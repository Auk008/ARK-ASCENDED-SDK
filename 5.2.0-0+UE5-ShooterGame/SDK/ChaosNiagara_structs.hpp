...
public:
	...
	struct FVector                               AngularVelocity;                                   // 0x48(0x18)(None)
	float                                        ExtentMin;                                         // 0x60(0x4)(None)
	float                                        ExtentMax;                                         // 0x64(0x4)(None)
	int32                                        ParticleID;                                        // 0x68(0x4)(None)
	float                                        Time;                                              // 0x6C(0x4)(None)
	int32                                        Type;                                              // 0x70(0x4)(None)
