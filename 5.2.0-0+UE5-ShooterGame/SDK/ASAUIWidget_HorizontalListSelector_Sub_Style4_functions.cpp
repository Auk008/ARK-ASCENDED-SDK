...
// class UASAUIWidget_Button_Style4_C*CallFunc_Array_Get_Item                                          (None)

void UASAUIWidget_HorizontalListSelector_Sub_Style4_C::SetEnabledStateOfButtonIndex(int32 Index, bool Enabled_, bool CallFunc_Array_IsValidIndex_ReturnValue, class UASAUIWidget_Button_Style4_C* CallFunc_Array_Get_Item)
{
...
void UASAUIWidget_HorizontalListSelector_Sub_Style4_C::GetLastAvailableButtonIndex(int32 FirstButton, int32 FoundFirstButton, bool Temp_bool_Variable, int32 Temp_int_Variable, int32 CallFunc_Add_IntInt_ReturnValue, bool CallFunc_Not_PreBool_ReturnValue, int32 CallFunc_Subtract_IntInt_ReturnValue, int32 CallFunc_Subtract_IntInt_ReturnValue_1, bool CallFunc_LessEqual_IntInt_ReturnValue, class UASAUIWidget_Button_Style4_C* CallFunc_Array_Get_Item, bool CallFunc_BooleanAND_ReturnValue, bool CallFunc_GetIsEnabled_ReturnValue)
{
	static class UFunction* Func = nullptr;
...
// TArray<class UWidget*>             K2Node_MakeArray_Array                                           (Edit, ZeroConstructor, AutoWeak, ContainsInstancedReference, AssetRegistrySearchable, BlueprintCallable, BlueprintAuthorityOnly, NonPIEDuplicateTransient, ExposeOnSpawn, NativeAccessSpecifierPublic, NativeAccessSpecifierProtected)
...
// TArray<class UWidget*>             K2Node_MakeArray_Array_1                                         (Edit, ZeroConstructor, Protected, BlueprintCallable, BlueprintAuthorityOnly, TextExportTransient, NonPIEDuplicateTransient, HasGetValueTypeHash, NativeAccessSpecifierPublic, NativeAccessSpecifierProtected, NativeAccessSpecifierPrivate)
...
void UASAUIWidget_HorizontalListSelector_Sub_Style4_C::SetButtonsInactive(int32 Temp_int_Array_Index_Variable, int32 Temp_int_Loop_Counter_Variable, int32 CallFunc_Add_IntInt_ReturnValue, int32 CallFunc_Array_Length_ReturnValue, class UASAUIWidget_Button_Style4_C* CallFunc_Array_Get_Item, bool CallFunc_Less_IntInt_ReturnValue)
{
	static class UFunction* Func = nullptr;
...
// TArray<class UPrimalUI*>           CallFunc_GetAllWidgetsOfClass_FoundWidgets                       (Edit, ZeroConstructor, AutoWeak, ContainsInstancedReference, SimpleDisplay, Protected, BlueprintAuthorityOnly, UObjectWrapper, NativeAccessSpecifierPublic, NativeAccessSpecifierPrivate)
// int32                              CallFunc_Array_Length_ReturnValue                                (None)
// int32                              Temp_int_Loop_Counter_Variable                                   (None)
// bool                               CallFunc_Less_IntInt_ReturnValue                                 (None)
// int32                              CallFunc_Add_IntInt_ReturnValue                                  (None)
...
// class UASAUIWidget_Button_Style4_C*CallFunc_Array_Get_Item_1                                        (Edit, ZeroConstructor)
// class UTexture*                    CallFunc_Array_Get_Item_2                                        (Edit, ZeroConstructor)
// int32                              CallFunc_Subtract_IntInt_ReturnValue_1                           (None)
// bool                               CallFunc_LessEqual_IntInt_ReturnValue_1                          (None)
// class UWidget*                     CallFunc_GetChildAt_ReturnValue                                  (ZeroConstructor)
// TArray<class UWidget*>             CallFunc_GetAllChildren_ReturnValue                              (Edit, ZeroConstructor, AutoWeak, AssetRegistrySearchable, SimpleDisplay, AdvancedDisplay, NonPIEDuplicateTransient, ExposeOnSpawn, NativeAccessSpecifierPublic, NativeAccessSpecifierProtected)
// class UWidget*                     CallFunc_Array_Get_Item_3                                        (Edit, ZeroConstructor)
// int32                              CallFunc_Array_Length_ReturnValue_1                              (None)
// struct FGeometry                   CallFunc_GetCachedGeometry_ReturnValue                           (None)
// bool                               CallFunc_Less_IntInt_ReturnValue_1                               (None)
// struct FVector2D                   CallFunc_GetLocalSize_ReturnValue                                (None)
// double                             CallFunc_BreakVector2D_X                                         (None)
// double                             CallFunc_BreakVector2D_Y                                         (None)
// struct FGeometry                   CallFunc_GetCachedGeometry_ReturnValue_1                         (None)
// struct FVector2D                   CallFunc_GetLocalSize_ReturnValue_1                              (None)
...
// struct FGeometry                   CallFunc_GetCachedGeometry_ReturnValue_2                         (None)
// int32                              CallFunc_Array_Add_ReturnValue                                   (None)
// struct FVector2D                   CallFunc_GetLocalSize_ReturnValue_2                              (None)
...
// class UWidget*                     CallFunc_GetChildAt_ReturnValue_2                                (Edit, ZeroConstructor)
...
// TArray<class UASAUIWidget_Button_Style4_C*>K2Node_MakeArray_Array                                           (None)
