...
// class UGLTFExportOptions*          Options                                                          (ZeroConstructor)
// TSet<class AActor*>                SelectedActors                                                   (None)
// struct FGLTFExportMessages         OutMessages                                                      (None)
// bool                               ReturnValue                                                      (None)

void UGLTFExporter::ExportToGLTF(class UObject* Object, const class FString& FilePath, class UGLTFExportOptions* Options, TSet<class AActor*> SelectedActors, const struct FGLTFExportMessages& OutMessages, bool ReturnValue)
{
	static class UFunction* Func = nullptr;
