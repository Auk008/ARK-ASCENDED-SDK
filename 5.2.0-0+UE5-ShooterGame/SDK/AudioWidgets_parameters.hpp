...
{
public:
	TArray<struct FMeterChannelInfo>             InMeterChannelInfo;                                // 0x0(0x10)(None)
};
...
{
public:
	TArray<struct FMeterChannelInfo>             ReturnValue;                                       // 0x0(0x10)(None)
};
...
{
public:
	enum class EAudioRadialSliderLayout          InLayout;                                          // 0x0(0x1)(None)
};
...
{
public:
	class FText                                  Units;                                             // 0x0(0x18)(None)
};
...
{
public:
	struct FSlateColor                           InColor;                                           // 0x0(0x14)(None)
};
...
{
public:
	float                                        InThickness;                                       // 0x0(0x4)(None)
};
...
{
public:
	bool                                         bShowUnitsText;                                    // 0x0(0x1)(None)
};
...
{
public:
	bool                                         bShowLabelOnlyOnHover;                             // 0x0(0x1)(None)
};
...
{
public:
	struct FVector2D                             InOutputRange;                                     // 0x0(0x10)(None)
};
...
{
public:
	struct FVector2D                             InHandStartEndRatio;                               // 0x0(0x10)(None)
};
...
{
public:
	float                                        OutputValue;                                       // 0x0(0x4)(None)
...
{
public:
	float                                        InSliderValue;                                     // 0x0(0x4)(None)
	float                                        ReturnValue;                                       // 0x4(0x4)(None)
};
