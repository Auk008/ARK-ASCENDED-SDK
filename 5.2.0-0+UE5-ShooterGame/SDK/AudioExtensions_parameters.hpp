...
public:
	class FName                                  InName;                                            // 0x0(0x8)(None)
	TArray<class FString>                        InValue;                                           // 0x8(0x10)(None)
};
...
{
public:
	TArray<struct FAudioParameter>               InParameters;                                      // 0x0(0x10)(None)
};
...
public:
	class FName                                  InName;                                            // 0x0(0x8)(None)
	class UObject*                               InValue;                                           // 0x8(0x8)(None)
};
...
public:
	class FName                                  InName;                                            // 0x0(0x8)(None)
	TArray<class UObject*>                       InValue;                                           // 0x8(0x10)(None)
};
...
public:
	class FName                                  InName;                                            // 0x0(0x8)(None)
	TArray<int32>                                InValue;                                           // 0x8(0x10)(None)
};
...
public:
	class FName                                  InName;                                            // 0x0(0x8)(None)
	TArray<float>                                InValue;                                           // 0x8(0x10)(None)
};
...
public:
	class FName                                  InName;                                            // 0x0(0x8)(None)
	TArray<bool>                                 InValue;                                           // 0x8(0x10)(None)
};
