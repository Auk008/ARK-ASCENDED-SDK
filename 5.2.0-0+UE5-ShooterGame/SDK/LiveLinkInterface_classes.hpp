...
public:
	...
	class UClass*                                Role;                                              // 0x30(0x8)(ZeroConstructor)
	TArray<struct FLiveLinkSubjectName>          Subjects;                                          // 0x38(0x10)(None)
	TArray<class ULiveLinkFrameTranslator*>      FrameTranslators;                                  // 0x48(0x10)(None)
	bool                                         bRebroadcastSubject;                               // 0x58(0x1)(None)
	uint8                                        Pad_129D[0x107];                                   // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	enum class ELiveLinkSourceMode               Mode;                                              // 0x28(0x1)(None)
	uint8                                        Pad_12A3[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FLiveLinkSourceBufferManagementSettings BufferSettings;                                    // 0x30(0x60)(None)
	class FString                                ConnectionString;                                  // 0x90(0x10)(None)
	class UClass*                                Factory;                                           // 0xA0(0x8)(None)
...
{
public:
	struct FLiveLinkCurveConversionSettings      CurveConversionSettings;                           // 0xA8(0x50)(None)
...
{
public:
	TArray<class ULiveLinkFramePreProcessor*>    PreProcessors;                                     // 0x28(0x10)(ZeroConstructor)
	class ULiveLinkFrameInterpolationProcessor*  InterpolationProcessor;                            // 0x38(0x8)(ZeroConstructor)
	TArray<class ULiveLinkFrameTranslator*>      Translators;                                       // 0x40(0x10)(ZeroConstructor)
	class UClass*                                Role;                                              // 0x50(0x8)(None)
	struct FFrameRate                            FrameRate;                                         // 0x58(0x8)(None)
	bool                                         bRebroadcastSubject;                               // 0x60(0x1)(None)
