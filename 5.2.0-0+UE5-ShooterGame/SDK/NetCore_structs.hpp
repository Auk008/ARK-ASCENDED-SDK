...
public:
	...
	class FString                                StateName;                                         // 0x8(0x10)(None)
};
...
{
public:
	bool                                         bLogEscalate;                                      // 0x18(0x1)(None)
	bool                                         bDormant;                                          // 0x19(0x1)(None)
	int16                                        CooloffTime;                                       // 0x1A(0x2)(None)
	int16                                        AutoEscalateTime;                                  // 0x1C(0x2)(None)
	int8                                         HighestTimePeriod;                                 // 0x1E(0x1)(None)
	uint8                                        Pad_2C49[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	TArray<int8>                                 AllTimePeriods;                                    // 0x20(0x10)(ContainsInstancedReference, SimpleDisplay, AdvancedDisplay, BlueprintCallable, NonPIEDuplicateTransient, UObjectWrapper)
};
...
{
public:
	bool                                         bCloseConnection;                                  // 0x30(0x1)(None)
	uint8                                        Pad_2C4B[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	int16                                        EscalateQuotaFaultsPerPeriod;                      // 0x32(0x2)(None)
	int8                                         EscalateQuotaFaultPercentPerPeriod;                // 0x34(0x1)(None)
	uint8                                        Pad_2C4C[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	int16                                        DescalateQuotaFaultsPerPeriod;                     // 0x36(0x2)(None)
	int8                                         DescalateQuotaFaultPercentPerPeriod;               // 0x38(0x1)(None)
	int8                                         EscalateQuotaTimePeriod;                           // 0x39(0x1)(None)
	uint8                                        Pad_2C4D[0x6];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	int32                                        ReplicationID;                                     // 0x0(0x4)(None)
	int32                                        ReplicationKey;                                    // 0x4(0x4)(None)
	int32                                        MostRecentArrayReplicationKey;                     // 0x8(0x4)(None)
};
...
{
public:
	uint8                                        Pad_2C4E[0x54];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	int32                                        ArrayReplicationKey;                               // 0x54(0x4)(None)
	uint8                                        Pad_2C4F[0xA8];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	enum class EFastArraySerializerDeltaFlags    DeltaFlags;                                        // 0x100(0x1)(None)
