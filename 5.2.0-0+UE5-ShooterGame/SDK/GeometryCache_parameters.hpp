...
{
public:
	class UGeometryCacheComponent*               ReturnValue;                                       // 0x0(0x8)(None)
};
...
public:
	...
	bool                                         bInIsRunning;                                      // 0x4(0x1)(None)
	bool                                         bInBackwards;                                      // 0x5(0x1)(None)
	bool                                         bInIsLooping;                                      // 0x6(0x1)(None)
	uint8                                        Pad_AF9[0x1];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	float                                        NewStartTimeOffset;                                // 0x0(0x4)(None)
};
...
{
public:
	float                                        NewPlaybackSpeed;                                  // 0x0(0x4)(None)
};
...
{
public:
	float                                        NewMotionVectorScale;                              // 0x0(0x4)(None)
};
...
{
public:
	class UGeometryCache*                        NewGeomCache;                                      // 0x0(0x8)(None)
...
{
public:
	bool                                         bNewExtrapolating;                                 // 0x0(0x1)(None)
};
...
{
public:
	struct FGeometryCacheMeshData                MeshData;                                          // 0x0(0xC8)(None)
	float                                        SampleTime;                                        // 0xC8(0x4)(None)
...
{
public:
	struct FGeometryCacheMeshData                NewMeshData;                                       // 0x0(0xC8)(None)
};
