...
public:
	...
	bool                                         K2Node_Event_bIsDocked;                            // 0x15(0x1)(None)
	uint8                                        Pad_41B4[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class UVerticalBoxSlot*                      CallFunc_SlotAsVerticalBoxSlot_ReturnValue;        // 0x18(0x8)(Edit, ZeroConstructor)
	class UVerticalBoxSlot*                      CallFunc_SlotAsVerticalBoxSlot_ReturnValue_1;      // 0x20(0x8)(None)
	struct FMargin                               K2Node_Select_Default;                             // 0x28(0x10)(None)
};
