...
{
public:
	float                                        StartingFrequency;                                 // 0x28(0x4)(None)
	int32                                        NumBands;                                          // 0x2C(0x4)(None)
	float                                        NumBandsPerOctave;                                 // 0x30(0x4)(None)
	float                                        AnalysisPeriod;                                    // 0x34(0x4)(None)
	bool                                         bDownmixToMono;                                    // 0x38(0x1)(None)
	enum class EConstantQFFTSizeEnum             FFTSize;                                           // 0x39(0x1)(None)
	enum class EFFTWindowType                    WindowType;                                        // 0x3A(0x1)(None)
	enum class EAudioSpectrumType                SpectrumType;                                      // 0x3B(0x1)(None)
	float                                        BandWidthStretch;                                  // 0x3C(0x4)(None)
	enum class EConstantQNormalizationEnum       CQTNormalization;                                  // 0x40(0x1)(None)
	uint8                                        Pad_265B[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	float                                        NoiseFloorDb;                                      // 0x44(0x4)(None)
...
{
public:
	class UConstantQNRTSettings*                 Settings;                                          // 0x78(0x8)(ZeroConstructor)

	static class UClass* StaticClass();
	static class UConstantQNRT* GetDefaultObj();

	void GetNormalizedChannelConstantQAtTime(float InSeconds, int32 InChannel, const TArray<float>& OutConstantQ);
	void GetChannelConstantQAtTime(float InSeconds, int32 InChannel, const TArray<float>& OutConstantQ);
};
...
{
public:
	float                                        AnalysisPeriod;                                    // 0x28(0x4)(None)
	float                                        MinimumFrequency;                                  // 0x2C(0x4)(None)
	float                                        MaximumFrequency;                                  // 0x30(0x4)(None)
	enum class ELoudnessCurveTypeEnum            CurveType;                                         // 0x34(0x1)(None)
	uint8                                        Pad_2662[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	float                                        NoiseFloorDb;                                      // 0x38(0x4)(None)
	float                                        ExpectedMaxLoudness;                               // 0x3C(0x4)(None)
...
{
public:
	class ULoudnessSettings*                     Settings;                                          // 0x90(0x8)(ZeroConstructor)
	FMulticastInlineDelegateProperty_            OnOverallLoudnessResults;                          // 0x98(0x10)(ZeroConstructor)
	FMulticastInlineDelegateProperty_            OnPerChannelLoudnessResults;                       // 0xA8(0x10)(ZeroConstructor)
	FMulticastInlineDelegateProperty_            OnLatestOverallLoudnessResults;                    // 0xB8(0x10)(ZeroConstructor)
	FMulticastInlineDelegateProperty_            OnLatestPerChannelLoudnessResults;                 // 0xC8(0x10)(ZeroConstructor)
...
public:
	...
	float                                        MinimumFrequency;                                  // 0x2C(0x4)(None)
	float                                        MaximumFrequency;                                  // 0x30(0x4)(None)
	enum class ELoudnessNRTCurveTypeEnum         CurveType;                                         // 0x34(0x1)(None)
...
{
public:
	class ULoudnessNRTSettings*                  Settings;                                          // 0x78(0x8)(ZeroConstructor)
...
public:
	float                                        AnalysisPeriod;                                    // 0x28(0x4)(None)
	enum class EMeterPeakType                    PeakMode;                                          // 0x2C(0x1)(None)
	uint8                                        Pad_266A[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	int32                                        MeterAttackTime;                                   // 0x30(0x4)(None)
	int32                                        MeterReleaseTime;                                  // 0x34(0x4)(None)
	int32                                        PeakHoldTime;                                      // 0x38(0x4)(None)
	float                                        ClippingThreshold;                                 // 0x3C(0x4)(None)
...
{
public:
	class UMeterSettings*                        Settings;                                          // 0x90(0x8)(ZeroConstructor)
	FMulticastInlineDelegateProperty_            OnOverallMeterResults;                             // 0x98(0x10)(ZeroConstructor)
	uint8                                        Pad_266C[0x18];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	FMulticastInlineDelegateProperty_            OnPerChannelMeterResults;                          // 0xC0(0x10)(ZeroConstructor)
	uint8                                        Pad_266D[0x18];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	FMulticastInlineDelegateProperty_            OnLatestOverallMeterResults;                       // 0xE8(0x10)(ZeroConstructor)
	uint8                                        Pad_266E[0x18];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	FMulticastInlineDelegateProperty_            OnLatestPerChannelMeterResults;                    // 0x110(0x10)(ZeroConstructor)
...
{
public:
	bool                                         bDownmixToMono;                                    // 0x28(0x1)(None)
	uint8                                        Pad_2670[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	float                                        GranularityInSeconds;                              // 0x2C(0x4)(None)
	float                                        Sensitivity;                                       // 0x30(0x4)(None)
	float                                        MinimumFrequency;                                  // 0x34(0x4)(None)
	float                                        MaximumFrequency;                                  // 0x38(0x4)(None)
...
{
public:
	class UOnsetNRTSettings*                     Settings;                                          // 0x78(0x8)(ZeroConstructor)
...
public:
	float                                        AnalysisPeriod;                                    // 0x28(0x4)(None)
	enum class EFFTSize                          FFTSize;                                           // 0x2C(0x1)(None)
	enum class EAudioSpectrumType                SpectrumType;                                      // 0x2D(0x1)(None)
	enum class EFFTWindowType                    WindowType;                                        // 0x2E(0x1)(None)
	bool                                         bDownmixToMono;                                    // 0x2F(0x1)(None)
...
{
public:
	class USynesthesiaSpectrumAnalysisSettings*  Settings;                                          // 0x90(0x8)(ZeroConstructor)
	FMulticastInlineDelegateProperty_            OnSpectrumResults;                                 // 0x98(0x10)(ZeroConstructor)
	uint8                                        Pad_267E[0x18];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	FMulticastInlineDelegateProperty_            OnLatestSpectrumResults;                           // 0xC0(0x10)(ZeroConstructor)
	uint8                                        Pad_267F[0x18];                                    // Fixing Size Of Struct [ Dumper-7 ]
