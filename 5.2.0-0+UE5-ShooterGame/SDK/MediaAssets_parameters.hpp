...
{
public:
	class UMediaPlayer*                          NewMediaPlayer;                                    // 0x0(0x8)(None)
};
...
{
public:
	class UMediaTexture*                         ReturnValue;                                       // 0x0(0x8)(None)
};
...
{
public:
	float                                        Horizontal;                                        // 0x0(0x4)(None)
	float                                        Vertical;                                          // 0x4(0x4)(None)
	bool                                         Absolute;                                          // 0x8(0x1)(None)
...
{
public:
	int32                                        TrackIndex;                                        // 0x0(0x4)(None)
	int32                                        FormatIndex;                                       // 0x4(0x4)(None)
	float                                        FrameRate;                                         // 0x8(0x4)(None)
...
{
public:
	struct FTimespan                             TimeDelay;                                         // 0x0(0x8)(None)
};
...
{
public:
	class UMediaSource*                          Options;                                           // 0x0(0x8)(None)
};
...
{
public:
	class FName                                  PlayerName;                                        // 0x0(0x8)(None)
};
...
{
public:
	class UMediaSource*                          MediaSource;                                       // 0x0(0x8)(None)
	struct FMediaPlayerOptions                   Options;                                           // 0x8(0x30)(None)
...
public:
	...
	struct FLatentActionInfo                     LatentInfo;                                        // 0x8(0x18)(ZeroConstructor)
	class UMediaSource*                          MediaSource;                                       // 0x20(0x8)(None)
	struct FMediaPlayerOptions                   Options;                                           // 0x28(0x30)(None)
	bool                                         bSuccess;                                          // 0x58(0x1)(None)
...
{
public:
	class UMediaPlaylist*                        InPlaylist;                                        // 0x0(0x8)(None)
...
public:
	int32                                        TrackIndex;                                        // 0x0(0x4)(None)
	int32                                        FormatIndex;                                       // 0x4(0x4)(None)
	struct FFloatRange                           ReturnValue;                                       // 0x8(0x10)(None)
};
...
{
public:
	class UMediaTimeStampInfo*                   ReturnValue;                                       // 0x0(0x8)(None)
};
...
{
public:
	TArray<struct FFloatRange>                   OutRates;                                          // 0x0(0x10)(None)
	bool                                         Unthinned;                                         // 0x10(0x1)(None)
...
{
public:
	class UMediaPlaylist*                        ReturnValue;                                       // 0x0(0x8)(None)
};
...
public:
	...
	class UMediaSource*                          Replacement;                                       // 0x8(0x8)(None)
	bool                                         ReturnValue;                                       // 0x10(0x1)(None)
...
{
public:
	int32                                        OutIndex;                                          // 0x0(0x4)(None)
	uint8                                        Pad_250E[0x4];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class UMediaSource*                          ReturnValue;                                       // 0x8(0x8)(None)
};
...
{
public:
	TArray<float>                                InFrequenciesToAnalyze;                            // 0x0(0x10)(None)
	enum class EMediaSoundComponentFFTSize       InFFTSize;                                         // 0x10(0x1)(None)
...
{
public:
	int32                                        AttackTimeMsec;                                    // 0x0(0x4)(None)
	int32                                        ReleaseTimeMsec;                                   // 0x4(0x4)(None)
};
...
{
public:
	bool                                         bInSpectralAnalysisEnabled;                        // 0x0(0x1)(None)
};
...
{
public:
	bool                                         bInEnvelopeFollowing;                              // 0x0(0x1)(None)
};
...
{
public:
	TArray<struct FMediaSoundComponentSpectralData> ReturnValue;                                       // 0x0(0x10)(None)
};
...
{
public:
	struct FSoundAttenuationSettings             OutAttenuationSettings;                            // 0x0(0x3C8)(None)
	bool                                         ReturnValue;                                       // 0x3C8(0x1)(None)
...
{
public:
	TArray<struct FMediaCaptureDevice>           OutDevices;                                        // 0x0(0x10)(None)
	int32                                        Filter;                                            // 0x10(0x4)(None)
