...
public:
	...
	TArray<float>                                Confidence;                                        // 0x38(0x10)(None)
};
...
{
public:
	class UMRMeshComponent*                      InMRMeshPtr;                                       // 0x0(0x8)(None)
};
...
{
public:
	bool                                         bUseWireframe;                                     // 0x0(0x1)(None)
};
...
{
public:
	class UMRMeshComponent*                      Mesh;                                              // 0x0(0x8)(None)
};
