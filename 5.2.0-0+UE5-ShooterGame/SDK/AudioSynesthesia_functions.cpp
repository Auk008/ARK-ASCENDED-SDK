...
// Parameters:
// float                              InSeconds                                                        (None)
// int32                              InChannel                                                        (None)
// TArray<float>                      OutConstantQ                                                     (None)

void UConstantQNRT::GetNormalizedChannelConstantQAtTime(float InSeconds, int32 InChannel, const TArray<float>& OutConstantQ)
{
...
void UConstantQNRT::GetChannelConstantQAtTime(float InSeconds, int32 InChannel, const TArray<float>& OutConstantQ)
{
	static class UFunction* Func = nullptr;
...
// (Final, Native, Public, HasOutParams, BlueprintCallable, BlueprintPure, Const)
// Parameters:
// float                              InStartSeconds                                                   (None)
// float                              InEndSeconds                                                     (None)
// int32                              InChannel                                                        (None)
// TArray<float>                      OutOnsetTimestamps                                               (None)
// TArray<float>                      OutOnsetStrengths                                                (None)
...
// Parameters:
// float                              InSampleRate                                                     (None)
// TArray<float>                      OutCenterFrequencies                                             (None)
