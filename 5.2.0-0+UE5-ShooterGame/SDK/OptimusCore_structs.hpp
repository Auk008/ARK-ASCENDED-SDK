...
{
public:
	class FName                                  TypeName;                                          // 0x0(0x8)(None)
	TWeakObjectPtr<class UObject>                TypeObject;                                        // 0x8(0x8)(None)
};
...
public:
	class FName                                  Name;                                              // 0x0(0x8)(None)
	struct FOptimusDataTypeRef                   DataType;                                          // 0x8(0x10)(None)
};
...
{
public:
	enum class EOptimusDataDomainType            Type;                                              // 0x0(0x4)(None)
	uint8                                        Pad_77B[0x4];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	TArray<class FName>                          DimensionNames;                                    // 0x8(0x10)(ContainsInstancedReference, AssetRegistrySearchable, SimpleDisplay, BlueprintAuthorityOnly, TextExportTransient, NonPIEDuplicateTransient, ExposeOnSpawn, PersistentInstance, HasGetValueTypeHash, NativeAccessSpecifierProtected, NativeAccessSpecifierPrivate)
	int32                                        Multiplier;                                        // 0x18(0x4)(None)
	uint8                                        Pad_77C[0x4];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	class FString                                Expression;                                        // 0x20(0x10)(AutoWeak, AssetRegistrySearchable, AdvancedDisplay, BlueprintCallable, BlueprintAuthorityOnly, TextExportTransient, NonPIEDuplicateTransient, ExposeOnSpawn, PersistentInstance, NativeAccessSpecifierProtected, NativeAccessSpecifierPrivate)
	TArray<class FName>                          LevelNames;                                        // 0x30(0x10)(None)
};
...
{
public:
	struct FOptimusValidatedName                 Name;                                              // 0x0(0x8)(None)
	struct FOptimusDataTypeRef                   DataType;                                          // 0x8(0x10)(None)
	struct FOptimusDataDomain                    DataDomain;                                        // 0x18(0x40)(None)
};
...
{
public:
	TArray<struct FOptimusParameterBinding>      InnerArray;                                        // 0x0(0x10)(None)
};
...
{
public:
	class FString                                Declarations;                                      // 0x0(0x10)(ContainsInstancedReference, AssetRegistrySearchable, SimpleDisplay, AdvancedDisplay, Protected, BlueprintCallable, TextExportTransient, NonPIEDuplicateTransient, ExposeOnSpawn, PersistentInstance, HasGetValueTypeHash, NativeAccessSpecifierProtected, NativeAccessSpecifierPrivate)
	class FString                                ShaderText;                                        // 0x10(0x10)(None)
};
...
{
public:
	uint8                                        Pad_77F[0x18];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_780[0x28];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_782[0x28];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_783[0x40];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_786[0x20];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_789[0x90];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_78A[0x38];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_78C[0xA0];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_78F[0x30];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_792[0x78];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_793[0x40];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_796[0x88];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_797[0x88];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_799[0x48];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_79A[0x28];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_79C[0x98];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_79E[0x48];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_7A1[0x28];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_7A8[0x88];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_7AB[0x28];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	class FString                                Name;                                              // 0x0(0x10)(SimpleDisplay, AdvancedDisplay, Protected, BlueprintCallable, TextExportTransient, NonPIEDuplicateTransient, ExposeOnSpawn, PersistentInstance, HasGetValueTypeHash, NativeAccessSpecifierProtected, NativeAccessSpecifierPrivate)
	class FName                                  BoneName;                                          // 0x10(0x8)(None)
	struct FOptimusDataTypeRef                   DataType;                                          // 0x18(0x10)(ZeroConstructor)
	class UOptimusValueContainer*                DefaultValue;                                      // 0x28(0x8)(None)
	class FString                                HlslId;                                            // 0x30(0x10)(None)
	class FName                                  PinName;                                           // 0x40(0x8)(None)
};
...
{
public:
	TArray<struct FOptimusAnimAttributeDescription> InnerArray;                                        // 0x0(0x10)(None)
};
...
{
public:
	bool                                         bForceEnable;                                      // 0x0(0x1)(None)
	uint8                                        Pad_7AF[0x3];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	int32                                        MaxLineCount;                                      // 0x4(0x4)(None)
	int32                                        MaxTriangleCount;                                  // 0x8(0x4)(None)
	int32                                        MaxCharacterCount;                                 // 0xC(0x4)(None)
	int32                                        FontSize;                                          // 0x10(0x4)(None)
};
...
{
public:
	class FString                                Name;                                              // 0x0(0x10)(AutoWeak, SimpleDisplay, BlueprintCallable, BlueprintAuthorityOnly, TextExportTransient, NonPIEDuplicateTransient, ExposeOnSpawn, PersistentInstance, NativeAccessSpecifierProtected, NativeAccessSpecifierPrivate)
	struct FShaderValueTypeHandle                ValueType;                                         // 0x10(0x8)(None)
	TArray<uint8>                                Value;                                             // 0x18(0x10)(None)
	int32                                        Offset;                                            // 0x28(0x4)(None)
...
{
public:
	struct FOptimusValidatedName                 GroupName;                                         // 0x0(0x8)(None)
	struct FOptimusParameterBindingArray         BindingArray;                                      // 0x8(0x10)(None)
};
...
{
public:
	class FName                                  VariableName;                                      // 0x0(0x8)(None)
	struct FOptimusDataTypeRef                   DataType;                                          // 0x8(0x10)(None)
	class FString                                DefaultValue;                                      // 0x18(0x10)(None)
};
...
{
public:
	class FName                                  ResourceName;                                      // 0x0(0x8)(None)
	struct FOptimusDataTypeRef                   DataType;                                          // 0x8(0x10)(None)
	struct FOptimusDataDomain                    DataDomain;                                        // 0x18(0x40)(None)
};
...
public:
	class FName                                  TypeName;                                          // 0x0(0x8)(None)
	class FText                                  DisplayName;                                       // 0x8(0x18)(None)
	struct FShaderValueTypeHandle                ShaderValueType;                                   // 0x20(0x8)(None)
	int32                                        ShaderValueSize;                                   // 0x28(0x4)(None)
	class FName                                  TypeCategory;                                      // 0x2C(0x8)(None)
	TWeakObjectPtr<class UObject>                TypeObject;                                        // 0x34(0x8)(None)
	bool                                         bHasCustomPinColor;                                // 0x3C(0x1)(None)
	uint8                                        Pad_7B7[0x3];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	struct FLinearColor                          CustomPinColor;                                    // 0x40(0x10)(None)
	enum class EOptimusDataTypeUsageFlags        UsageFlags;                                        // 0x50(0x1)(None)
	enum class EOptimusDataTypeFlags             TypeFlags;                                         // 0x51(0x1)(None)
...
{
public:
	enum class EOptimusNodeGraphType             GraphType;                                         // 0x0(0x4)(None)
	class FName                                  GraphName;                                         // 0x4(0x8)(None)
	uint8                                        Pad_7B9[0x4];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	class UOptimusComputeGraph*                  ComputeGraph;                                      // 0x10(0x8)(None)
};
...
public:
	...
	enum class EOptimusNodeGraphType             GraphType;                                         // 0x8(0x4)(None)
	uint8                                        Pad_7BC[0x4];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	class UComputeGraph*                         ComputeGraph;                                      // 0x10(0x8)(ZeroConstructor)
	struct FComputeGraphInstance                 ComputeGraphInstance;                              // 0x18(0x18)(None)
};
...
{
public:
	class FName                                  ProviderName;                                      // 0x0(0x8)(None)
	class FName                                  ComponentName;                                     // 0x8(0x8)(None)
};
