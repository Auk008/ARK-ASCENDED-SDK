...
// Parameters:
// class UTemplateSequence*           InSequence                                                       (None)
...
// Parameters:
// class UTemplateSequence*           ReturnValue                                                      (None)
...
// (Final, Native, Public, BlueprintCallable, BlueprintPure, Const)
// Parameters:
// class UTemplateSequencePlayer*     ReturnValue                                                      (None)
...
// class UTemplateSequence*           TemplateSequence                                                 (ZeroConstructor)
// struct FMovieSceneSequencePlaybackSettingsSettings                                                         (None)
// class ATemplateSequenceActor*      OutActor                                                         (ZeroConstructor)
// class UTemplateSequencePlayer*     ReturnValue                                                      (None)

void UTemplateSequencePlayer::CreateTemplateSequencePlayer(class UObject* WorldContextObject, class UTemplateSequence* TemplateSequence, const struct FMovieSceneSequencePlaybackSettings& Settings, class ATemplateSequenceActor* OutActor, class UTemplateSequencePlayer* ReturnValue)
{
	static class UFunction* Func = nullptr;
...
// int32                              PPIndex                                                          (None)
// struct FPostProcessSettings        OutPPSettings                                                    (None)
// float                              OutPPBlendWeight                                                 (None)
// bool                               ReturnValue                                                      (None)

void USequenceCameraShakeTestUtil::GetPostProcessBlendCache(class APlayerController* PlayerController, int32 PPIndex, const struct FPostProcessSettings& OutPPSettings, float OutPPBlendWeight, bool ReturnValue)
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// class APlayerController*           PlayerController                                                 (ZeroConstructor)
// struct FMinimalViewInfo            ReturnValue                                                      (None)
