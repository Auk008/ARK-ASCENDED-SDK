...
public:
	...
	enum class EUDLSSMode                        DLSSMode;                                          // 0x8(0x1)(None)
...
{
public:
	enum class EUDLSSSupport                     ReturnValue;                                       // 0x0(0x1)(None)
};
...
{
public:
	enum class EUDLSSMode                        DLSSMode;                                          // 0x0(0x1)(None)
...
{
public:
	TArray<enum class EUDLSSMode>                ReturnValue;                                       // 0x0(0x10)(None)
};
...
{
public:
	float                                        MinScreenPercentage;                               // 0x0(0x4)(None)
	float                                        MaxScreenPercentage;                               // 0x4(0x4)(None)
};
...
{
public:
	int32                                        MinDriverVersionMajor;                             // 0x0(0x4)(None)
	int32                                        MinDriverVersionMinor;                             // 0x4(0x4)(None)
};
...
public:
	...
	struct FVector2D                             ScreenResolution;                                  // 0x8(0x10)(None)
	bool                                         bIsSupported;                                      // 0x18(0x1)(None)
	uint8                                        Pad_1E95[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	float                                        OptimalScreenPercentage;                           // 0x1C(0x4)(None)
	bool                                         bIsFixedScreenPercentage;                          // 0x20(0x1)(None)
	uint8                                        Pad_1E96[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	float                                        MinScreenPercentage;                               // 0x24(0x4)(None)
	float                                        MaxScreenPercentage;                               // 0x28(0x4)(None)
	float                                        OptimalSharpness;                                  // 0x2C(0x4)(None)
};
...
{
public:
	enum class EUDLSSMode                        ReturnValue;                                       // 0x0(0x1)(None)
};
