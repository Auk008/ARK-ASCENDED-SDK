...
{
public:
	class UResonanceAudioReverbPluginPreset*     InPreset;                                          // 0x0(0x8)(None)
};
...
{
public:
	class UResonanceAudioReverbPluginPreset*     ReturnValue;                                       // 0x0(0x8)(None)
};
...
{
public:
	struct FQuat                                 InRotation;                                        // 0x0(0x20)(None)
};
...
{
public:
	TArray<enum class ERaMaterialName>           InMaterials;                                       // 0x0(0x10)(None)
};
...
{
public:
	struct FVector                               InDimensions;                                      // 0x0(0x18)(None)
};
...
{
public:
	float                                        InReverbTimeModifier;                              // 0x0(0x4)(None)
};
...
{
public:
	float                                        InReverbGain;                                      // 0x0(0x4)(None)
};
...
{
public:
	float                                        InReverbBrightness;                                // 0x0(0x4)(None)
};
...
{
public:
	float                                        InReflectionScalar;                                // 0x0(0x4)(None)
};
...
{
public:
	bool                                         bInEnableRoomEffects;                              // 0x0(0x1)(None)
};
...
{
public:
	float                                        InPattern;                                         // 0x0(0x4)(None)
	float                                        InSharpness;                                       // 0x4(0x4)(None)
};
