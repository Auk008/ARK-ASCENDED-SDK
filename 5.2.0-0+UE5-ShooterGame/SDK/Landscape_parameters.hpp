...
{
public:
	enum class ERuntimeVirtualTextureMainPassType InType;                                            // 0x0(0x1)(None)
};
...
public:
	class FName                                  ParameterName;                                     // 0x0(0x8)(None)
	class UTexture*                              Value;                                             // 0x8(0x8)(None)
};
...
public:
	...
	bool                                         InExportHeightIntoRGChannel;                       // 0x8(0x1)(None)
	bool                                         InExportLandscapeProxies;                          // 0x9(0x1)(None)
	bool                                         ReturnValue;                                       // 0xA(0x1)(None)
	uint8                                        Pad_2D9A[0x5];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	class ALandscape*                            ReturnValue;                                       // 0x0(0x8)(None)
};
...
{
public:
	class UMaterialInterface*                    NewLandscapeMaterial;                              // 0x0(0x8)(None)
};
...
{
public:
	class USplineComponent*                      InSplineComponent;                                 // 0x0(0x8)(ZeroConstructor)
	float                                        StartWidth;                                        // 0x8(0x4)(None)
	float                                        EndWidth;                                          // 0xC(0x4)(None)
	float                                        StartSideFalloff;                                  // 0x10(0x4)(None)
	float                                        EndSideFalloff;                                    // 0x14(0x4)(None)
	float                                        StartRoll;                                         // 0x18(0x4)(None)
	float                                        EndRoll;                                           // 0x1C(0x4)(None)
	int32                                        NumSubdivisions;                                   // 0x20(0x4)(None)
	bool                                         bRaiseHeights;                                     // 0x24(0x1)(None)
	bool                                         bLowerHeights;                                     // 0x25(0x1)(None)
	uint8                                        Pad_2DA2[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class ULandscapeLayerInfoObject*             PaintLayer;                                        // 0x28(0x8)(None)
	class FName                                  EditLayerName;                                     // 0x30(0x8)(None)
};
...
{
public:
	float                                        InLODDistanceFactor;                               // 0x0(0x4)(None)
};
...
{
public:
	float                                        InComponentScreenSizeToUseSubSections;             // 0x0(0x4)(None)
};
...
{
public:
	struct FTransform                            InWorldTransform;                                  // 0x0(0x60)(None)
	struct FBox2D                                InExtents;                                         // 0x60(0x28)(None)
	class UTextureRenderTarget2D*                OutRenderTarget;                                   // 0x88(0x8)(None)
};
...
{
public:
	int32                                        InForcedLOD;                                       // 0x0(0x4)(None)
};
...
public:
	...
	class UMaterialInstanceDynamic*              ReturnValue;                                       // 0x8(0x8)(None)
};
...
{
public:
	struct FVector                               InLocation;                                        // 0x0(0x18)(None)
	class FName                                  InPaintLayerName;                                  // 0x18(0x8)(None)
...
public:
	struct FVector                               InLocation;                                        // 0x0(0x18)(None)
	class ULandscapeLayerInfoObject*             PaintLayer;                                        // 0x18(0x8)(None)
	float                                        ReturnValue;                                       // 0x20(0x4)(None)
	uint8                                        Pad_2DC0[0x4];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	class ULandscapeComponent*                   ReturnValue;                                       // 0x0(0x8)(None)
};
...
{
public:
	TArray<class USplineMeshComponent*>          ReturnValue;                                       // 0x0(0x10)(None)
};
...
{
public:
	bool                                         bInUserTriggered;                                  // 0x0(0x1)(None)
};
...
{
public:
	bool                                         InIsHeightmap;                                     // 0x0(0x1)(None)
	uint8                                        Pad_2DF0[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class UTextureRenderTarget2D*                InCombinedResult;                                  // 0x8(0x8)(ZeroConstructor)
	class FName                                  InWeightmapLayerName;                              // 0x10(0x8)(None)
	class UTextureRenderTarget2D*                ReturnValue;                                       // 0x18(0x8)(None)
};
...
{
public:
	struct FTransform                            InLandscapeTransform;                              // 0x0(0x60)(None)
	struct FIntPoint                             InLandscapeSize;                                   // 0x60(0x8)(None)
	struct FIntPoint                             InLandscapeRenderTargetSize;                       // 0x68(0x8)(None)
};
...
{
public:
	TArray<class UObject*>                       OutStreamableAssets;                               // 0x0(0x10)(None)
};
