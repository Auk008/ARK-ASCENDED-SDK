...
public:
	...
	float                                        TimeToLookAhead;                                   // 0x4(0x4)(None)
};
...
{
public:
	class FText                                  DisplayName;                                       // 0x0(0x18)(SimpleDisplay, Protected, TextExportTransient, ExposeOnSpawn, PersistentInstance, HasGetValueTypeHash)
