...
// (Net, NetReliable, Native, Event, Public, NetServer)
// Parameters:
// class UClass*                      Class                                                            (None)
// int32                              PeriodFrame                                                      (None)
...
// Parameters:
// struct FVector                     CellLocation                                                     (None)
// struct FVector                     CellExtent                                                       (None)
