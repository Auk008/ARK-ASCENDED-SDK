...
{
public:
	bool                                         bOverrideCompressionTimes;                         // 0x0(0x1)(None)
	uint8                                        Pad_3162[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	float                                        DurationThreshold;                                 // 0x4(0x4)(None)
	int32                                        MaxNumRandomBranches;                              // 0x8(0x4)(None)
	int32                                        SoundCueQualityIndex;                              // 0xC(0x4)(None)
};
