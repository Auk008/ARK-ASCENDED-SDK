...
{
public:
	struct FColor                                NewColor;                                          // 0x0(0x4)(None)
};
...
{
public:
	enum class EDynamicMeshComponentColorOverrideMode NewMode;                                           // 0x0(0x1)(None)
};
...
{
public:
	class UMaterialInterface*                    ReturnValue;                                       // 0x0(0x8)(None)
};
...
{
public:
	class UDynamicMesh*                          ReturnValue;                                       // 0x0(0x8)(None)
};
...
{
public:
	enum class EDynamicMeshComponentColorOverrideMode ReturnValue;                                       // 0x0(0x1)(None)
};
...
{
public:
	bool                                         bCreateIfMissing;                                  // 0x0(0x1)(None)
	bool                                         bDeleteExtraSlots;                                 // 0x1(0x1)(None)
...
{
public:
	bool                                         bOnlyIfPending;                                    // 0x0(0x1)(None)
};
...
{
public:
	enum class EDynamicMeshComponentTangentsMode NewTangentsType;                                   // 0x0(0x1)(None)
};
...
public:
	bool                                         bEnabled;                                          // 0x0(0x1)(None)
	bool                                         bImmediateUpdate;                                  // 0x1(0x1)(None)
};
...
{
public:
	enum class EDynamicMeshComponentTangentsMode ReturnValue;                                       // 0x0(0x1)(None)
};
...
{
public:
	TArray<class UMaterialInterface*>            NewMaterialSet;                                    // 0x0(0x10)(None)
};
...
{
public:
	class UDynamicMesh*                          Mesh;                                              // 0x0(0x8)(None)
...
{
public:
	class UDynamicMeshComponent*                 ReturnValue;                                       // 0x0(0x8)(None)
};
