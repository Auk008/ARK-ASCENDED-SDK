...
// Parameters:
// class UObject*                     Object                                                           (None)
// class FString                      StringToMatch                                                    (None)
// TArray<class FName>                OutKeys                                                          (None)
// TArray<class FString>              OutValues                                                        (None)

void UDatasmithContentBlueprintLibrary::GetDatasmithUserDataKeysAndValuesForValue(class UObject* Object, const class FString& StringToMatch, const TArray<class FName>& OutKeys, const TArray<class FString>& OutValues)
{
	static class UFunction* Func = nullptr;
...
// class UDatasmithAssetUserData*     ReturnValue                                                      (None)
...
// Parameters:
// class ULevelSequence*              SequenceToPlay                                                   (None)
