...
public:
	...
	TArray<struct FBoolParameterNameAndCurve>    BoolParameterNamesAndCurves;                       // 0xF8(0x10)(None)
	TArray<struct FScalarParameterNameAndCurve>  ScalarParameterNamesAndCurves;                     // 0x108(0x10)(None)
	TArray<struct FVector2DParameterNameAndCurves> Vector2DParameterNamesAndCurves;                   // 0x118(0x10)(None)
	TArray<struct FVectorParameterNameAndCurves> VectorParameterNamesAndCurves;                     // 0x128(0x10)(None)
	TArray<struct FColorParameterNameAndCurves>  ColorParameterNamesAndCurves;                      // 0x138(0x10)(None)
	TArray<struct FTransformParameterNameAndCurves> TransformParameterNamesAndCurves;                  // 0x148(0x10)(None)
...
{
public:
	class UMovieSceneSection*                    SectionToKey;                                      // 0x98(0x8)(ZeroConstructor)
	struct FMovieScenePropertyBinding            PropertyBinding;                                   // 0xA0(0x14)(None)
	uint8                                        Pad_12EC[0x4];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	TArray<class UMovieSceneSection*>            Sections;                                          // 0xB8(0x10)(ZeroConstructor)
...
{
public:
	struct FMovieSceneCameraAnimSectionData      AnimData;                                          // 0xF0(0x20)(ZeroConstructor)
	class UCameraAnim*                           CameraAnim;                                        // 0x110(0x8)(ZeroConstructor)
	float                                        PlayRate;                                          // 0x118(0x4)(None)
	float                                        PlayScale;                                         // 0x11C(0x4)(None)
	float                                        BlendInTime;                                       // 0x120(0x4)(None)
	float                                        BlendOutTime;                                      // 0x124(0x4)(None)
	bool                                         bLooping;                                          // 0x128(0x1)(None)
...
public:
	...
	TArray<class UMovieSceneSection*>            CameraAnimSections;                                // 0xA0(0x10)(ZeroConstructor)
...
{
public:
	float                                        FloatProperty;                                     // 0x28(0x4)(None)
...
public:
	...
	TArray<class UObject*>                       BoundObjects;                                      // 0x70(0x10)(ZeroConstructor)
	TArray<struct FGuid>                         BindingGuids;                                      // 0x80(0x10)(None)
...
{
public:
	struct FMovieSceneDoublePerlinNoiseChannel   PerlinNoiseChannel;                                // 0x58(0x68)(None)
...
{
public:
	struct FMovieSceneFloatPerlinNoiseChannel    PerlinNoiseChannel;                                // 0x58(0x68)(None)
...
{
public:
	uint8                                        Pad_1309[0x1B0];                                   // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	struct FGuid                                 ConstraintId;                                      // 0xF0(0x10)(None)
	struct FMovieSceneObjectBindingID            ConstraintBindingID;                               // 0x100(0x18)(None)
...
public:
	...
	class FName                                  AttachSocketName;                                  // 0x120(0x8)(None)
	class FName                                  AttachComponentName;                               // 0x128(0x8)(None)
	enum class EAttachmentRule                   AttachmentLocationRule;                            // 0x130(0x1)(None)
	enum class EAttachmentRule                   AttachmentRotationRule;                            // 0x131(0x1)(None)
	enum class EAttachmentRule                   AttachmentScaleRule;                               // 0x132(0x1)(None)
	enum class EDetachmentRule                   DetachmentLocationRule;                            // 0x133(0x1)(None)
	enum class EDetachmentRule                   DetachmentRotationRule;                            // 0x134(0x1)(None)
	enum class EDetachmentRule                   DetachmentScaleRule;                               // 0x135(0x1)(None)
	uint8                                        Pad_1313[0x2];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	struct FMovieSceneFloatChannel               TimingCurve;                                       // 0x118(0x110)(None)
	enum class EMovieScene3DPathSection_Axis     FrontAxisEnum;                                     // 0x228(0x1)(None)
	enum class EMovieScene3DPathSection_Axis     UpAxisEnum;                                        // 0x229(0x1)(None)
	uint8                                        Pad_1316[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	uint8                                        bFollow : 1;                                       // Mask: 0x1, PropSize: 0x10x22C(0x1)(None)
	uint8                                        bReverse : 1;                                      // Mask: 0x2, PropSize: 0x10x22C(0x1)(None)
	uint8                                        bForceUpright : 1;                                 // Mask: 0x4, PropSize: 0x10x22C(0x1)(None)
...
{
public:
	TArray<struct FConstraintAndActiveChannel>   ConstraintsChannels;                               // 0x28(0x10)(None)
...
{
public:
	uint8                                        Pad_1320[0x40];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	struct FMovieSceneTransformMask              TransformMask;                                     // 0x130(0x4)(None)
	uint8                                        Pad_1321[0x4];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FMovieSceneDoubleChannel              Translation[0x3];                                  // 0x138(0x348)(None)
	struct FMovieSceneDoubleChannel              Rotation[0x3];                                     // 0x480(0x348)(None)
	struct FMovieSceneDoubleChannel              Scale[0x3];                                        // 0x7C8(0x348)(None)
	struct FMovieSceneFloatChannel               ManualWeight;                                      // 0xB10(0x110)(None)
	class UMovieSceneSectionChannelOverrideRegistry* OverrideRegistry;                                  // 0xC20(0x8)(ZeroConstructor)
	class UMovieScene3DTransformSectionConstraints* Constraints;                                       // 0xC28(0x8)(ZeroConstructor)
	bool                                         bUseQuaternionInterpolation;                       // 0xC30(0x1)(None)
...
{
public:
	struct FMovieSceneActorReferenceData         ActorReferenceData;                                // 0xF0(0x120)(None)
	struct FIntegralCurve                        ActorGuidIndexCurve;                               // 0x210(0x80)(None)
	TArray<class FString>                        ActorGuidStrings;                                  // 0x290(0x10)(None)
...
{
public:
	class USoundBase*                            Sound;                                             // 0xF0(0x8)(ZeroConstructor)
	struct FFrameNumber                          StartFrameOffset;                                  // 0xF8(0x4)(None)
	bool                                         bForceNeverStopTrack;                              // 0xFC(0x1)(None)
	uint8                                        Pad_132D[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	float                                        StartOffset;                                       // 0x100(0x4)(None)
	float                                        AudioStartTime;                                    // 0x104(0x4)(None)
	float                                        AudioDilationFactor;                               // 0x108(0x4)(None)
	float                                        AudioVolume;                                       // 0x10C(0x4)(None)
	struct FMovieSceneFloatChannel               SoundVolume;                                       // 0x110(0x110)(None)
	struct FMovieSceneFloatChannel               PitchMultiplier;                                   // 0x220(0x110)(None)
	TMap<class FName, struct FMovieSceneFloatChannel> Inputs_Float;                                      // 0x330(0x50)(None)
	TMap<class FName, struct FMovieSceneStringChannel> Inputs_String;                                     // 0x380(0x50)(None)
	TMap<class FName, struct FMovieSceneBoolChannel> Inputs_Bool;                                       // 0x3D0(0x50)(None)
	TMap<class FName, struct FMovieSceneIntegerChannel> Inputs_Int;                                        // 0x420(0x50)(None)
	TMap<class FName, struct FMovieSceneAudioTriggerChannel> Inputs_Trigger;                                    // 0x470(0x50)(None)
	struct FMovieSceneActorReferenceData         AttachActorData;                                   // 0x4C0(0x120)(None)
	bool                                         bLooping;                                          // 0x5E0(0x1)(None)
	bool                                         bSuppressSubtitles;                                // 0x5E1(0x1)(None)
	bool                                         bOverrideAttenuation;                              // 0x5E2(0x1)(None)
	uint8                                        Pad_1330[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class USoundAttenuation*                     AttenuationSettings;                               // 0x5E8(0x8)(ZeroConstructor)
	FDelegateProperty_                           OnQueueSubtitles;                                  // 0x5F0(0x10)(ZeroConstructor)
	FMulticastInlineDelegateProperty_            OnAudioFinished;                                   // 0x600(0x10)(ZeroConstructor)
	FMulticastInlineDelegateProperty_            OnAudioPlaybackPercent;                            // 0x610(0x10)(ZeroConstructor)
...
public:
	...
	struct FMovieSceneByteChannel                ByteCurve;                                         // 0xF8(0x108)(ZeroConstructor)
...
public:
	...
	bool                                         bLockPreviousCamera;                               // 0xF8(0x1)(None)
	uint8                                        Pad_134F[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FGuid                                 CameraGuid;                                        // 0xFC(0x10)(None)
	struct FMovieSceneObjectBindingID            CameraBindingID;                                   // 0x10C(0x18)(None)
	uint8                                        Pad_1350[0xC];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FTransform                            InitialCameraCutTransform;                         // 0x130(0x60)(None)
	bool                                         bHasInitialCameraCutTransform;                     // 0x190(0x1)(None)
	uint8                                        Pad_1351[0xF];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	struct FMovieSceneCameraShakeSectionData     ShakeData;                                         // 0xF0(0x28)(ZeroConstructor)
	class UClass*                                ShakeClass;                                        // 0x118(0x8)(ZeroConstructor)
	float                                        PlayScale;                                         // 0x120(0x4)(None)
	enum class ECameraShakePlaySpace             PlaySpace;                                         // 0x124(0x1)(None)
	uint8                                        Pad_1354[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FRotator                              UserDefinedPlaySpace;                              // 0x128(0x18)(None)
...
{
public:
	struct FMovieSceneCameraShakeSourceTriggerChannel Channel;                                           // 0xF0(0xF8)(ZeroConstructor)
...
{
public:
	class FString                                ShotDisplayName;                                   // 0x138(0x10)(None)
	class FText                                  DisplayName;                                       // 0x148(0x18)(None)
...
public:
	...
	struct FMovieSceneFloatChannel               RedCurve;                                          // 0xF8(0x110)(None)
	struct FMovieSceneFloatChannel               GreenCurve;                                        // 0x208(0x110)(None)
	struct FMovieSceneFloatChannel               BlueCurve;                                         // 0x318(0x110)(None)
	struct FMovieSceneFloatChannel               AlphaCurve;                                        // 0x428(0x110)(None)
...
public:
	...
	TArray<struct FMovieSceneConsoleVariableCollection> ConsoleVariableCollections;                        // 0xF8(0x10)(ZeroConstructor)
	struct FMovieSceneCVarOverrides              ConsoleVariables;                                  // 0x108(0x50)(None)
...
public:
	...
	TArray<struct FActorDataLayer>               DataLayers;                                        // 0xF8(0x10)(None)
	TArray<class UDataLayerAsset*>               DataLayerAssets;                                   // 0x108(0x10)(ZeroConstructor)
	enum class EDataLayerRuntimeState            DesiredState;                                      // 0x118(0x1)(None)
	enum class EDataLayerRuntimeState            PrerollState;                                      // 0x119(0x1)(None)
	bool                                         bFlushOnUnload;                                    // 0x11A(0x1)(None)
	uint8                                        Pad_1397[0x5];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	struct FMovieSceneDoubleChannel              DoubleCurve;                                       // 0xF8(0x118)(None)
...
public:
	...
	struct FMovieSceneByteChannel                EnumCurve;                                         // 0xF8(0x108)(ZeroConstructor)
...
public:
	...
	struct FMovieSceneEvent                      Event;                                             // 0xF8(0x28)(ZeroConstructor)
...
{
public:
	struct FNameCurve                            Events;                                            // 0xF0(0x78)(None)
	struct FMovieSceneEventSectionData           EventData;                                         // 0x168(0xF8)(None)
...
public:
	...
	struct FMovieSceneEventChannel               EventChannel;                                      // 0xF8(0xF8)(ZeroConstructor)
...
{
public:
	uint8                                        Pad_13AA[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FMovieSceneFloatChannel               FloatCurve;                                        // 0xF8(0x110)(None)
	struct FLinearColor                          FadeColor;                                         // 0x208(0x10)(None)
	uint8                                        bFadeAudio : 1;                                    // Mask: 0x1, PropSize: 0x10x218(0x1)(None)
...
{
public:
	uint8                                        Pad_13AE[0x10];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	struct FMovieSceneFloatChannel               FloatCurve;                                        // 0x100(0x110)(None)
	class UMovieSceneSectionChannelOverrideRegistry* OverrideRegistry;                                  // 0x210(0x8)(ZeroConstructor)
...
public:
	...
	struct FMovieSceneIntegerChannel             IntegerCurve;                                      // 0xF8(0x100)(None)
...
{
public:
	uint8                                        Pad_13C3[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	enum class ELevelVisibility                  Visibility;                                        // 0xF8(0x1)(None)
	uint8                                        Pad_13C4[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	TArray<class FName>                          LevelNames;                                        // 0x100(0x10)(None)
...
{
public:
	struct FMovieSceneObjectPathChannel          ObjectChannel;                                     // 0xF0(0x138)(ZeroConstructor)
...
{
public:
	struct FMovieSceneParticleChannel            ParticleKeys;                                      // 0xF0(0x108)(ZeroConstructor)
...
public:
	...
	struct FMovieSceneObjectPathChannel          MaterialChannel;                                   // 0xF8(0x138)(ZeroConstructor)
...
public:
	...
	struct FMovieSceneSkeletalAnimationParams    Params;                                            // 0xF8(0x150)(ZeroConstructor)
	class UAnimSequence*                         AnimSequence;                                      // 0x248(0x8)(ZeroConstructor)
	class UAnimSequenceBase*                     Animation;                                         // 0x250(0x8)(ZeroConstructor)
	float                                        StartOffset;                                       // 0x258(0x4)(None)
	float                                        EndOffset;                                         // 0x25C(0x4)(None)
	float                                        PlayRate;                                          // 0x260(0x4)(None)
	uint8                                        bReverse : 1;                                      // Mask: 0x1, PropSize: 0x10x264(0x1)(None)
	uint8                                        BitPad_103 : 7;                                    // Fixing Bit-Field Size  [ Dumper-7 ]
	uint8                                        Pad_13CE[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class FName                                  SlotName;                                          // 0x268(0x8)(None)
	struct FVector                               StartLocationOffset;                               // 0x270(0x18)(None)
	struct FRotator                              StartRotationOffset;                               // 0x288(0x18)(None)
	bool                                         bMatchWithPrevious;                                // 0x2A0(0x1)(None)
	uint8                                        Pad_13CF[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class FName                                  MatchedBoneName;                                   // 0x2A4(0x8)(None)
	uint8                                        Pad_13D0[0x4];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FVector                               MatchedLocationOffset;                             // 0x2B0(0x18)(None)
	struct FRotator                              MatchedRotationOffset;                             // 0x2C8(0x18)(None)
	bool                                         bMatchTranslation;                                 // 0x2E0(0x1)(None)
	bool                                         bMatchIncludeZHeight;                              // 0x2E1(0x1)(None)
	bool                                         bMatchRotationYaw;                                 // 0x2E2(0x1)(None)
	bool                                         bMatchRotationPitch;                               // 0x2E3(0x1)(None)
	bool                                         bMatchRotationRoll;                                // 0x2E4(0x1)(None)
	uint8                                        Pad_13D1[0x7B];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	struct FMovieSceneFloatChannel               FloatCurve;                                        // 0xF0(0x110)(None)
...
{
public:
	struct FMovieSceneStringChannel              StringCurve;                                       // 0xF0(0x110)(None)
...
public:
	...
	struct FMovieSceneFloatChannel               Curves[0x4];                                       // 0xF8(0x440)(None)
	int32                                        ChannelsUsed;                                      // 0x538(0x4)(None)
...
public:
	...
	struct FMovieSceneDoubleChannel              Curves[0x4];                                       // 0xF8(0x460)(None)
	int32                                        ChannelsUsed;                                      // 0x558(0x4)(None)
...
public:
	...
	class UMovieScenePropertyInstantiatorSystem* InstantiatorSystem;                                // 0x48(0x8)(ZeroConstructor)
...
{
public:
	uint8                                        Pad_13E5[0x190];                                   // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_13E9[0x160];                                   // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_13EB[0x1F0];                                   // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_13F3[0x90];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_13F5[0x18];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1402[0x50];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1432[0x168];                                   // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_143B[0x20];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1440[0x310];                                   // Fixing Size After Last Property  [ Dumper-7 ]
	class UMovieScenePiecewiseDoubleBlenderSystem* DoubleBlenderSystem;                               // 0x350(0x8)(ZeroConstructor)
...
{
public:
	uint8                                        Pad_1455[0x58];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1456[0x28];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1459[0x28];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_145C[0xC8];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1462[0x28];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1468[0x48];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	FMulticastInlineDelegateProperty_            Result;                                            // 0x30(0x10)(ZeroConstructor)
	FMulticastInlineDelegateProperty_            Failure;                                           // 0x40(0x10)(ZeroConstructor)
	uint8                                        Pad_148D[0x10];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	class UMovieSceneSequencePlayer*             SequencePlayer;                                    // 0x60(0x8)(ZeroConstructor)
	class USceneComponent*                       SceneComponent;                                    // 0x68(0x8)(None)
	uint8                                        Pad_148E[0x10];                                    // Fixing Size Of Struct [ Dumper-7 ]

	static class UClass* StaticClass();
	static class UMovieSceneAsyncAction_SequencePrediction* GetDefaultObj();

	void PredictWorldTransformAtTime(class UMovieSceneSequencePlayer* Player, class USceneComponent* TargetComponent, float TimeInSeconds, class UMovieSceneAsyncAction_SequencePrediction* ReturnValue);
	void PredictWorldTransformAtFrame(class UMovieSceneSequencePlayer* Player, class USceneComponent* TargetComponent, const struct FFrameTime& FrameTime, class UMovieSceneAsyncAction_SequencePrediction* ReturnValue);
	void PredictLocalTransformAtTime(class UMovieSceneSequencePlayer* Player, class USceneComponent* TargetComponent, float TimeInSeconds, class UMovieSceneAsyncAction_SequencePrediction* ReturnValue);
	void PredictLocalTransformAtFrame(class UMovieSceneSequencePlayer* Player, class USceneComponent* TargetComponent, const struct FFrameTime& FrameTime, class UMovieSceneAsyncAction_SequencePrediction* ReturnValue);
};
...
{
public:
	uint8                                        Pad_1498[0x90];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	TArray<class UMovieSceneAsyncAction_SequencePrediction*> PendingPredictions;                                // 0xD0(0x10)(ZeroConstructor)
	TArray<class UMovieSceneAsyncAction_SequencePrediction*> ProcessingPredictions;                             // 0xE0(0x10)(ZeroConstructor)
...
{
public:
	uint8                                        Pad_149A[0x208];                                   // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_149C[0x70];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_149E[0xA0];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_14A0[0x38];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_14A1[0x38];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	class UWeightAndEasingEvaluatorSystem*       EvaluatorSystem;                                   // 0x78(0x8)(ZeroConstructor)
...
{
public:
	uint8                                        Pad_14A3[0x78];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_14A4[0x50];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	TArray<class UMovieSceneSection*>            ConstraintSections;                                // 0x98(0x10)(ZeroConstructor)
...
public:
	...
	class UClass*                                BlenderSystemClass;                                // 0xD0(0x8)(ZeroConstructor)
...
public:
	...
	TArray<class UMovieSceneSection*>            AudioSections;                                     // 0xA0(0x10)(ZeroConstructor)
...
{
public:
	class UEnum*                                 Enum;                                              // 0xC8(0x8)(ZeroConstructor)
...
{
public:
	bool                                         bCanBlend;                                         // 0x98(0x1)(None)
	uint8                                        Pad_14B6[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	TArray<class UMovieSceneSection*>            Sections;                                          // 0xA0(0x10)(ZeroConstructor)
...
public:
	...
	TArray<class UMovieSceneSection*>            CameraShakeSections;                               // 0xA0(0x10)(ZeroConstructor)
...
{
public:
	bool                                         bIsSlateColor;                                     // 0xC8(0x1)(None)
...
{
public:
	uint8                                        Pad_14C1[0x10];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	uint8                                        bFireEventsWhenForwards : 1;                       // Mask: 0x1, PropSize: 0x10xA8(0x1)(None)
	uint8                                        bFireEventsWhenBackwards : 1;                      // Mask: 0x2, PropSize: 0x10xA8(0x1)(None)
	uint8                                        BitPad_106 : 6;                                    // Fixing Bit-Field Size  [ Dumper-7 ]
	uint8                                        Pad_14C2[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	enum class EFireEventsAtPosition             EventPosition;                                     // 0xAC(0x1)(None)
	uint8                                        Pad_14C3[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	TArray<class UMovieSceneSection*>            Sections;                                          // 0xB0(0x10)(ZeroConstructor)
...
public:
	...
	class UMaterialParameterCollection*          MPC;                                               // 0xB8(0x8)(ZeroConstructor)
...
{
public:
	uint8                                        Pad_14D1[0x10];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	int32                                        MaterialIndex;                                     // 0xB8(0x4)(None)
...
public:
	...
	class UClass*                                PropertyClass;                                     // 0xD0(0x8)(ZeroConstructor)
...
public:
	...
	TArray<class UMovieSceneSection*>            ParticleSections;                                  // 0xA0(0x10)(ZeroConstructor)
...
{
public:
	int32                                        MaterialIndex;                                     // 0xC8(0x4)(None)
...
{
public:
	TArray<class UMovieSceneSection*>            AnimationSections;                                 // 0x98(0x10)(ZeroConstructor)
	bool                                         bUseLegacySectionIndexBlend;                       // 0xA8(0x1)(None)
	uint8                                        Pad_14E6[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FMovieSceneSkeletalAnimRootMotionTrackParams RootMotionParams;                                  // 0xB0(0x80)(None)
	bool                                         bBlendFirstChildOfRoot;                            // 0x130(0x1)(None)
...
{
public:
	uint8                                        Pad_14E8[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	int32                                        NumChannelsUsed;                                   // 0xC8(0x4)(None)
