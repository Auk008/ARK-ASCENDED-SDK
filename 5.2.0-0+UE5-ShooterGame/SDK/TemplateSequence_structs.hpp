...
{
public:
	struct FGuid                                 ObjectBinding;                                     // 0x0(0x10)(None)
	struct FMovieScenePropertyBinding            PropertyBinding;                                   // 0x10(0x14)(None)
	enum class ETemplateSectionPropertyScaleType PropertyScaleType;                                 // 0x24(0x4)(None)
	struct FMovieSceneFloatChannel               FloatChannel;                                      // 0x28(0x110)(None)
};
...
{
public:
	TWeakObjectPtr<class UObject>                Object;                                            // 0x0(0x8)(None)
