...
{
public:
	int32                                        NumSubsteps;                                       // 0x0(0x4)(None)
};
...
{
public:
	int32                                        MaxNumIterations;                                  // 0x0(0x4)(None)
};
...
{
public:
	float                                        InStiffness;                                       // 0x0(0x4)(None)
};
...
{
public:
	class FString                                ClothingAssetName;                                 // 0x0(0x10)(None)
	class UClothingInteractor*                   ReturnValue;                                       // 0x10(0x8)(None)
};
...
{
public:
	struct FVector                               InVector;                                          // 0x0(0x18)(None)
};
