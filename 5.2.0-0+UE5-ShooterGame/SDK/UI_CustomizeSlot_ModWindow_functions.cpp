...
void UUI_CustomizeSlot_ModWindow_C::SetColor(const struct FLinearColor& Color, bool CallFunc_IsValid_ReturnValue)
{
...
void UUI_CustomizeSlot_ModWindow_C::GetColor(const struct FLinearColor& Color, const struct FCFCoreThemeRowData& CallFunc_GetCurrentTheme_CurrentTheme)
{
	static class UFunction* Func = nullptr;
