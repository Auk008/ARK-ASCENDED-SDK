...
{
public:
	bool                                         bEnableAutocorrect;                                // 0x0(0x1)(None)
};
...
public:
	...
	uint8                                        bShift : 1;                                        // Mask: 0x1, PropSize: 0x10x18(0x1)(None)
	uint8                                        bCtrl : 1;                                         // Mask: 0x2, PropSize: 0x10x18(0x1)(None)
	uint8                                        bAlt : 1;                                          // Mask: 0x4, PropSize: 0x10x18(0x1)(None)
	uint8                                        bCmd : 1;                                          // Mask: 0x8, PropSize: 0x10x18(0x1)(None)
...
{
public:
	struct FVector2D                             Minimum;                                           // 0x0(0x10)(None)
	struct FVector2D                             Maximum;                                           // 0x10(0x10)(None)
};
...
{
public:
	enum class ECustomizedToolMenuVisibility     Visibility;                                        // 0x0(0x4)(None)
};
...
{
public:
	TArray<class FName>                          Names;                                             // 0x0(0x10)(None)
};
...
public:
	...
	TMap<class FName, struct FCustomizedToolMenuEntry> Entries;                                           // 0x8(0x50)(ContainsInstancedReference, AssetRegistrySearchable, SimpleDisplay, AdvancedDisplay, Protected, BlueprintAuthorityOnly, ExposeOnSpawn, PersistentInstance)
	TMap<class FName, struct FCustomizedToolMenuSection> Sections;                                          // 0x58(0x50)(AutoWeak, BlueprintCallable, BlueprintAuthorityOnly, ExposeOnSpawn, PersistentInstance)
	TMap<class FName, struct FCustomizedToolMenuNameArray> EntryOrder;                                        // 0xA8(0x50)(ContainsInstancedReference, AssetRegistrySearchable, SimpleDisplay, AdvancedDisplay, BlueprintAuthorityOnly, TextExportTransient, NonPIEDuplicateTransient, ExposeOnSpawn, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, NativeAccessSpecifierProtected, NativeAccessSpecifierPrivate)
	TArray<class FName>                          SectionOrder;                                      // 0xF8(0x10)(None)
	uint8                                        Pad_28F3[0xE8];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
