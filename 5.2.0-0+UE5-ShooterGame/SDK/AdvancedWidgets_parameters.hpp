...
{
public:
	TArray<float>                                InValueTags;                                       // 0x0(0x10)(None)
};
...
{
public:
	bool                                         InUseVerticalDrag;                                 // 0x0(0x1)(None)
};
...
{
public:
	struct FRuntimeFloatCurve                    InSliderRange;                                     // 0x0(0x88)(None)
};
...
{
public:
	bool                                         InShowSliderHandle;                                // 0x0(0x1)(None)
};
...
{
public:
	bool                                         InShowSliderHand;                                  // 0x0(0x1)(None)
};
