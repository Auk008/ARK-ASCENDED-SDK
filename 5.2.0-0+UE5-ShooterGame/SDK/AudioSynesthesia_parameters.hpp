...
{
public:
	float                                        InSeconds;                                         // 0x0(0x4)(None)
	int32                                        InChannel;                                         // 0x4(0x4)(None)
	TArray<float>                                OutConstantQ;                                      // 0x8(0x10)(None)
};
...
public:
	float                                        InSeconds;                                         // 0x0(0x4)(None)
	float                                        OutLoudness;                                       // 0x4(0x4)(None)
};
...
public:
	float                                        InSeconds;                                         // 0x0(0x4)(None)
	int32                                        InChannel;                                         // 0x4(0x4)(None)
	float                                        OutLoudness;                                       // 0x8(0x4)(None)
};
...
{
public:
	float                                        InStartSeconds;                                    // 0x0(0x4)(None)
	float                                        InEndSeconds;                                      // 0x4(0x4)(None)
	int32                                        InChannel;                                         // 0x8(0x4)(None)
	uint8                                        Pad_2674[0x4];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	TArray<float>                                OutOnsetTimestamps;                                // 0x10(0x10)(None)
	TArray<float>                                OutOnsetStrengths;                                 // 0x20(0x10)(None)
};
...
{
public:
	float                                        InSampleRate;                                      // 0x0(0x4)(None)
	uint8                                        Pad_267D[0x4];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	TArray<float>                                OutCenterFrequencies;                              // 0x8(0x10)(None)
};
