...
// class USoundscapePalette*          SoundscapePaletteIn                                              (ZeroConstructor)
// class UActiveSoundscapePalette*    SoundscapePaletteAgentsOut                                       (None)
// bool                               ReturnValue                                                      (None)

void USoundscapeBPFunctionLibrary::SpawnSoundscapePalette(class UObject* WorldContextObject, class USoundscapePalette* SoundscapePaletteIn, class UActiveSoundscapePalette* SoundscapePaletteAgentsOut, bool ReturnValue)
{
	...
	Parms.SoundscapePaletteAgentsOut = SoundscapePaletteAgentsOut;
...
// Parameters:
// class UObject*                     WorldContextObject                                               (ZeroConstructor)
// class USoundscapeColor*            SoundscapeColorIn                                                (ZeroConstructor)
// class UActiveSoundscapeColor*      ActiveSoundscapeColor                                            (None)
// bool                               ReturnValue                                                      (None)

void USoundscapeBPFunctionLibrary::SpawnSoundscapeColor(class UObject* WorldContextObject, class USoundscapeColor* SoundscapeColorIn, class UActiveSoundscapeColor* ActiveSoundscapeColor, bool ReturnValue)
{
	static class UFunction* Func = nullptr;
...
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// float                              ColorVolume                                                      (None)
// float                              ColorPitch                                                       (None)
// float                              ColorFadeInTime                                                  (None)
...
// Parameters:
// struct FVector                     Location                                                         (None)
// struct FGameplayTag                ColorPoint                                                       (None)
// int32                              ReturnValue                                                      (None)

void USoundscapeColorPointHashMap::NumColorPointsInCell(const struct FVector& Location, const struct FGameplayTag& ColorPoint, int32 ReturnValue)
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// float                              HashCellSizeIn                                                   (None)
// struct FVector                     GridCenterIn                                                     (None)
...
// Parameters:
// struct FVector                     Location                                                         (None)
// uint64                             ReturnValue                                                      (None)

void USoundscapeColorPointHashMap::CalculateHashIndex(const struct FVector& Location, uint64 ReturnValue)
{
	static class UFunction* Func = nullptr;
...
void USoundscapeColorPointHashMap::AddColorPointToHash(const struct FVector& Location, const struct FGameplayTag& ColorPoint, bool ReturnValue)
{
	static class UFunction* Func = nullptr;
...
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// struct FGameplayTag                SoundscapeState                                                  (None)
...
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// class FName                        PaletteCollectionName                                            (None)
// bool                               ReturnValue                                                      (None)
...
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// class FName                        ColorPointCollectionName                                         (None)
// bool                               ReturnValue                                                      (None)
...
void USoundscapeSubsystem::CheckColorPointDensity(const struct FVector& Location, const struct FGameplayTag& ColorPoint, int32 ReturnValue)
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// class FName                        PaletteCollectionName                                            (None)
// struct FSoundscapePaletteCollectionPaletteCollection                                                (None)
// bool                               ReturnValue                                                      (None)
...
// Parameters:
// class FName                        ColorPointCollectionName                                         (None)
// struct FSoundscapeColorPointCollectionColorPointCollection                                             (None)
