...
{
public:
	class UMotionWarpingComponent*               MotionWarpingComp;                                 // 0x0(0x8)(ZeroConstructor)
	class URootMotionModifier*                   Modifier;                                          // 0x8(0x8)(None)
};
...
public:
	...
	float                                        StartTime;                                         // 0x10(0x4)(None)
	float                                        EndTime;                                           // 0x14(0x4)(None)
	class URootMotionModifier*                   ReturnValue;                                       // 0x18(0x8)(None)
};
...
public:
	...
	TArray<struct FMotionWarpingWindowData>      OutWindows;                                        // 0x8(0x10)(None)
};
...
public:
	class UAnimSequenceBase*                     Animation;                                         // 0x0(0x8)(ZeroConstructor)
	class FName                                  WarpTargetName;                                    // 0x8(0x8)(None)
	TArray<struct FMotionWarpingWindowData>      OutWindows;                                        // 0x10(0x10)(None)
};
...
{
public:
	class UAnimSequenceBase*                     Animation;                                         // 0x0(0x8)(None)
...
{
public:
	class FName                                  WarpTargetName;                                    // 0x0(0x8)(None)
...
public:
	class FName                                  WarpTargetName;                                    // 0x0(0x8)(None)
	struct FVector                               TargetLocation;                                    // 0x8(0x18)(None)
	struct FRotator                              TargetRotation;                                    // 0x20(0x18)(None)
};
...
public:
	class FName                                  WarpTargetName;                                    // 0x0(0x8)(None)
	class USceneComponent*                       Component;                                         // 0x8(0x8)(None)
	class FName                                  BoneName;                                          // 0x10(0x8)(None)
	bool                                         bFollowComponent;                                  // 0x18(0x1)(None)
...
{
public:
	struct FMotionWarpingTarget                  WarpTarget;                                        // 0x0(0x50)(None)
};
...
{
public:
	class UMotionWarpingComponent*               InMotionWarpingComp;                               // 0x0(0x8)(ZeroConstructor)
	class UAnimSequenceBase*                     InAnimation;                                       // 0x8(0x8)(ZeroConstructor)
	float                                        InStartTime;                                       // 0x10(0x4)(None)
	float                                        InEndTime;                                         // 0x14(0x4)(None)
	struct FVector                               InScale;                                           // 0x18(0x18)(None)
	class URootMotionModifier_Scale*             ReturnValue;                                       // 0x30(0x8)(None)
};
...
public:
	...
	float                                        InStartTime;                                       // 0x10(0x4)(None)
	float                                        InEndTime;                                         // 0x14(0x4)(None)
	class FName                                  InWarpTargetName;                                  // 0x18(0x8)(None)
	enum class EWarpPointAnimProvider            InWarpPointAnimProvider;                           // 0x20(0x1)(None)
	uint8                                        Pad_31F[0xF];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	struct FTransform                            InWarpPointAnimTransform;                          // 0x30(0x60)(None)
	class FName                                  InWarpPointAnimBoneName;                           // 0x90(0x8)(None)
	bool                                         bInWarpTranslation;                                // 0x98(0x1)(None)
	bool                                         bInIgnoreZAxis;                                    // 0x99(0x1)(None)
	bool                                         bInWarpRotation;                                   // 0x9A(0x1)(None)
	enum class EMotionWarpRotationType           InRotationType;                                    // 0x9B(0x1)(None)
	float                                        InWarpRotationTimeMultiplier;                      // 0x9C(0x4)(None)
	class URootMotionModifier_SkewWarp*          ReturnValue;                                       // 0xA0(0x8)(None)
