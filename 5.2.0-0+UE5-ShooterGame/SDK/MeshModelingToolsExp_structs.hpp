...
{
public:
	class UStaticMesh*                           SourceMesh;                                        // 0x0(0x8)(ZeroConstructor)
	class UTexture2D*                            SourceTexture;                                     // 0x8(0x8)(None)
	int32                                        SourceTextureUVLayer;                              // 0x10(0x4)(None)
...
{
public:
	class UTransformProxy*                       TransformProxy;                                    // 0x0(0x8)(ZeroConstructor)
	class UCombinedTransformGizmo*               TransformGizmo;                                    // 0x8(0x8)(None)
};
...
public:
	...
	uint8                                        Pad_1ED1[0xC];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FTransform                            Transform;                                         // 0x10(0x60)(None)
	struct FKShapeElem                           Element;                                           // 0x70(0x30)(None)
};
...
{
public:
	struct FVector                               Dimensions;                                        // 0x0(0x18)(None)
	uint8                                        Pad_1ED3[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FTransform                            Transform;                                         // 0x20(0x60)(None)
	struct FKShapeElem                           Element;                                           // 0x80(0x30)(None)
};
...
{
public:
	int32                                        NumVertices;                                       // 0x0(0x4)(None)
	int32                                        NumFaces;                                          // 0x4(0x4)(None)
	struct FKShapeElem                           Element;                                           // 0x8(0x30)(None)
};
...
{
public:
	struct FKShapeElem                           Element;                                           // 0x0(0x30)(None)
};
...
{
public:
	enum class EBrushToolSizeType                SizeType;                                          // 0x0(0x1)(None)
	uint8                                        Pad_1ED6[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	float                                        AdaptiveSize;                                      // 0x4(0x4)(None)
	float                                        WorldRadius;                                       // 0x8(0x4)(None)
