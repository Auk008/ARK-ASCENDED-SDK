...
// Parameters:
// class UResonanceAudioReverbPluginPreset*InPreset                                                         (None)
...
// (Final, Native, Static, Public, BlueprintCallable)
// Parameters:
// class UResonanceAudioReverbPluginPreset*ReturnValue                                                      (None)
...
// Parameters:
// TArray<enum class ERaMaterialName> InMaterials                                                      (None)
...
// (Final, Native, Public, HasOutParams, HasDefaults, BlueprintCallable)
// Parameters:
// struct FVector                     InDimensions                                                     (None)
...
// Parameters:
// float                              InReverbTimeModifier                                             (None)
...
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// bool                               bInEnableRoomEffects                                             (None)
...
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// float                              InPattern                                                        (None)
// float                              InSharpness                                                      (None)
