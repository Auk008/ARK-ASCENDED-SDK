...
// Parameters:
// class UGeometryCacheComponent*     ReturnValue                                                      (None)
...
// Parameters:
// float                              Time                                                             (None)
// bool                               bInIsRunning                                                     (None)
// bool                               bInBackwards                                                     (None)
// bool                               bInIsLooping                                                     (None)
...
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// float                              NewMotionVectorScale                                             (None)
...
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// class UGeometryCache*              NewGeomCache                                                     (None)
...
// Parameters:
// struct FGeometryCacheMeshData      MeshData                                                         (None)
// float                              SampleTime                                                       (None)
...
// (Final, Native, Public, HasOutParams)
// Parameters:
// struct FGeometryCacheMeshData      NewMeshData                                                      (None)
