...
{
public:
	class USplineComponent*                      ReturnValue;                                       // 0x0(0x8)(None)
};
...
{
public:
	class UCineCameraComponent*                  ReturnValue;                                       // 0x0(0x8)(None)
};
...
{
public:
	struct FCameraLensSettings                   NewLensSettings;                                   // 0x0(0x1C)(None)
};
...
{
public:
	class FString                                InPresetName;                                      // 0x0(0x10)(None)
};
...
{
public:
	struct FCameraFocusSettings                  NewFocusSettings;                                  // 0x0(0x68)(None)
};
...
{
public:
	struct FCameraFilmbackSettings               NewFilmback;                                       // 0x0(0xC)(None)
};
...
{
public:
	float                                        NewCustomNearClippingPlane;                        // 0x0(0x4)(None)
};
...
{
public:
	float                                        InFocalLength;                                     // 0x0(0x4)(None)
};
...
{
public:
	float                                        NewCurrentAperture;                                // 0x0(0x4)(None)
};
...
{
public:
	struct FPlateCropSettings                    NewCropSettings;                                   // 0x0(0x4)(None)
};
...
{
public:
	TArray<struct FNamedLensPreset>              ReturnValue;                                       // 0x0(0x10)(None)
};
...
{
public:
	TArray<struct FNamedFilmbackPreset>          ReturnValue;                                       // 0x0(0x10)(None)
};
...
{
public:
	TArray<struct FNamedLensPreset>              InLensPresets;                                     // 0x0(0x10)(None)
};
...
{
public:
	TArray<struct FNamedFilmbackPreset>          InFilmbackPresets;                                 // 0x0(0x10)(None)
};
...
{
public:
	class FString                                InDefaultLensPresetName;                           // 0x0(0x10)(None)
};
...
{
public:
	float                                        InDefaultLensFStop;                                // 0x0(0x4)(None)
};
...
{
public:
	float                                        InDefaultLensFocalLength;                          // 0x0(0x4)(None)
};
...
{
public:
	class FString                                InDefaultFilmbackPreset;                           // 0x0(0x10)(None)
};
...
{
public:
	class FString                                InDefaultCropPresetName;                           // 0x0(0x10)(None)
};
...
{
public:
	TArray<struct FNamedPlateCropPreset>         InCropPresets;                                     // 0x0(0x10)(None)
};
...
{
public:
	class FString                                PresetName;                                        // 0x0(0x10)(None)
	struct FCameraLensSettings                   LensSettings;                                      // 0x10(0x1C)(None)
	bool                                         ReturnValue;                                       // 0x2C(0x1)(None)
	uint8                                        Pad_2E8D[0x3];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_2EA5[0x3];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	class UCineCameraSettings*                   ReturnValue;                                       // 0x0(0x8)(None)
};
