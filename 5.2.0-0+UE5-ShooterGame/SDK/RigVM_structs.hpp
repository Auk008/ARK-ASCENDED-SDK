...
public:
	...
	enum class ERigVMDrawSettings                PrimitiveType;                                     // 0x8(0x1)(None)
	uint8                                        Pad_1317[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	TArray<struct FVector>                       Positions;                                         // 0x10(0x10)(None)
	struct FLinearColor                          Color;                                             // 0x20(0x10)(None)
	float                                        Thickness;                                         // 0x30(0x4)(None)
	uint8                                        Pad_1319[0xC];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FTransform                            Transform;                                         // 0x40(0x60)(None)
	uint8                                        Pad_131A[0x30];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	TArray<struct FRigVMDrawInstruction>         Instructions;                                      // 0x8(0x10)(None)
};
...
{
public:
	int32                                        MaximumArraySize;                                  // 0x0(0x4)(None)
	uint8                                        Pad_131E[0x14];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_1339[0xF0];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	float                                        Size;                                              // 0x4(0x4)(None)
	float                                        LinearDamping;                                     // 0x8(0x4)(None)
	float                                        InheritMotion;                                     // 0xC(0x4)(None)
	struct FVector                               Position;                                          // 0x10(0x18)(None)
	struct FVector                               LinearVelocity;                                    // 0x28(0x18)(None)
};
...
public:
	...
	struct FRigVMExecuteContext                  ExecuteContext;                                    // 0x10(0xF0)(None)
};
...
public:
	...
	struct FVector                               C;                                                 // 0x30(0x18)(None)
	struct FVector                               D;                                                 // 0x48(0x18)(None)
};
...
{
public:
	uint8                                        Pad_1374[0x30];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	struct FSoftObjectPath                       LibraryNode;                                       // 0x0(0x20)(ContainsInstancedReference, AssetRegistrySearchable, AdvancedDisplay, BlueprintCallable, BlueprintAuthorityOnly, TextExportTransient, NonPIEDuplicateTransient, ExposeOnSpawn, PersistentInstance, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FSoftObjectPath                       HostObject;                                        // 0x20(0x20)(None)
};
...
public:
	...
	class FName                                  CPPType;                                           // 0x10(0x8)(None)
	TSoftObjectPtr<class UObject>                CPPTypeObject;                                     // 0x18(0x30)(SimpleDisplay, BlueprintCallable, BlueprintAuthorityOnly, TextExportTransient, NonPIEDuplicateTransient, ExposeOnSpawn, PersistentInstance, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                         bIsArray;                                          // 0x48(0x1)(None)
	enum class ERigVMPinDirection                Direction;                                         // 0x49(0x1)(None)
	uint8                                        Pad_137C[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class FString                                DefaultValue;                                      // 0x50(0x10)(AdvancedDisplay, BlueprintCallable, BlueprintAuthorityOnly, ExposeOnSpawn, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                         bIsConst;                                          // 0x60(0x1)(None)
	uint8                                        Pad_137D[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	TMap<class FString, class FText>             PathToTooltip;                                     // 0x68(0x50)(None)
};
...
{
public:
	struct FRigVMGraphFunctionIdentifier         LibraryPointer;                                    // 0x0(0x40)(ContainsInstancedReference, AdvancedDisplay, Protected, BlueprintAuthorityOnly, TextExportTransient, NonPIEDuplicateTransient, ExposeOnSpawn, PersistentInstance, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FName                                  Name;                                              // 0x40(0x8)(None)
	class FString                                NodeTitle;                                         // 0x48(0x10)(ContainsInstancedReference, AssetRegistrySearchable, AdvancedDisplay, Protected, BlueprintAuthorityOnly, TextExportTransient, NonPIEDuplicateTransient, ExposeOnSpawn, PersistentInstance, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FLinearColor                          NodeColor;                                         // 0x58(0x10)(None)
	class FText                                  Tooltip;                                           // 0x68(0x18)(SimpleDisplay, AdvancedDisplay, Protected, BlueprintAuthorityOnly, TextExportTransient, NonPIEDuplicateTransient, ExposeOnSpawn, PersistentInstance, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                Category;                                          // 0x80(0x10)(ContainsInstancedReference, SimpleDisplay, AdvancedDisplay, Protected, BlueprintAuthorityOnly, TextExportTransient, NonPIEDuplicateTransient, ExposeOnSpawn, PersistentInstance, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                Keywords;                                          // 0x90(0x10)(ContainsInstancedReference, AssetRegistrySearchable, SimpleDisplay, AdvancedDisplay, Protected, BlueprintCallable, BlueprintAuthorityOnly, NonPIEDuplicateTransient, PersistentInstance, UObjectWrapper, NativeAccessSpecifierPublic)
	TArray<struct FRigVMGraphFunctionArgument>   Arguments;                                         // 0xA0(0x10)(AutoWeak, SimpleDisplay, AdvancedDisplay, BlueprintCallable, BlueprintAuthorityOnly, ExposeOnSpawn, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TMap<struct FRigVMGraphFunctionIdentifier, uint32> Dependencies;                                      // 0xB0(0x50)(AutoWeak, TextExportTransient, NonPIEDuplicateTransient, PersistentInstance, UObjectWrapper, NativeAccessSpecifierPublic)
	TArray<struct FRigVMExternalVariable>        ExternalVariables;                                 // 0x100(0x10)(None)
};
...
public:
	class FName                                  Name;                                              // 0x0(0x8)(None)
	int32                                        InstructionIndex;                                  // 0x8(0x4)(None)
};
...
public:
	...
	class FName                                  Label;                                             // 0x4(0x8)(None)
	int32                                        InstructionIndex;                                  // 0xC(0x4)(None)
	int32                                        ArgumentIndex;                                     // 0x10(0x4)(None)
	uint16                                       FirstInstruction;                                  // 0x14(0x2)(None)
	uint16                                       LastInstruction;                                   // 0x16(0x2)(None)
};
...
{
public:
	TArray<uint8>                                ByteCode;                                          // 0x0(0x10)(ContainsInstancedReference, AssetRegistrySearchable, TextExportTransient, NonPIEDuplicateTransient, PersistentInstance, UObjectWrapper, NativeAccessSpecifierPublic)
	int32                                        NumInstructions;                                   // 0x10(0x4)(None)
	uint8                                        Pad_13E6[0x4];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	TArray<struct FRigVMByteCodeEntry>           Entries;                                           // 0x18(0x10)(SimpleDisplay, TextExportTransient, NonPIEDuplicateTransient, PersistentInstance, UObjectWrapper, NativeAccessSpecifierPublic)
	TArray<struct FRigVMBranchInfo>              BranchInfos;                                       // 0x28(0x10)(None)
	uint8                                        Pad_13E7[0x58];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	class FName                                  Name;                                              // 0x0(0x8)(None)
	class FString                                CPPType;                                           // 0x8(0x10)(ContainsInstancedReference, AssetRegistrySearchable, BlueprintAuthorityOnly, TextExportTransient, NonPIEDuplicateTransient, ExposeOnSpawn, PersistentInstance, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TSoftObjectPtr<class UObject>                CPPTypeObject;                                     // 0x18(0x30)(SimpleDisplay, BlueprintAuthorityOnly, TextExportTransient, NonPIEDuplicateTransient, ExposeOnSpawn, PersistentInstance, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                DefaultValue;                                      // 0x48(0x10)(None)
};
...
{
public:
	int32                                        PropertyIndex;                                     // 0x0(0x4)(None)
	uint8                                        Pad_13EA[0x4];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class FString                                HeadCPPType;                                       // 0x8(0x10)(AdvancedDisplay, BlueprintAuthorityOnly, TextExportTransient, NonPIEDuplicateTransient, ExposeOnSpawn, PersistentInstance, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                SegmentPath;                                       // 0x18(0x10)(None)
};
...
{
public:
	enum class ERigVMMemoryType                  MemoryType;                                        // 0x0(0x1)(None)
	uint8                                        Pad_13ED[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	uint16                                       RegisterIndex;                                     // 0x2(0x2)(None)
	uint16                                       RegisterOffset;                                    // 0x4(0x2)(None)
};
...
{
public:
	struct FRigVMByteCode                        ByteCode;                                          // 0x0(0x90)(AutoWeak, ContainsInstancedReference, SimpleDisplay, TextExportTransient, NonPIEDuplicateTransient, PersistentInstance, UObjectWrapper, NativeAccessSpecifierPublic)
	TArray<class FName>                          FunctionNames;                                     // 0x90(0x10)(AutoWeak, AssetRegistrySearchable, SimpleDisplay, TextExportTransient, NonPIEDuplicateTransient, PersistentInstance, UObjectWrapper, NativeAccessSpecifierPublic)
	TArray<struct FRigVMFunctionCompilationPropertyDescription> WorkPropertyDescriptions;                          // 0xA0(0x10)(ZeroConstructor, AdvancedDisplay, TextExportTransient, NonPIEDuplicateTransient, PersistentInstance, UObjectWrapper, NativeAccessSpecifierPublic)
	TArray<struct FRigVMFunctionCompilationPropertyPath> WorkPropertyPathDescriptions;                      // 0xB0(0x10)(ContainsInstancedReference, AdvancedDisplay, TextExportTransient, NonPIEDuplicateTransient, PersistentInstance, UObjectWrapper, NativeAccessSpecifierPublic)
	TArray<struct FRigVMFunctionCompilationPropertyDescription> LiteralPropertyDescriptions;                       // 0xC0(0x10)(ZeroConstructor, AutoWeak, AssetRegistrySearchable, AdvancedDisplay, TextExportTransient, NonPIEDuplicateTransient, PersistentInstance, UObjectWrapper, NativeAccessSpecifierPublic)
	TArray<struct FRigVMFunctionCompilationPropertyPath> LiteralPropertyPathDescriptions;                   // 0xD0(0x10)(AutoWeak, ContainsInstancedReference, AssetRegistrySearchable, AdvancedDisplay, TextExportTransient, NonPIEDuplicateTransient, PersistentInstance, UObjectWrapper, NativeAccessSpecifierPublic)
	TArray<struct FRigVMFunctionCompilationPropertyDescription> DebugPropertyDescriptions;                         // 0xE0(0x10)(ZeroConstructor, ContainsInstancedReference, SimpleDisplay, AdvancedDisplay, TextExportTransient, NonPIEDuplicateTransient, PersistentInstance, UObjectWrapper, NativeAccessSpecifierPublic)
	TArray<struct FRigVMFunctionCompilationPropertyPath> DebugPropertyPathDescriptions;                     // 0xF0(0x10)(AssetRegistrySearchable, SimpleDisplay, AdvancedDisplay, TextExportTransient, NonPIEDuplicateTransient, PersistentInstance, UObjectWrapper, NativeAccessSpecifierPublic)
	TArray<struct FRigVMFunctionCompilationPropertyDescription> ExternalPropertyDescriptions;                      // 0x100(0x10)(AutoWeak, ContainsInstancedReference, AssetRegistrySearchable, SimpleDisplay, AdvancedDisplay, TextExportTransient, NonPIEDuplicateTransient, PersistentInstance, UObjectWrapper, NativeAccessSpecifierPublic)
	TArray<struct FRigVMFunctionCompilationPropertyPath> ExternalPropertyPathDescriptions;                  // 0x110(0x10)(ContainsInstancedReference, AssetRegistrySearchable, SimpleDisplay, Protected, BlueprintCallable, BlueprintAuthorityOnly, ExposeOnSpawn, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TMap<int32, class FName>                     ExternalRegisterIndexToVariable;                   // 0x120(0x50)(AssetRegistrySearchable, AdvancedDisplay, Protected, BlueprintCallable, BlueprintAuthorityOnly, ExposeOnSpawn, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TMap<class FString, struct FRigVMOperand>    Operands;                                          // 0x170(0x50)(None)
	uint32                                       Hash;                                              // 0x1C0(0x4)(None)
...
{
public:
	struct FRigVMGraphFunctionHeader             Header;                                            // 0x0(0x110)(ZeroConstructor, ContainsInstancedReference, AssetRegistrySearchable, SimpleDisplay, AdvancedDisplay, TextExportTransient, NonPIEDuplicateTransient, ExposeOnSpawn, PersistentInstance, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FRigVMFunctionCompilationData         CompilationData;                                   // 0x110(0x1C8)(Protected, TextExportTransient, NonPIEDuplicateTransient, ExposeOnSpawn, PersistentInstance, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                SerializedCollapsedNode;                           // 0x2D8(0x10)(None)
};
...
{
public:
	TArray<struct FRigVMGraphFunctionData>       PublicFunctions;                                   // 0x0(0x10)(ZeroConstructor, AssetRegistrySearchable, Protected, TextExportTransient, NonPIEDuplicateTransient, PersistentInstance, UObjectWrapper, NativeAccessSpecifierPublic)
	TArray<struct FRigVMGraphFunctionData>       PrivateFunctions;                                  // 0x10(0x10)(None)
};
...
{
public:
	int32                                        RegisterCount;                                     // 0x0(0x4)(None)
	int32                                        DataBytes;                                         // 0x4(0x4)(None)
	int32                                        TotalBytes;                                        // 0x8(0x4)(None)
};
...
{
public:
	int32                                        InstructionCount;                                  // 0x0(0x4)(None)
	int32                                        DataBytes;                                         // 0x4(0x4)(None)
};
...
{
public:
	int32                                        BytesForCDO;                                       // 0x0(0x4)(None)
	int32                                        BytesPerInstance;                                  // 0x4(0x4)(None)
	struct FRigVMMemoryStatistics                LiteralMemory;                                     // 0x8(0xC)(None)
	struct FRigVMMemoryStatistics                WorkMemory;                                        // 0x14(0xC)(None)
	struct FRigVMMemoryStatistics                DebugMemory;                                       // 0x20(0xC)(None)
	int32                                        BytesForCaching;                                   // 0x2C(0x4)(None)
	struct FRigVMByteCodeStatistics              ByteCode;                                          // 0x30(0x8)(None)
};
...
{
public:
	enum class ERigVMParameterType               Type;                                              // 0x0(0x1)(None)
	uint8                                        Pad_13F7[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class FName                                  Name;                                              // 0x4(0x8)(None)
	int32                                        RegisterIndex;                                     // 0xC(0x4)(None)
	class FString                                CPPType;                                           // 0x10(0x10)(None)
	class UScriptStruct*                         ScriptStruct;                                      // 0x20(0x8)(None)
	class FName                                  ScriptStructPath;                                  // 0x28(0x8)(None)
};
...
{
public:
	uint8                                        Pad_13F9[0x1];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_13FD[0xD];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_13FE[0x13];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_13FF[0x19];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_1400[0x1F];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_1401[0x25];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_1403[0x11];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_1405[0x13];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_1409[0xB];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint64                                       ByteCodeIndex;                                     // 0x0(0x8)(None)
	enum class ERigVMOpCode                      OpCode;                                            // 0x8(0x1)(None)
	uint8                                        OperandAlignment;                                  // 0x9(0x1)(None)
...
{
public:
	TArray<struct FRigVMInstruction>             Instructions;                                      // 0x0(0x10)(None)
};
...
{
public:
	uint8                                        Pad_140D[0x28];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_140E[0xF8];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_140F[0xC];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_1410[0x108];                                   // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	enum class ERigVMRegisterType                Type;                                              // 0x0(0x1)(None)
	uint8                                        Pad_1411[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	uint32                                       ByteIndex;                                         // 0x4(0x4)(None)
	uint16                                       ElementSize;                                       // 0x8(0x2)(None)
	uint16                                       ElementCount;                                      // 0xA(0x2)(None)
	uint16                                       SliceCount;                                        // 0xC(0x2)(None)
	uint8                                        AlignmentBytes;                                    // 0xE(0x1)(None)
	uint8                                        Pad_1412[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	uint16                                       TrailingBytes;                                     // 0x10(0x2)(None)
	uint8                                        Pad_1413[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class FName                                  Name;                                              // 0x14(0x8)(None)
	int32                                        ScriptStructIndex;                                 // 0x1C(0x4)(None)
	bool                                         bIsArray;                                          // 0x20(0x1)(None)
	bool                                         bIsDynamic;                                        // 0x21(0x1)(None)
	uint8                                        Pad_1415[0x2];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	TArray<int32>                                Segments;                                          // 0x0(0x10)(ContainsInstancedReference, AssetRegistrySearchable, SimpleDisplay, Protected, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	enum class ERigVMRegisterType                Type;                                              // 0x10(0x1)(None)
	uint8                                        Pad_1416[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class FName                                  CPPType;                                           // 0x14(0x8)(None)
	uint8                                        Pad_1417[0x4];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class UScriptStruct*                         ScriptStruct;                                      // 0x20(0x8)(ZeroConstructor)
	class UScriptStruct*                         ParentScriptStruct;                                // 0x28(0x8)(None)
	int32                                        ArrayIndex;                                        // 0x30(0x4)(None)
	uint16                                       ElementSize;                                       // 0x34(0x2)(None)
	uint8                                        Pad_1418[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class FString                                CachedSegmentPath;                                 // 0x38(0x10)(None)
};
...
{
public:
	bool                                         bUseNameMap;                                       // 0x0(0x1)(None)
	enum class ERigVMMemoryType                  MemoryType;                                        // 0x1(0x1)(None)
	uint8                                        Pad_141A[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	TArray<struct FRigVMRegister>                Registers;                                         // 0x8(0x10)(SimpleDisplay, BlueprintAuthorityOnly, TextExportTransient, NonPIEDuplicateTransient, PersistentInstance, UObjectWrapper, NativeAccessSpecifierPublic)
	TArray<struct FRigVMRegisterOffset>          RegisterOffsets;                                   // 0x18(0x10)(ZeroConstructor, ContainsInstancedReference, SimpleDisplay, BlueprintAuthorityOnly, TextExportTransient, NonPIEDuplicateTransient, PersistentInstance, UObjectWrapper, NativeAccessSpecifierPublic)
	TArray<uint8>                                Data;                                              // 0x28(0x10)(SimpleDisplay, Protected, BlueprintCallable, BlueprintAuthorityOnly, NonPIEDuplicateTransient, PersistentInstance, UObjectWrapper, NativeAccessSpecifierPublic)
	TArray<class UScriptStruct*>                 ScriptStructs;                                     // 0x38(0x10)(AssetRegistrySearchable, SimpleDisplay, AdvancedDisplay, Protected, TextExportTransient, ExposeOnSpawn, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TMap<class FName, int32>                     NameMap;                                           // 0x48(0x50)(None)
	bool                                         bEncounteredErrorDuringLoad;                       // 0x98(0x1)(None)
...
{
public:
	class FName                                  CPPType;                                           // 0x0(0x8)(None)
	class UObject*                               CPPTypeObject;                                     // 0x8(0x8)(None)
};
...
public:
	...
	class FString                                Title;                                             // 0x8(0x10)(AssetRegistrySearchable, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                Tooltip;                                           // 0x18(0x10)(None)
	enum class ERigVMUserWorkflowType            Type;                                              // 0x28(0x1)(None)
	uint8                                        Pad_1420[0x17];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	FDelegateProperty_                           PerformDynamicDelegate;                            // 0x40(0x10)(ZeroConstructor)
	class UClass*                                OptionsClass;                                      // 0x50(0x8)(None)
};
...
{
public:
	enum class ERigVMAnimEasingType              Type;                                              // 0x8(0x1)(None)
...
public:
	...
	enum class ERigVMAnimEasingType              Type;                                              // 0xC(0x1)(None)
	uint8                                        Pad_1425[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	float                                        SourceMinimum;                                     // 0x10(0x4)(None)
	float                                        SourceMaximum;                                     // 0x14(0x4)(None)
	float                                        TargetMinimum;                                     // 0x18(0x4)(None)
	float                                        TargetMaximum;                                     // 0x1C(0x4)(None)
	float                                        Result;                                            // 0x20(0x4)(None)
...
public:
	...
	struct FRuntimeFloatCurve                    Curve;                                             // 0x10(0x88)(None)
	float                                        SourceMinimum;                                     // 0x98(0x4)(None)
	float                                        SourceMaximum;                                     // 0x9C(0x4)(None)
	float                                        TargetMinimum;                                     // 0xA0(0x4)(None)
	float                                        TargetMaximum;                                     // 0xA4(0x4)(None)
	float                                        Result;                                            // 0xA8(0x4)(None)
...
{
public:
	float                                        Year;                                              // 0x8(0x4)(None)
	float                                        Month;                                             // 0xC(0x4)(None)
	float                                        Day;                                               // 0x10(0x4)(None)
	float                                        WeekDay;                                           // 0x14(0x4)(None)
	float                                        Hours;                                             // 0x18(0x4)(None)
	float                                        Minutes;                                           // 0x1C(0x4)(None)
	float                                        Seconds;                                           // 0x20(0x4)(None)
	float                                        OverallSeconds;                                    // 0x24(0x4)(None)
};
...
{
public:
	float                                        Seconds;                                           // 0x8(0x4)(None)
	float                                        Frames;                                            // 0xC(0x4)(None)
};
...
{
public:
	struct FVector                               A;                                                 // 0x100(0x18)(None)
	struct FVector                               B;                                                 // 0x118(0x18)(None)
	struct FLinearColor                          Color;                                             // 0x130(0x10)(None)
	float                                        Thickness;                                         // 0x140(0x4)(None)
	class FName                                  Space;                                             // 0x144(0x8)(None)
...
public:
	...
	struct FTransform                            WorldOffset;                                       // 0x150(0x60)(None)
	bool                                         bEnabled;                                          // 0x1B0(0x1)(None)
	uint8                                        Pad_1438[0xF];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	TArray<struct FVector>                       Points;                                            // 0x100(0x10)(ContainsInstancedReference, SimpleDisplay, BlueprintAuthorityOnly, UObjectWrapper, NativeAccessSpecifierProtected, NativeAccessSpecifierPrivate)
	struct FLinearColor                          Color;                                             // 0x110(0x10)(None)
	float                                        Thickness;                                         // 0x120(0x4)(None)
	class FName                                  Space;                                             // 0x124(0x8)(None)
	uint8                                        Pad_1439[0x4];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FTransform                            WorldOffset;                                       // 0x130(0x60)(None)
	bool                                         bEnabled;                                          // 0x190(0x1)(None)
...
public:
	...
	enum class ERigUnitDebugPointMode            Mode;                                              // 0x20(0x1)(None)
	uint8                                        Pad_1441[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FLinearColor                          Color;                                             // 0x24(0x10)(None)
	float                                        Scale;                                             // 0x34(0x4)(None)
	float                                        Thickness;                                         // 0x38(0x4)(None)
	class FName                                  Space;                                             // 0x3C(0x8)(None)
	uint8                                        Pad_1443[0xC];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FTransform                            WorldOffset;                                       // 0x50(0x60)(None)
	bool                                         bEnabled;                                          // 0xB0(0x1)(None)
...
{
public:
	struct FVector                               Vector;                                            // 0x100(0x18)(None)
	enum class ERigUnitDebugPointMode            Mode;                                              // 0x118(0x1)(None)
	uint8                                        Pad_144B[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FLinearColor                          Color;                                             // 0x11C(0x10)(None)
	float                                        Scale;                                             // 0x12C(0x4)(None)
	float                                        Thickness;                                         // 0x130(0x4)(None)
	class FName                                  Space;                                             // 0x134(0x8)(None)
	uint8                                        Pad_144E[0x4];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FTransform                            WorldOffset;                                       // 0x140(0x60)(None)
	bool                                         bEnabled;                                          // 0x1A0(0x1)(None)
	uint8                                        Pad_1450[0xF];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	struct FTransform                            Transform;                                         // 0x100(0x60)(None)
	struct FLinearColor                          Color;                                             // 0x160(0x10)(None)
	float                                        Scale;                                             // 0x170(0x4)(None)
	float                                        Thickness;                                         // 0x174(0x4)(None)
	class FName                                  Space;                                             // 0x178(0x8)(None)
	struct FTransform                            WorldOffset;                                       // 0x180(0x60)(None)
	bool                                         bEnabled;                                          // 0x1E0(0x1)(None)
...
public:
	...
	struct FTransform                            WorldOffset;                                       // 0x180(0x60)(None)
	bool                                         bEnabled;                                          // 0x1E0(0x1)(None)
	uint8                                        Pad_1454[0xF];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	struct FTransform                            Transform;                                         // 0x100(0x60)(None)
	struct FLinearColor                          Color;                                             // 0x160(0x10)(None)
	float                                        Radius;                                            // 0x170(0x4)(None)
	float                                        MinimumDegrees;                                    // 0x174(0x4)(None)
	float                                        MaximumDegrees;                                    // 0x178(0x4)(None)
	float                                        Thickness;                                         // 0x17C(0x4)(None)
	int32                                        Detail;                                            // 0x180(0x4)(None)
	class FName                                  Space;                                             // 0x184(0x8)(None)
...
public:
	...
	float                                        Thickness;                                         // 0x17C(0x4)(None)
	int32                                        Detail;                                            // 0x180(0x4)(None)
	uint8                                        Pad_145A[0xC];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FTransform                            WorldOffset;                                       // 0x190(0x60)(None)
	bool                                         bEnabled;                                          // 0x1F0(0x1)(None)
	uint8                                        Pad_145B[0xF];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	enum class ERigUnitDebugTransformMode        Mode;                                              // 0x70(0x1)(None)
	uint8                                        Pad_145E[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FLinearColor                          Color;                                             // 0x74(0x10)(None)
	float                                        Thickness;                                         // 0x84(0x4)(None)
	float                                        Scale;                                             // 0x88(0x4)(None)
	class FName                                  Space;                                             // 0x8C(0x8)(None)
	uint8                                        Pad_145F[0xC];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FTransform                            WorldOffset;                                       // 0xA0(0x60)(None)
	bool                                         bEnabled;                                          // 0x100(0x1)(None)
...
public:
	struct FTransform                            Transform;                                         // 0x100(0x60)(None)
	enum class ERigUnitDebugTransformMode        Mode;                                              // 0x160(0x1)(None)
	uint8                                        Pad_1461[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FLinearColor                          Color;                                             // 0x164(0x10)(None)
	float                                        Thickness;                                         // 0x174(0x4)(None)
	float                                        Scale;                                             // 0x178(0x4)(None)
	class FName                                  Space;                                             // 0x17C(0x8)(None)
	uint8                                        Pad_1463[0xC];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FTransform                            WorldOffset;                                       // 0x190(0x60)(None)
	bool                                         bEnabled;                                          // 0x1F0(0x1)(None)
	uint8                                        Pad_1464[0xF];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	struct FTransform                            WorldOffset;                                       // 0x180(0x60)(None)
	bool                                         bEnabled;                                          // 0x1E0(0x1)(None)
	uint8                                        Pad_1467[0xF];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	TArray<struct FTransform>                    DrawTransforms;                                    // 0x0(0x10)(None)
};
...
{
public:
	TArray<struct FTransform>                    Transforms;                                        // 0x100(0x10)(AssetRegistrySearchable, AdvancedDisplay, TextExportTransient, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	enum class ERigUnitDebugTransformMode        Mode;                                              // 0x110(0x1)(None)
	uint8                                        Pad_1469[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FLinearColor                          Color;                                             // 0x114(0x10)(None)
	float                                        Thickness;                                         // 0x124(0x4)(None)
	float                                        Scale;                                             // 0x128(0x4)(None)
	class FName                                  Space;                                             // 0x12C(0x8)(None)
	uint8                                        Pad_146A[0xC];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FTransform                            WorldOffset;                                       // 0x140(0x60)(None)
	bool                                         bEnabled;                                          // 0x1A0(0x1)(None)
	uint8                                        Pad_146B[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FRigVMFunction_DebugTransformArrayMutable_WorkData WorkData;                                          // 0x1A8(0x10)(ContainsInstancedReference, SimpleDisplay, BlueprintAuthorityOnly, UObjectWrapper, NativeAccessSpecifierProtected, NativeAccessSpecifierPrivate)
...
{
public:
	TArray<struct FTransform>                    Transforms;                                        // 0x100(0x10)(AutoWeak, ContainsInstancedReference, SimpleDisplay, AdvancedDisplay, BlueprintCallable, TextExportTransient, NonPIEDuplicateTransient, PersistentInstance, UObjectWrapper, NativeAccessSpecifierPublic)
	TArray<int32>                                ParentIndices;                                     // 0x110(0x10)(ContainsInstancedReference, SimpleDisplay, BlueprintAuthorityOnly, UObjectWrapper, NativeAccessSpecifierProtected, NativeAccessSpecifierPrivate)
	enum class ERigUnitDebugTransformMode        Mode;                                              // 0x120(0x1)(None)
	uint8                                        Pad_146D[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FLinearColor                          Color;                                             // 0x124(0x10)(None)
	float                                        Thickness;                                         // 0x134(0x4)(None)
	float                                        Scale;                                             // 0x138(0x4)(None)
...
public:
	...
	bool                                         bEnabled;                                          // 0x20(0x1)(None)
	enum class ERigUnitVisualDebugPointMode      Mode;                                              // 0x21(0x1)(None)
	uint8                                        Pad_1471[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FLinearColor                          Color;                                             // 0x24(0x10)(None)
	float                                        Thickness;                                         // 0x34(0x4)(None)
	float                                        Scale;                                             // 0x38(0x4)(None)
	class FName                                  BoneSpace;                                         // 0x3C(0x8)(None)
...
public:
	...
	float                                        Scale;                                             // 0x38(0x4)(None)
	class FName                                  BoneSpace;                                         // 0x3C(0x8)(None)
	uint8                                        Pad_1477[0xC];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	bool                                         bEnabled;                                          // 0x70(0x1)(None)
	uint8                                        Pad_147C[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	float                                        Thickness;                                         // 0x74(0x4)(None)
	float                                        Scale;                                             // 0x78(0x4)(None)
	class FName                                  BoneSpace;                                         // 0x7C(0x8)(None)
	uint8                                        Pad_147D[0xC];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	class FName                                  BlockToRun;                                        // 0x100(0x8)(None)
	int32                                        Count;                                             // 0x108(0x4)(None)
	int32                                        Index;                                             // 0x10C(0x4)(None)
	float                                        Ratio;                                             // 0x110(0x4)(None)
	uint8                                        Pad_1482[0xC];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FRigVMExecuteContext                  Completed;                                         // 0x120(0xF0)(ContainsInstancedReference, SimpleDisplay, BlueprintAuthorityOnly, UObjectWrapper, NativeAccessSpecifierProtected, NativeAccessSpecifierPrivate)
};
...
public:
	...
	struct FRigVMExecuteContext                  ExecuteContext;                                    // 0x10(0xF0)(None)
	class FName                                  EventName;                                         // 0x100(0x8)(None)
...
public:
	bool                                         Value;                                             // 0x8(0x1)(None)
	bool                                         Result;                                            // 0x9(0x1)(None)
	uint8                                        Pad_1486[0x6];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	bool                                         A;                                                 // 0x8(0x1)(None)
	bool                                         B;                                                 // 0x9(0x1)(None)
	bool                                         Result;                                            // 0xA(0x1)(None)
	uint8                                        Pad_1488[0x5];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	bool                                         B;                                                 // 0x9(0x1)(None)
	bool                                         Result;                                            // 0xA(0x1)(None)
	uint8                                        Pad_148A[0x5];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	bool                                         B;                                                 // 0x9(0x1)(None)
	bool                                         Result;                                            // 0xA(0x1)(None)
	uint8                                        Pad_148F[0x5];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	bool                                         Value;                                             // 0x8(0x1)(None)
	bool                                         Toggled;                                           // 0x9(0x1)(None)
	bool                                         Initialized;                                       // 0xA(0x1)(None)
	bool                                         LastValue;                                         // 0xB(0x1)(None)
...
public:
	...
	bool                                         Result;                                            // 0xC(0x1)(None)
	bool                                         LastValue;                                         // 0xD(0x1)(None)
	uint8                                        Pad_1495[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	float                                        TimeLeft;                                          // 0x10(0x4)(None)
...
{
public:
	struct FLinearColor                          A;                                                 // 0x8(0x10)(None)
	struct FLinearColor                          B;                                                 // 0x18(0x10)(None)
	struct FLinearColor                          Result;                                            // 0x28(0x10)(None)
};
...
{
public:
	float                                        R;                                                 // 0x8(0x4)(None)
	float                                        G;                                                 // 0xC(0x4)(None)
	float                                        B;                                                 // 0x10(0x4)(None)
	float                                        A;                                                 // 0x14(0x4)(None)
	struct FLinearColor                          Result;                                            // 0x18(0x10)(None)
};
...
public:
	float                                        Value;                                             // 0x8(0x4)(None)
	struct FLinearColor                          Result;                                            // 0xC(0x10)(None)
...
{
public:
	double                                       Value;                                             // 0x8(0x8)(None)
	struct FLinearColor                          Result;                                            // 0x10(0x10)(None)
};
...
public:
	struct FLinearColor                          A;                                                 // 0x8(0x10)(None)
	struct FLinearColor                          B;                                                 // 0x18(0x10)(None)
	float                                        T;                                                 // 0x28(0x4)(None)
	struct FLinearColor                          Result;                                            // 0x2C(0x10)(None)
...
{
public:
	double                                       A;                                                 // 0x8(0x8)(None)
	double                                       B;                                                 // 0x10(0x8)(None)
	double                                       Result;                                            // 0x18(0x8)(None)
};
...
public:
	double                                       Value;                                             // 0x8(0x8)(None)
	double                                       Minimum;                                           // 0x10(0x8)(None)
	double                                       Maximum;                                           // 0x18(0x8)(None)
	double                                       Result;                                            // 0x20(0x8)(None)
};
...
public:
	double                                       Value;                                             // 0x8(0x8)(None)
	double                                       SourceMinimum;                                     // 0x10(0x8)(None)
	double                                       SourceMaximum;                                     // 0x18(0x8)(None)
	double                                       TargetMinimum;                                     // 0x20(0x8)(None)
	double                                       TargetMaximum;                                     // 0x28(0x8)(None)
	bool                                         bClamp;                                            // 0x30(0x1)(None)
	uint8                                        Pad_14C0[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	double                                       Result;                                            // 0x38(0x8)(None)
};
...
public:
	double                                       Value;                                             // 0x8(0x8)(None)
	double                                       Tolerance;                                         // 0x10(0x8)(None)
	bool                                         Result;                                            // 0x18(0x1)(None)
...
public:
	double                                       A;                                                 // 0x8(0x8)(None)
	double                                       B;                                                 // 0x10(0x8)(None)
	double                                       Tolerance;                                         // 0x18(0x8)(None)
	bool                                         Result;                                            // 0x20(0x1)(None)
	uint8                                        Pad_14CC[0x7];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	double                                       A;                                                 // 0x8(0x8)(None)
	double                                       B;                                                 // 0x10(0x8)(None)
	double                                       C;                                                 // 0x18(0x8)(None)
	double                                       AlphaAngle;                                        // 0x20(0x8)(None)
	double                                       BetaAngle;                                         // 0x28(0x8)(None)
	double                                       GammaAngle;                                        // 0x30(0x8)(None)
	bool                                         bValid;                                            // 0x38(0x1)(None)
...
{
public:
	TArray<double>                               Array;                                             // 0x8(0x10)(None)
	double                                       Sum;                                               // 0x18(0x8)(None)
};
...
{
public:
	float                                        A;                                                 // 0x8(0x4)(None)
	float                                        B;                                                 // 0xC(0x4)(None)
...
public:
	float                                        Value;                                             // 0x8(0x4)(None)
	float                                        Minimum;                                           // 0xC(0x4)(None)
	float                                        Maximum;                                           // 0x10(0x4)(None)
...
public:
	float                                        Value;                                             // 0x8(0x4)(None)
	float                                        SourceMinimum;                                     // 0xC(0x4)(None)
	float                                        SourceMaximum;                                     // 0x10(0x4)(None)
	float                                        TargetMinimum;                                     // 0x14(0x4)(None)
	float                                        TargetMaximum;                                     // 0x18(0x4)(None)
	bool                                         bClamp;                                            // 0x1C(0x1)(None)
...
public:
	float                                        A;                                                 // 0x8(0x4)(None)
	float                                        B;                                                 // 0xC(0x4)(None)
	float                                        Tolerance;                                         // 0x10(0x4)(None)
	bool                                         Result;                                            // 0x14(0x1)(None)
...
{
public:
	bool                                         Condition;                                         // 0x8(0x1)(None)
	uint8                                        Pad_153B[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	float                                        IfTrue;                                            // 0xC(0x4)(None)
	float                                        IfFalse;                                           // 0x10(0x4)(None)
	float                                        Result;                                            // 0x14(0x4)(None)
};
...
public:
	float                                        A;                                                 // 0x8(0x4)(None)
	float                                        B;                                                 // 0xC(0x4)(None)
	float                                        C;                                                 // 0x10(0x4)(None)
	float                                        AlphaAngle;                                        // 0x14(0x4)(None)
	float                                        BetaAngle;                                         // 0x18(0x4)(None)
	float                                        GammaAngle;                                        // 0x1C(0x4)(None)
	bool                                         bValid;                                            // 0x20(0x1)(None)
...
{
public:
	TArray<float>                                Array;                                             // 0x8(0x10)(None)
	float                                        Sum;                                               // 0x18(0x4)(None)
...
{
public:
	int32                                        A;                                                 // 0x8(0x4)(None)
	int32                                        B;                                                 // 0xC(0x4)(None)
	int32                                        Result;                                            // 0x10(0x4)(None)
...
public:
	int32                                        Value;                                             // 0x8(0x4)(None)
	int32                                        Minimum;                                           // 0xC(0x4)(None)
	int32                                        Maximum;                                           // 0x10(0x4)(None)
	int32                                        Result;                                            // 0x14(0x4)(None)
};
...
{
public:
	TArray<int32>                                Array;                                             // 0x8(0x10)(None)
	int32                                        Sum;                                               // 0x18(0x4)(None)
...
public:
	...
	struct FMatrix                               Value;                                             // 0x10(0x80)(None)
	struct FMatrix                               Result;                                            // 0x90(0x80)(None)
};
...
public:
	...
	struct FMatrix                               A;                                                 // 0x10(0x80)(None)
	struct FMatrix                               B;                                                 // 0x90(0x80)(None)
	struct FMatrix                               Result;                                            // 0x110(0x80)(None)
};
...
public:
	...
	struct FMatrix                               Value;                                             // 0x10(0x80)(None)
	struct FTransform                            Result;                                            // 0x90(0x60)(None)
};
...
public:
	...
	struct FTransform                            Transform;                                         // 0x10(0x60)(None)
	struct FMatrix                               Result;                                            // 0x70(0x80)(None)
};
...
public:
	...
	struct FMatrix                               Value;                                             // 0x10(0x80)(None)
	struct FVector                               Origin;                                            // 0x90(0x18)(None)
	struct FVector                               X;                                                 // 0xA8(0x18)(None)
	struct FVector                               Y;                                                 // 0xC0(0x18)(None)
	struct FVector                               Z;                                                 // 0xD8(0x18)(None)
};
...
public:
	...
	struct FVector                               X;                                                 // 0x20(0x18)(None)
	struct FVector                               Y;                                                 // 0x38(0x18)(None)
	struct FVector                               Z;                                                 // 0x50(0x18)(None)
...
public:
	...
	struct FQuat                                 A;                                                 // 0x10(0x20)(None)
	struct FQuat                                 B;                                                 // 0x30(0x20)(None)
...
{
public:
	float                                        X;                                                 // 0x8(0x4)(None)
	float                                        Y;                                                 // 0xC(0x4)(None)
	float                                        Z;                                                 // 0x10(0x4)(None)
	float                                        W;                                                 // 0x14(0x4)(None)
...
{
public:
	struct FVector                               Euler;                                             // 0x8(0x18)(None)
	enum class EEulerRotationOrder               RotationOrder;                                     // 0x20(0x1)(None)
	uint8                                        Pad_1582[0xF];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FQuat                                 Result;                                            // 0x30(0x20)(None)
};
...
{
public:
	struct FVector                               A;                                                 // 0x8(0x18)(None)
	struct FVector                               B;                                                 // 0x20(0x18)(None)
	uint8                                        Pad_1584[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FQuat                                 Result;                                            // 0x40(0x20)(None)
};
...
public:
	...
	struct FQuat                                 Value;                                             // 0x10(0x20)(None)
	float                                        Scale;                                             // 0x30(0x4)(None)
	uint8                                        Pad_158B[0xC];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	struct FQuat                                 Value;                                             // 0x10(0x20)(None)
	float                                        Factor;                                            // 0x30(0x4)(None)
	uint8                                        Pad_158D[0xC];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FQuat                                 Result;                                            // 0x40(0x20)(None)
};
...
public:
	...
	struct FQuat                                 Value;                                             // 0x10(0x20)(None)
	enum class EEulerRotationOrder               RotationOrder;                                     // 0x30(0x1)(None)
...
public:
	...
	struct FQuat                                 A;                                                 // 0x10(0x20)(None)
	struct FQuat                                 B;                                                 // 0x30(0x20)(None)
	float                                        T;                                                 // 0x50(0x4)(None)
	uint8                                        Pad_1596[0xC];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FQuat                                 Result;                                            // 0x60(0x20)(None)
};
...
public:
	...
	struct FQuat                                 A;                                                 // 0x10(0x20)(None)
	struct FQuat                                 B;                                                 // 0x30(0x20)(None)
	bool                                         Result;                                            // 0x50(0x1)(None)
	uint8                                        Pad_1599[0xF];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	struct FQuat                                 B;                                                 // 0x30(0x20)(None)
	bool                                         Result;                                            // 0x50(0x1)(None)
	uint8                                        Pad_159B[0xF];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	struct FQuat                                 IfTrue;                                            // 0x10(0x20)(None)
	struct FQuat                                 IfFalse;                                           // 0x30(0x20)(None)
	struct FQuat                                 Result;                                            // 0x50(0x20)(None)
};
...
public:
	...
	struct FQuat                                 Transform;                                         // 0x10(0x20)(None)
	struct FVector                               Vector;                                            // 0x30(0x18)(None)
...
public:
	...
	struct FQuat                                 Quaternion;                                        // 0x10(0x20)(None)
	enum class EAxis                             Axis;                                              // 0x30(0x1)(None)
...
{
public:
	enum class EEulerRotationOrder               RotationOrder;                                     // 0x8(0x1)(None)
...
public:
	...
	struct FQuat                                 Global;                                            // 0x10(0x20)(None)
	struct FQuat                                 Parent;                                            // 0x30(0x20)(None)
	struct FQuat                                 Local;                                             // 0x50(0x20)(None)
};
...
public:
	...
	struct FQuat                                 Local;                                             // 0x10(0x20)(None)
	struct FQuat                                 Parent;                                            // 0x30(0x20)(None)
	struct FQuat                                 Global;                                            // 0x50(0x20)(None)
};
...
public:
	...
	struct FQuat                                 Value;                                             // 0x10(0x20)(None)
	enum class EAxis                             MirrorAxis;                                        // 0x30(0x1)(None)
	enum class EAxis                             AxisToFlip;                                        // 0x31(0x1)(None)
	uint8                                        Pad_15B1[0xE];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FTransform                            CentralTransform;                                  // 0x40(0x60)(None)
	struct FQuat                                 Result;                                            // 0xA0(0x20)(None)
};
...
{
public:
	uint8                                        Pad_15B2[0x90];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_15B3[0x90];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	struct FQuat                                 Input;                                             // 0x10(0x20)(None)
	enum class ERBFQuatDistanceType              DistanceFunction;                                  // 0x30(0x1)(None)
	enum class ERBFKernelType                    SmoothingFunction;                                 // 0x31(0x1)(None)
	uint8                                        Pad_15B5[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	float                                        SmoothingAngle;                                    // 0x34(0x4)(None)
	bool                                         bNormalizeOutput;                                  // 0x38(0x1)(None)
	uint8                                        Pad_15B6[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FVector                               TwistAxis;                                         // 0x40(0x18)(None)
	uint8                                        Pad_15B7[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FRigVMFunction_MathRBFInterpolateQuatWorkData WorkData;                                          // 0x60(0x90)(None)
};
...
public:
	...
	enum class ERBFVectorDistanceType            DistanceFunction;                                  // 0x20(0x1)(None)
	enum class ERBFKernelType                    SmoothingFunction;                                 // 0x21(0x1)(None)
	uint8                                        Pad_15B9[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	float                                        SmoothingRadius;                                   // 0x24(0x4)(None)
	bool                                         bNormalizeOutput;                                  // 0x28(0x1)(None)
	uint8                                        Pad_15BA[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FRigVMFunction_MathRBFInterpolateVectorWorkData WorkData;                                          // 0x30(0x90)(None)
};
...
{
public:
	struct FQuat                                 Target;                                            // 0x0(0x20)(None)
	float                                        Value;                                             // 0x20(0x4)(None)
	uint8                                        Pad_15BB[0xC];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	TArray<struct FMathRBFInterpolateQuatFloat_Target> Targets;                                           // 0xF0(0x10)(AssetRegistrySearchable, SimpleDisplay, BlueprintCallable, PersistentInstance, UObjectWrapper, NativeAccessSpecifierProtected)
	float                                        Output;                                            // 0x100(0x4)(None)
...
public:
	struct FQuat                                 Target;                                            // 0x0(0x20)(None)
	struct FVector                               Value;                                             // 0x20(0x18)(None)
...
{
public:
	TArray<struct FMathRBFInterpolateQuatVector_Target> Targets;                                           // 0xF0(0x10)(AssetRegistrySearchable, SimpleDisplay, BlueprintCallable, PersistentInstance, UObjectWrapper, NativeAccessSpecifierProtected)
	struct FVector                               Output;                                            // 0x100(0x18)(None)
	uint8                                        Pad_15BE[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	struct FQuat                                 Target;                                            // 0x0(0x20)(None)
	struct FLinearColor                          Value;                                             // 0x20(0x10)(None)
};
...
{
public:
	TArray<struct FMathRBFInterpolateQuatColor_Target> Targets;                                           // 0xF0(0x10)(AssetRegistrySearchable, SimpleDisplay, BlueprintCallable, PersistentInstance, UObjectWrapper, NativeAccessSpecifierProtected)
	struct FLinearColor                          Output;                                            // 0x100(0x10)(None)
};
...
{
public:
	TArray<struct FMathRBFInterpolateQuatQuat_Target> Targets;                                           // 0xF0(0x10)(AssetRegistrySearchable, SimpleDisplay, BlueprintCallable, PersistentInstance, UObjectWrapper, NativeAccessSpecifierProtected)
	struct FQuat                                 Output;                                            // 0x100(0x20)(None)
};
...
{
public:
	TArray<struct FMathRBFInterpolateQuatXform_Target> Targets;                                           // 0xF0(0x10)(AssetRegistrySearchable, SimpleDisplay, BlueprintCallable, PersistentInstance, UObjectWrapper, NativeAccessSpecifierProtected)
	struct FTransform                            Output;                                            // 0x100(0x60)(None)
};
...
{
public:
	TArray<struct FMathRBFInterpolateVectorFloat_Target> Targets;                                           // 0xC0(0x10)(BlueprintCallable, BlueprintAuthorityOnly, PersistentInstance, UObjectWrapper, NativeAccessSpecifierProtected)
	float                                        Output;                                            // 0xD0(0x4)(None)
	uint8                                        Pad_15C3[0xC];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	TArray<struct FMathRBFInterpolateVectorVector_Target> Targets;                                           // 0xC0(0x10)(BlueprintCallable, BlueprintAuthorityOnly, PersistentInstance, UObjectWrapper, NativeAccessSpecifierProtected)
	struct FVector                               Output;                                            // 0xD0(0x18)(None)
...
public:
	struct FVector                               Target;                                            // 0x0(0x18)(None)
	struct FLinearColor                          Value;                                             // 0x18(0x10)(None)
};
...
{
public:
	TArray<struct FMathRBFInterpolateVectorColor_Target> Targets;                                           // 0xC0(0x10)(BlueprintCallable, BlueprintAuthorityOnly, PersistentInstance, UObjectWrapper, NativeAccessSpecifierProtected)
	struct FLinearColor                          Output;                                            // 0xD0(0x10)(None)
};
...
{
public:
	TArray<struct FMathRBFInterpolateVectorQuat_Target> Targets;                                           // 0xC0(0x10)(BlueprintCallable, BlueprintAuthorityOnly, PersistentInstance, UObjectWrapper, NativeAccessSpecifierProtected)
	struct FQuat                                 Output;                                            // 0xD0(0x20)(None)
};
...
{
public:
	TArray<struct FMathRBFInterpolateVectorXform_Target> Targets;                                           // 0xC0(0x10)(BlueprintCallable, BlueprintAuthorityOnly, PersistentInstance, UObjectWrapper, NativeAccessSpecifierProtected)
	struct FTransform                            Output;                                            // 0xD0(0x60)(None)
};
...
public:
	...
	struct FTransform                            Value;                                             // 0x10(0x60)(None)
	struct FTransform                            Result;                                            // 0x70(0x60)(None)
};
...
public:
	...
	struct FTransform                            A;                                                 // 0x10(0x60)(None)
	struct FTransform                            B;                                                 // 0x70(0x60)(None)
...
public:
	...
	struct FTransform                            Result;                                            // 0x60(0x60)(None)
};
...
{
public:
	struct FEulerTransform                       EulerTransform;                                    // 0x8(0x48)(None)
...
{
public:
	struct FEulerTransform                       Value;                                             // 0x8(0x48)(None)
	struct FTransform                            Result;                                            // 0x50(0x60)(None)
};
...
public:
	...
	struct FTransform                            Global;                                            // 0x10(0x60)(None)
	struct FTransform                            Parent;                                            // 0x70(0x60)(None)
	struct FTransform                            Local;                                             // 0xD0(0x60)(None)
};
...
public:
	...
	struct FTransform                            Local;                                             // 0x10(0x60)(None)
	struct FTransform                            Parent;                                            // 0x70(0x60)(None)
	struct FTransform                            Global;                                            // 0xD0(0x60)(None)
};
...
{
public:
	TArray<struct FTransform>                    Transforms;                                        // 0x100(0x10)(AutoWeak, AssetRegistrySearchable, SimpleDisplay, BlueprintAuthorityOnly, PersistentInstance, NativeAccessSpecifierProtected)
	enum class ERigVMTransformSpace              TargetSpace;                                       // 0x110(0x1)(None)
	uint8                                        Pad_1684[0xF];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FTransform                            Root;                                              // 0x120(0x60)(None)
	TArray<int32>                                ParentIndices;                                     // 0x180(0x10)(ContainsInstancedReference, SimpleDisplay, BlueprintAuthorityOnly, UObjectWrapper, NativeAccessSpecifierProtected, NativeAccessSpecifierPrivate)
};
...
public:
	...
	struct FTransform                            A;                                                 // 0x10(0x60)(None)
	struct FTransform                            B;                                                 // 0x70(0x60)(None)
	float                                        T;                                                 // 0xD0(0x4)(None)
	uint8                                        Pad_1686[0xC];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FTransform                            Result;                                            // 0xE0(0x60)(None)
};
...
public:
	...
	struct FTransform                            IfTrue;                                            // 0x10(0x60)(None)
	struct FTransform                            IfFalse;                                           // 0x70(0x60)(None)
	struct FTransform                            Result;                                            // 0xD0(0x60)(None)
};
...
public:
	...
	struct FTransform                            Transform;                                         // 0x10(0x60)(None)
	struct FVector                               Vector;                                            // 0x70(0x18)(None)
	struct FVector                               Result;                                            // 0x88(0x18)(None)
};
...
{
public:
	uint8                                        Pad_168E[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FTransform                            Transform;                                         // 0x10(0x60)(None)
	struct FVector                               Location;                                          // 0x70(0x18)(None)
	struct FVector                               Result;                                            // 0x88(0x18)(None)
};
...
public:
	...
	struct FVector                               Rotation;                                          // 0x20(0x18)(None)
	enum class EEulerRotationOrder               RotationOrder;                                     // 0x38(0x1)(None)
	...
	struct FEulerTransform                       EulerTransform;                                    // 0xC0(0x48)(None)
	uint8                                        Pad_1692[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	TArray<struct FTransform>                    Transforms;                                        // 0x8(0x10)(ContainsInstancedReference, AdvancedDisplay, Protected, BlueprintCallable, PersistentInstance, NativeAccessSpecifierProtected)
	TArray<struct FVector>                       Translations;                                      // 0x18(0x10)(AssetRegistrySearchable, AdvancedDisplay, Protected, BlueprintCallable, PersistentInstance, NativeAccessSpecifierProtected)
	TArray<struct FQuat>                         Rotations;                                         // 0x28(0x10)(AutoWeak, ContainsInstancedReference, AssetRegistrySearchable, AdvancedDisplay, Protected, BlueprintCallable, PersistentInstance, NativeAccessSpecifierProtected)
	TArray<struct FVector>                       Scales;                                            // 0x38(0x10)(None)
};
...
{
public:
	uint8                                        Pad_1694[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FTransform                            Value;                                             // 0x10(0x60)(None)
	enum class EAxis                             Axis;                                              // 0x70(0x1)(None)
	enum class ERigVMClampSpatialMode            Type;                                              // 0x71(0x1)(None)
	uint8                                        Pad_1696[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	float                                        Minimum;                                           // 0x74(0x4)(None)
	float                                        Maximum;                                           // 0x78(0x4)(None)
	uint8                                        Pad_1697[0x4];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FTransform                            Space;                                             // 0x80(0x60)(None)
	bool                                         bDrawDebug;                                        // 0xE0(0x1)(None)
	uint8                                        Pad_1698[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FLinearColor                          DebugColor;                                        // 0xE4(0x10)(None)
	float                                        DebugThickness;                                    // 0xF4(0x4)(None)
	uint8                                        Pad_1699[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FTransform                            Result;                                            // 0x100(0x60)(None)
};
...
public:
	...
	struct FTransform                            Value;                                             // 0x10(0x60)(None)
	enum class EAxis                             MirrorAxis;                                        // 0x70(0x1)(None)
	enum class EAxis                             AxisToFlip;                                        // 0x71(0x1)(None)
	uint8                                        Pad_169B[0xE];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FTransform                            CentralTransform;                                  // 0x80(0x60)(None)
	struct FTransform                            Result;                                            // 0xE0(0x60)(None)
};
...
public:
	...
	struct FVector                               Result;                                            // 0x18(0x18)(None)
};
...
public:
	...
	struct FVector                               Result;                                            // 0x10(0x18)(None)
};
...
public:
	struct FVector                               Value;                                             // 0x8(0x18)(None)
	float                                        Factor;                                            // 0x20(0x4)(None)
	uint8                                        Pad_16A7[0x4];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FVector                               Result;                                            // 0x28(0x18)(None)
};
...
public:
	struct FVector                               Value;                                             // 0x8(0x18)(None)
	struct FVector                               Minimum;                                           // 0x20(0x18)(None)
	struct FVector                               Maximum;                                           // 0x38(0x18)(None)
...
public:
	struct FVector                               Value;                                             // 0x8(0x18)(None)
	struct FVector                               SourceMinimum;                                     // 0x20(0x18)(None)
	struct FVector                               SourceMaximum;                                     // 0x38(0x18)(None)
	struct FVector                               TargetMinimum;                                     // 0x50(0x18)(None)
	struct FVector                               TargetMaximum;                                     // 0x68(0x18)(None)
	bool                                         bClamp;                                            // 0x80(0x1)(None)
...
public:
	struct FVector                               Value;                                             // 0x8(0x18)(None)
	float                                        Tolerance;                                         // 0x20(0x4)(None)
	bool                                         Result;                                            // 0x24(0x1)(None)
...
public:
	struct FVector                               A;                                                 // 0x8(0x18)(None)
	struct FVector                               B;                                                 // 0x20(0x18)(None)
	float                                        Tolerance;                                         // 0x38(0x4)(None)
	bool                                         Result;                                            // 0x3C(0x1)(None)
...
public:
	...
	struct FVector                               IfTrue;                                            // 0x10(0x18)(None)
	struct FVector                               IfFalse;                                           // 0x28(0x18)(None)
	struct FVector                               Result;                                            // 0x40(0x18)(None)
};
...
public:
	struct FVector                               Value;                                             // 0x8(0x18)(None)
	float                                        MinimumLength;                                     // 0x20(0x4)(None)
	float                                        MaximumLength;                                     // 0x24(0x4)(None)
	struct FVector                               Result;                                            // 0x28(0x18)(None)
};
...
public:
	struct FVector                               Value;                                             // 0x8(0x18)(None)
	struct FVector                               Normal;                                            // 0x20(0x18)(None)
	struct FVector                               Result;                                            // 0x38(0x18)(None)
};
...
public:
	struct FVector                               Value;                                             // 0x8(0x18)(None)
	enum class EAxis                             Axis;                                              // 0x20(0x1)(None)
	enum class ERigVMClampSpatialMode            Type;                                              // 0x21(0x1)(None)
	uint8                                        Pad_16F8[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	float                                        Minimum;                                           // 0x24(0x4)(None)
	float                                        Maximum;                                           // 0x28(0x4)(None)
	uint8                                        Pad_16F9[0x4];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FTransform                            Space;                                             // 0x30(0x60)(None)
	bool                                         bDrawDebug;                                        // 0x90(0x1)(None)
	uint8                                        Pad_16FB[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FLinearColor                          DebugColor;                                        // 0x94(0x10)(None)
	float                                        DebugThickness;                                    // 0xA4(0x4)(None)
	struct FVector                               Result;                                            // 0xA8(0x18)(None)
};
...
public:
	...
	struct FVector                               PlanePoint;                                        // 0x38(0x18)(None)
	struct FVector                               PlaneNormal;                                       // 0x50(0x18)(None)
	struct FVector                               Result;                                            // 0x68(0x18)(None)
	float                                        Distance;                                          // 0x80(0x4)(None)
...
public:
	...
	struct FVector                               PlanePoint;                                        // 0x20(0x18)(None)
	struct FVector                               PlaneNormal;                                       // 0x38(0x18)(None)
	struct FVector                               ClosestPointOnPlane;                               // 0x50(0x18)(None)
	float                                        SignedDistance;                                    // 0x68(0x4)(None)
...
{
public:
	struct FVector                               Global;                                            // 0x8(0x18)(None)
	struct FVector                               Parent;                                            // 0x20(0x18)(None)
	struct FVector                               Local;                                             // 0x38(0x18)(None)
};
...
{
public:
	struct FVector                               Local;                                             // 0x8(0x18)(None)
	struct FVector                               Parent;                                            // 0x20(0x18)(None)
	struct FVector                               Global;                                            // 0x38(0x18)(None)
};
...
public:
	struct FVector                               Value;                                             // 0x8(0x18)(None)
	enum class EAxis                             MirrorAxis;                                        // 0x20(0x1)(None)
	enum class EAxis                             AxisToFlip;                                        // 0x21(0x1)(None)
	uint8                                        Pad_1704[0xE];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FTransform                            CentralTransform;                                  // 0x30(0x60)(None)
	struct FVector                               Result;                                            // 0x90(0x18)(None)
...
{
public:
	TArray<struct FVector>                       Array;                                             // 0x8(0x10)(None)
	struct FVector                               Sum;                                               // 0x18(0x18)(None)
};
...
public:
	TArray<struct FVector>                       Array;                                             // 0x8(0x10)(None)
	struct FVector                               Average;                                           // 0x18(0x18)(None)
};
...
public:
	double                                       Value;                                             // 0x8(0x8)(None)
	double                                       Speed;                                             // 0x10(0x8)(None)
	double                                       Frequency;                                         // 0x18(0x8)(None)
	double                                       Minimum;                                           // 0x20(0x8)(None)
	double                                       Maximum;                                           // 0x28(0x8)(None)
	double                                       Result;                                            // 0x30(0x8)(None)
	double                                       Time;                                              // 0x38(0x8)(None)
};
...
public:
	...
	struct FVector                               Speed;                                             // 0x20(0x18)(None)
	struct FVector                               Frequency;                                         // 0x38(0x18)(None)
	float                                        Minimum;                                           // 0x50(0x4)(None)
	float                                        Maximum;                                           // 0x54(0x4)(None)
	struct FVector                               Result;                                            // 0x58(0x18)(None)
	struct FVector                               Time;                                              // 0x70(0x18)(None)
};
...
public:
	...
	struct FVector                               Speed;                                             // 0x20(0x18)(None)
	struct FVector                               Frequency;                                         // 0x38(0x18)(None)
	double                                       Minimum;                                           // 0x50(0x8)(None)
	double                                       Maximum;                                           // 0x58(0x8)(None)
	struct FVector                               Result;                                            // 0x60(0x18)(None)
	struct FVector                               Time;                                              // 0x78(0x18)(None)
};
...
{
public:
	int32                                        Seed;                                              // 0x8(0x4)(None)
	float                                        Minimum;                                           // 0xC(0x4)(None)
	float                                        Maximum;                                           // 0x10(0x4)(None)
	float                                        Duration;                                          // 0x14(0x4)(None)
	float                                        Result;                                            // 0x18(0x4)(None)
	float                                        LastResult;                                        // 0x1C(0x4)(None)
	int32                                        LastSeed;                                          // 0x20(0x4)(None)
	int32                                        BaseSeed;                                          // 0x24(0x4)(None)
	float                                        TimeLeft;                                          // 0x28(0x4)(None)
...
public:
	...
	float                                        Duration;                                          // 0x14(0x4)(None)
	struct FVector                               Result;                                            // 0x18(0x18)(None)
	struct FVector                               LastResult;                                        // 0x30(0x18)(None)
	int32                                        LastSeed;                                          // 0x48(0x4)(None)
	int32                                        BaseSeed;                                          // 0x4C(0x4)(None)
	float                                        TimeLeft;                                          // 0x50(0x4)(None)
...
{
public:
	enum class EAxis                             MirrorAxis;                                        // 0x0(0x1)(None)
	enum class EAxis                             AxisToFlip;                                        // 0x1(0x1)(None)
	uint8                                        Pad_1712[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class FString                                SearchString;                                      // 0x8(0x10)(AssetRegistrySearchable, TextExportTransient, NonPIEDuplicateTransient, PersistentInstance, UObjectWrapper, NativeAccessSpecifierProtected)
	class FString                                ReplaceString;                                     // 0x18(0x10)(None)
};
...
public:
	...
	struct FRigVMExecuteContext                  ExecuteContext;                                    // 0x10(0xF0)(ContainsInstancedReference, AssetRegistrySearchable, AdvancedDisplay, Protected, BlueprintCallable, BlueprintAuthorityOnly, NonPIEDuplicateTransient, PersistentInstance, UObjectWrapper, NativeAccessSpecifierProtected)
	bool                                         Condition;                                         // 0x100(0x1)(None)
	uint8                                        Pad_172E[0xF];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FRigVMExecuteContext                  TURR;                                              // 0x110(0xF0)(SimpleDisplay, AdvancedDisplay, Protected, BlueprintCallable, BlueprintAuthorityOnly, NonPIEDuplicateTransient, PersistentInstance, UObjectWrapper, NativeAccessSpecifierProtected)
	struct FRigVMExecuteContext                  FLASE;                                             // 0x200(0xF0)(ContainsInstancedReference, SimpleDisplay, AdvancedDisplay, Protected, BlueprintCallable, BlueprintAuthorityOnly, NonPIEDuplicateTransient, PersistentInstance, UObjectWrapper, NativeAccessSpecifierProtected)
	struct FRigVMExecuteContext                  Completed;                                         // 0x2F0(0xF0)(None)
	class FName                                  BlockToRun;                                        // 0x3E0(0x8)(None)
...
{
public:
	class FName                                  A;                                                 // 0x8(0x8)(None)
	class FName                                  B;                                                 // 0x10(0x8)(None)
	class FName                                  Result;                                            // 0x18(0x8)(None)
};
...
public:
	...
	int32                                        Count;                                             // 0x10(0x4)(None)
	bool                                         FromEnd;                                           // 0x14(0x1)(None)
	uint8                                        Pad_1734[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class FName                                  Remainder;                                         // 0x18(0x8)(None)
	class FName                                  Chopped;                                           // 0x20(0x8)(None)
};
...
public:
	class FName                                  Name;                                              // 0x8(0x8)(None)
	class FName                                  Old;                                               // 0x10(0x8)(None)
	class FName                                  New;                                               // 0x18(0x8)(None)
	class FName                                  Result;                                            // 0x20(0x8)(None)
};
...
public:
	class FName                                  Name;                                              // 0x8(0x8)(None)
	class FName                                  Ending;                                            // 0x10(0x8)(None)
	bool                                         Result;                                            // 0x18(0x1)(None)
...
public:
	class FName                                  Name;                                              // 0x8(0x8)(None)
	class FName                                  Start;                                             // 0x10(0x8)(None)
	bool                                         Result;                                            // 0x18(0x1)(None)
...
public:
	class FName                                  Name;                                              // 0x8(0x8)(None)
	class FName                                  Search;                                            // 0x10(0x8)(None)
	bool                                         Result;                                            // 0x18(0x1)(None)
	uint8                                        Pad_1738[0x7];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	class FString                                A;                                                 // 0x8(0x10)(SimpleDisplay, BlueprintCallable, TextExportTransient, NonPIEDuplicateTransient, PersistentInstance, UObjectWrapper, NativeAccessSpecifierProtected)
	class FString                                B;                                                 // 0x18(0x10)(ContainsInstancedReference, SimpleDisplay, BlueprintCallable, TextExportTransient, NonPIEDuplicateTransient, PersistentInstance, UObjectWrapper, NativeAccessSpecifierProtected)
	class FString                                Result;                                            // 0x28(0x10)(None)
};
...
{
public:
	class FString                                Name;                                              // 0x8(0x10)(ContainsInstancedReference, BlueprintCallable, TextExportTransient, NonPIEDuplicateTransient, PersistentInstance, UObjectWrapper, NativeAccessSpecifierProtected)
	int32                                        Count;                                             // 0x18(0x4)(None)
	bool                                         FromEnd;                                           // 0x1C(0x1)(None)
	uint8                                        Pad_173C[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class FString                                Remainder;                                         // 0x20(0x10)(AssetRegistrySearchable, BlueprintCallable, TextExportTransient, NonPIEDuplicateTransient, PersistentInstance, UObjectWrapper, NativeAccessSpecifierProtected)
	class FString                                Chopped;                                           // 0x30(0x10)(None)
};
...
{
public:
	class FString                                Name;                                              // 0x8(0x10)(ContainsInstancedReference, AssetRegistrySearchable, AdvancedDisplay, Protected, TextExportTransient, NonPIEDuplicateTransient, PersistentInstance, UObjectWrapper, NativeAccessSpecifierProtected)
	class FString                                Old;                                               // 0x18(0x10)(SimpleDisplay, AdvancedDisplay, Protected, TextExportTransient, NonPIEDuplicateTransient, PersistentInstance, UObjectWrapper, NativeAccessSpecifierProtected)
	class FString                                New;                                               // 0x28(0x10)(ContainsInstancedReference, SimpleDisplay, AdvancedDisplay, Protected, TextExportTransient, NonPIEDuplicateTransient, PersistentInstance, UObjectWrapper, NativeAccessSpecifierProtected)
	class FString                                Result;                                            // 0x38(0x10)(None)
};
...
{
public:
	class FString                                Name;                                              // 0x8(0x10)(AdvancedDisplay, Protected, TextExportTransient, NonPIEDuplicateTransient, PersistentInstance, UObjectWrapper, NativeAccessSpecifierProtected)
	class FString                                Ending;                                            // 0x18(0x10)(None)
	bool                                         Result;                                            // 0x28(0x1)(None)
...
{
public:
	class FString                                Name;                                              // 0x8(0x10)(ContainsInstancedReference, SimpleDisplay, Protected, TextExportTransient, NonPIEDuplicateTransient, PersistentInstance, UObjectWrapper, NativeAccessSpecifierProtected)
	class FString                                Start;                                             // 0x18(0x10)(None)
	bool                                         Result;                                            // 0x28(0x1)(None)
...
{
public:
	class FString                                Name;                                              // 0x8(0x10)(AssetRegistrySearchable, Protected, TextExportTransient, NonPIEDuplicateTransient, PersistentInstance, UObjectWrapper, NativeAccessSpecifierProtected)
	class FString                                Search;                                            // 0x18(0x10)(None)
	bool                                         Result;                                            // 0x28(0x1)(None)
...
{
public:
	class FString                                Value;                                             // 0x8(0x10)(AssetRegistrySearchable, SimpleDisplay, AdvancedDisplay, TextExportTransient, NonPIEDuplicateTransient, PersistentInstance, UObjectWrapper, NativeAccessSpecifierProtected)
	class FString                                Result;                                            // 0x18(0x10)(None)
};
...
{
public:
	class FString                                Value;                                             // 0x8(0x10)(AssetRegistrySearchable, SimpleDisplay, AdvancedDisplay, BlueprintAuthorityOnly, TextExportTransient, NonPIEDuplicateTransient, PersistentInstance, UObjectWrapper, NativeAccessSpecifierProtected)
	class FString                                Result;                                            // 0x18(0x10)(None)
};
...
{
public:
	class FString                                Value;                                             // 0x8(0x10)(SimpleDisplay, AdvancedDisplay, BlueprintAuthorityOnly, TextExportTransient, NonPIEDuplicateTransient, PersistentInstance, UObjectWrapper, NativeAccessSpecifierProtected)
	class FString                                Result;                                            // 0x18(0x10)(None)
};
...
{
public:
	class FString                                Value;                                             // 0x8(0x10)(AssetRegistrySearchable, AdvancedDisplay, BlueprintAuthorityOnly, TextExportTransient, NonPIEDuplicateTransient, PersistentInstance, UObjectWrapper, NativeAccessSpecifierProtected)
	class FString                                Reverse;                                           // 0x18(0x10)(None)
};
...
{
public:
	class FString                                Value;                                             // 0x8(0x10)(AdvancedDisplay, BlueprintAuthorityOnly, TextExportTransient, NonPIEDuplicateTransient, PersistentInstance, UObjectWrapper, NativeAccessSpecifierProtected)
	int32                                        Count;                                             // 0x18(0x4)(None)
	uint8                                        Pad_1742[0x4];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class FString                                Result;                                            // 0x20(0x10)(None)
};
...
{
public:
	class FString                                Value;                                             // 0x8(0x10)(ContainsInstancedReference, SimpleDisplay, BlueprintAuthorityOnly, TextExportTransient, NonPIEDuplicateTransient, PersistentInstance, UObjectWrapper, NativeAccessSpecifierProtected)
	int32                                        Count;                                             // 0x18(0x4)(None)
...
{
public:
	class FString                                Value;                                             // 0x8(0x10)(AssetRegistrySearchable, BlueprintAuthorityOnly, TextExportTransient, NonPIEDuplicateTransient, PersistentInstance, UObjectWrapper, NativeAccessSpecifierProtected)
	int32                                        Start;                                             // 0x18(0x4)(None)
	int32                                        Count;                                             // 0x1C(0x4)(None)
	class FString                                Result;                                            // 0x20(0x10)(None)
};
...
{
public:
	class FString                                Value;                                             // 0x8(0x10)(SimpleDisplay, AdvancedDisplay, Protected, BlueprintCallable, TextExportTransient, NonPIEDuplicateTransient, PersistentInstance, UObjectWrapper, NativeAccessSpecifierProtected)
	class FString                                Search;                                            // 0x18(0x10)(None)
	bool                                         Found;                                             // 0x28(0x1)(None)
	uint8                                        Pad_1746[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	int32                                        Index;                                             // 0x2C(0x4)(None)
};
...
{
public:
	class FString                                Value;                                             // 0x8(0x10)(ContainsInstancedReference, AdvancedDisplay, Protected, BlueprintCallable, TextExportTransient, NonPIEDuplicateTransient, PersistentInstance, UObjectWrapper, NativeAccessSpecifierProtected)
	class FString                                Separator;                                         // 0x18(0x10)(SimpleDisplay, AdvancedDisplay, BlueprintCallable, BlueprintAuthorityOnly, PersistentInstance, NativeAccessSpecifierProtected)
	TArray<class FString>                        Result;                                            // 0x28(0x10)(None)
};
...
{
public:
	TArray<class FString>                        Values;                                            // 0x8(0x10)(AssetRegistrySearchable, SimpleDisplay, Protected, BlueprintCallable, TextExportTransient, NonPIEDuplicateTransient, PersistentInstance, UObjectWrapper, NativeAccessSpecifierProtected)
	class FString                                Separator;                                         // 0x18(0x10)(ContainsInstancedReference, AssetRegistrySearchable, SimpleDisplay, Protected, BlueprintCallable, TextExportTransient, NonPIEDuplicateTransient, PersistentInstance, UObjectWrapper, NativeAccessSpecifierProtected)
	class FString                                Result;                                            // 0x28(0x10)(None)
};
...
public:
	int32                                        Value;                                             // 0x8(0x4)(None)
	int32                                        Digits;                                            // 0xC(0x4)(None)
	class FString                                Result;                                            // 0x10(0x10)(None)
};
...
{
public:
	float                                        Increment;                                         // 0x8(0x4)(None)
	float                                        InitialValue;                                      // 0xC(0x4)(None)
	bool                                         bIntegrateDeltaTime;                               // 0x10(0x1)(None)
	uint8                                        Pad_174D[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	float                                        Result;                                            // 0x14(0x4)(None)
	float                                        AccumulatedValue;                                  // 0x18(0x4)(None)
	bool                                         bIsInitialized;                                    // 0x1C(0x1)(None)
	uint8                                        Pad_174E[0x3];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	struct FVector                               Increment;                                         // 0x8(0x18)(None)
	struct FVector                               InitialValue;                                      // 0x20(0x18)(None)
	bool                                         bIntegrateDeltaTime;                               // 0x38(0x1)(None)
	uint8                                        Pad_1750[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FVector                               Result;                                            // 0x40(0x18)(None)
	struct FVector                               AccumulatedValue;                                  // 0x58(0x18)(None)
	bool                                         bIsInitialized;                                    // 0x70(0x1)(None)
...
{
public:
	struct FVector                               Multiplier;                                        // 0x8(0x18)(None)
	struct FVector                               InitialValue;                                      // 0x20(0x18)(None)
	bool                                         bIntegrateDeltaTime;                               // 0x38(0x1)(None)
...
public:
	...
	struct FQuat                                 Multiplier;                                        // 0x10(0x20)(None)
	struct FQuat                                 InitialValue;                                      // 0x30(0x20)(None)
	bool                                         bFlipOrder;                                        // 0x50(0x1)(None)
	bool                                         bIntegrateDeltaTime;                               // 0x51(0x1)(None)
	uint8                                        Pad_1757[0xE];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FQuat                                 Result;                                            // 0x60(0x20)(None)
	struct FQuat                                 AccumulatedValue;                                  // 0x80(0x20)(None)
	bool                                         bIsInitialized;                                    // 0xA0(0x1)(None)
	uint8                                        Pad_1758[0xF];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	struct FTransform                            Multiplier;                                        // 0x10(0x60)(None)
	struct FTransform                            InitialValue;                                      // 0x70(0x60)(None)
	bool                                         bFlipOrder;                                        // 0xD0(0x1)(None)
	bool                                         bIntegrateDeltaTime;                               // 0xD1(0x1)(None)
	uint8                                        Pad_175B[0xE];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FTransform                            Result;                                            // 0xE0(0x60)(None)
	struct FTransform                            AccumulatedValue;                                  // 0x140(0x60)(None)
	bool                                         bIsInitialized;                                    // 0x1A0(0x1)(None)
...
{
public:
	float                                        TargetValue;                                       // 0x8(0x4)(None)
	float                                        InitialValue;                                      // 0xC(0x4)(None)
	float                                        Blend;                                             // 0x10(0x4)(None)
	bool                                         bIntegrateDeltaTime;                               // 0x14(0x1)(None)
	uint8                                        Pad_175F[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	float                                        Result;                                            // 0x18(0x4)(None)
	float                                        AccumulatedValue;                                  // 0x1C(0x4)(None)
	bool                                         bIsInitialized;                                    // 0x20(0x1)(None)
...
{
public:
	struct FVector                               TargetValue;                                       // 0x8(0x18)(None)
	struct FVector                               InitialValue;                                      // 0x20(0x18)(None)
	float                                        Blend;                                             // 0x38(0x4)(None)
	bool                                         bIntegrateDeltaTime;                               // 0x3C(0x1)(None)
...
public:
	...
	struct FQuat                                 TargetValue;                                       // 0x10(0x20)(None)
	struct FQuat                                 InitialValue;                                      // 0x30(0x20)(None)
	float                                        Blend;                                             // 0x50(0x4)(None)
	bool                                         bIntegrateDeltaTime;                               // 0x54(0x1)(None)
	uint8                                        Pad_1769[0xB];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FQuat                                 Result;                                            // 0x60(0x20)(None)
	struct FQuat                                 AccumulatedValue;                                  // 0x80(0x20)(None)
	bool                                         bIsInitialized;                                    // 0xA0(0x1)(None)
...
public:
	...
	struct FTransform                            TargetValue;                                       // 0x10(0x60)(None)
	struct FTransform                            InitialValue;                                      // 0x70(0x60)(None)
	float                                        Blend;                                             // 0xD0(0x4)(None)
	bool                                         bIntegrateDeltaTime;                               // 0xD4(0x1)(None)
	uint8                                        Pad_1770[0xB];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FTransform                            Result;                                            // 0xE0(0x60)(None)
	struct FTransform                            AccumulatedValue;                                  // 0x140(0x60)(None)
	bool                                         bIsInitialized;                                    // 0x1A0(0x1)(None)
	uint8                                        Pad_1771[0xF];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	float                                        Minimum;                                           // 0xC(0x4)(None)
	float                                        Maximum;                                           // 0x10(0x4)(None)
	float                                        AccumulatedMinimum;                                // 0x14(0x4)(None)
	float                                        AccumulatedMaximum;                                // 0x18(0x4)(None)
	bool                                         bIsInitialized;                                    // 0x1C(0x1)(None)
...
public:
	...
	struct FVector                               Minimum;                                           // 0x20(0x18)(None)
	struct FVector                               Maximum;                                           // 0x38(0x18)(None)
	struct FVector                               AccumulatedMinimum;                                // 0x50(0x18)(None)
	struct FVector                               AccumulatedMaximum;                                // 0x68(0x18)(None)
	bool                                         bIsInitialized;                                    // 0x80(0x1)(None)
...
public:
	float                                        Value;                                             // 0x8(0x4)(None)
	float                                        Scale;                                             // 0xC(0x4)(None)
	float                                        Bias;                                              // 0x10(0x4)(None)
	bool                                         bMapRange;                                         // 0x14(0x1)(None)
	uint8                                        Pad_177F[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FInputRange                           InRange;                                           // 0x18(0x8)(None)
	struct FInputRange                           OutRange;                                          // 0x20(0x8)(None)
	bool                                         bClampResult;                                      // 0x28(0x1)(None)
	uint8                                        Pad_1780[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	float                                        ClampMin;                                          // 0x2C(0x4)(None)
	float                                        ClampMax;                                          // 0x30(0x4)(None)
	bool                                         bInterpResult;                                     // 0x34(0x1)(None)
	uint8                                        Pad_1781[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	float                                        InterpSpeedIncreasing;                             // 0x38(0x4)(None)
	float                                        InterpSpeedDecreasing;                             // 0x3C(0x4)(None)
	float                                        Result;                                            // 0x40(0x4)(None)
	struct FInputScaleBiasClamp                  ScaleBiasClamp;                                    // 0x44(0x30)(None)
...
public:
	...
	float                                        Bias;                                              // 0x24(0x4)(None)
	bool                                         bMapRange;                                         // 0x28(0x1)(None)
	uint8                                        Pad_1786[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FInputRange                           InRange;                                           // 0x2C(0x8)(None)
	struct FInputRange                           OutRange;                                          // 0x34(0x8)(None)
	bool                                         bClampResult;                                      // 0x3C(0x1)(None)
	uint8                                        Pad_1788[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	float                                        ClampMin;                                          // 0x40(0x4)(None)
	float                                        ClampMax;                                          // 0x44(0x4)(None)
	bool                                         bInterpResult;                                     // 0x48(0x1)(None)
	uint8                                        Pad_178A[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	float                                        InterpSpeedIncreasing;                             // 0x4C(0x4)(None)
	float                                        InterpSpeedDecreasing;                             // 0x50(0x4)(None)
	uint8                                        Pad_178B[0x4];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FVector                               Result;                                            // 0x58(0x18)(None)
	struct FInputScaleBiasClamp                  ScaleBiasClamp;                                    // 0x70(0x30)(None)
};
...
public:
	...
	struct FQuat                                 Value;                                             // 0x10(0x20)(None)
	float                                        Scale;                                             // 0x30(0x4)(None)
	float                                        Bias;                                              // 0x34(0x4)(None)
	bool                                         bMapRange;                                         // 0x38(0x1)(None)
	uint8                                        Pad_178D[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FInputRange                           InRange;                                           // 0x3C(0x8)(None)
	struct FInputRange                           OutRange;                                          // 0x44(0x8)(None)
	bool                                         bClampResult;                                      // 0x4C(0x1)(None)
	uint8                                        Pad_178F[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	float                                        ClampMin;                                          // 0x50(0x4)(None)
	float                                        ClampMax;                                          // 0x54(0x4)(None)
	bool                                         bInterpResult;                                     // 0x58(0x1)(None)
	uint8                                        Pad_1790[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	float                                        InterpSpeedIncreasing;                             // 0x5C(0x4)(None)
	float                                        InterpSpeedDecreasing;                             // 0x60(0x4)(None)
	uint8                                        Pad_1791[0xC];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FQuat                                 Result;                                            // 0x70(0x20)(None)
	struct FInputScaleBiasClamp                  ScaleBiasClamp;                                    // 0x90(0x30)(None)
};
...
public:
	float                                        Value;                                             // 0x8(0x4)(None)
	float                                        Delta;                                             // 0xC(0x4)(None)
	float                                        PreviousValue;                                     // 0x10(0x4)(None)
	float                                        Cache;                                             // 0x14(0x4)(None)
	bool                                         bIsInitialized;                                    // 0x18(0x1)(None)
...
public:
	struct FVector                               Value;                                             // 0x8(0x18)(None)
	struct FVector                               Delta;                                             // 0x20(0x18)(None)
	struct FVector                               PreviousValue;                                     // 0x38(0x18)(None)
	struct FVector                               Cache;                                             // 0x50(0x18)(None)
	bool                                         bIsInitialized;                                    // 0x68(0x1)(None)
...
public:
	...
	struct FQuat                                 Value;                                             // 0x10(0x20)(None)
	struct FQuat                                 Delta;                                             // 0x30(0x20)(None)
	struct FQuat                                 PreviousValue;                                     // 0x50(0x20)(None)
	struct FQuat                                 Cache;                                             // 0x70(0x20)(None)
	bool                                         bIsInitialized;                                    // 0x90(0x1)(None)
	uint8                                        Pad_1799[0xF];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	struct FTransform                            Value;                                             // 0x10(0x60)(None)
	struct FTransform                            Delta;                                             // 0x70(0x60)(None)
	struct FTransform                            PreviousValue;                                     // 0xD0(0x60)(None)
	struct FTransform                            Cache;                                             // 0x130(0x60)(None)
	bool                                         bIsInitialized;                                    // 0x190(0x1)(None)
	uint8                                        Pad_179C[0xF];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	float                                        Value;                                             // 0x8(0x4)(None)
	int32                                        BufferSize;                                        // 0xC(0x4)(None)
	float                                        Result;                                            // 0x10(0x4)(None)
	uint8                                        Pad_179E[0x4];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	TArray<float>                                Buffer;                                            // 0x18(0x10)(None)
	int32                                        LastInsertIndex;                                   // 0x28(0x4)(None)
...
public:
	struct FVector                               Value;                                             // 0x8(0x18)(None)
	int32                                        BufferSize;                                        // 0x20(0x4)(None)
	uint8                                        Pad_17A0[0x4];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FVector                               Result;                                            // 0x28(0x18)(None)
	TArray<struct FVector>                       Buffer;                                            // 0x40(0x10)(None)
	int32                                        LastInsertIndex;                                   // 0x50(0x4)(None)
...
public:
	...
	struct FTransform                            Value;                                             // 0x10(0x60)(None)
	int32                                        BufferSize;                                        // 0x70(0x4)(None)
	uint8                                        Pad_17AD[0xC];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FTransform                            Result;                                            // 0x80(0x60)(None)
	TArray<struct FTransform>                    Buffer;                                            // 0xE0(0x10)(None)
	int32                                        LastInsertIndex;                                   // 0xF0(0x4)(None)
	uint8                                        Pad_17AF[0xC];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	float                                        Speed;                                             // 0x8(0x4)(None)
	float                                        Time;                                              // 0xC(0x4)(None)
	float                                        AccumulatedValue;                                  // 0x10(0x4)(None)
	bool                                         bIsInitialized;                                    // 0x14(0x1)(None)
...
public:
	float                                        Speed;                                             // 0x8(0x4)(None)
	float                                        Duration;                                          // 0xC(0x4)(None)
	bool                                         Normalize;                                         // 0x10(0x1)(None)
	uint8                                        Pad_17B3[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	float                                        Absolute;                                          // 0x14(0x4)(None)
	float                                        Relative;                                          // 0x18(0x4)(None)
	float                                        FlipFlop;                                          // 0x1C(0x4)(None)
	bool                                         Even;                                              // 0x20(0x1)(None)
	uint8                                        Pad_17B5[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	float                                        AccumulatedAbsolute;                               // 0x24(0x4)(None)
	float                                        AccumulatedRelative;                               // 0x28(0x4)(None)
	int32                                        NumIterations;                                     // 0x2C(0x4)(None)
	bool                                         bIsInitialized;                                    // 0x30(0x1)(None)
...
public:
	float                                        Value;                                             // 0x8(0x4)(None)
	float                                        SecondsAgo;                                        // 0xC(0x4)(None)
	int32                                        BufferSize;                                        // 0x10(0x4)(None)
	float                                        TimeRange;                                         // 0x14(0x4)(None)
	float                                        Result;                                            // 0x18(0x4)(None)
	uint8                                        Pad_17B8[0x4];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	TArray<float>                                Buffer;                                            // 0x20(0x10)(AutoWeak, ContainsInstancedReference, SimpleDisplay, Protected, BlueprintAuthorityOnly, PersistentInstance, NativeAccessSpecifierProtected)
	TArray<float>                                DeltaTimes;                                        // 0x30(0x10)(None)
	int32                                        LastInsertIndex;                                   // 0x40(0x4)(None)
	int32                                        UpperBound;                                        // 0x44(0x4)(None)
};
...
public:
	struct FVector                               Value;                                             // 0x8(0x18)(None)
	float                                        SecondsAgo;                                        // 0x20(0x4)(None)
	int32                                        BufferSize;                                        // 0x24(0x4)(None)
	float                                        TimeRange;                                         // 0x28(0x4)(None)
	uint8                                        Pad_17BB[0x4];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FVector                               Result;                                            // 0x30(0x18)(None)
	TArray<struct FVector>                       Buffer;                                            // 0x48(0x10)(ContainsInstancedReference, AssetRegistrySearchable, Protected, BlueprintAuthorityOnly, PersistentInstance, NativeAccessSpecifierProtected)
	TArray<float>                                DeltaTimes;                                        // 0x58(0x10)(None)
	int32                                        LastInsertIndex;                                   // 0x68(0x4)(None)
	int32                                        UpperBound;                                        // 0x6C(0x4)(None)
};
...
public:
	...
	struct FTransform                            Value;                                             // 0x10(0x60)(None)
	float                                        SecondsAgo;                                        // 0x70(0x4)(None)
	int32                                        BufferSize;                                        // 0x74(0x4)(None)
	float                                        TimeRange;                                         // 0x78(0x4)(None)
	uint8                                        Pad_17C1[0x4];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FTransform                            Result;                                            // 0x80(0x60)(None)
	TArray<struct FTransform>                    Buffer;                                            // 0xE0(0x10)(ContainsInstancedReference, AssetRegistrySearchable, BlueprintCallable, TextExportTransient, PersistentInstance, NativeAccessSpecifierProtected)
	TArray<float>                                DeltaTimes;                                        // 0xF0(0x10)(None)
	int32                                        LastInsertIndex;                                   // 0x100(0x4)(None)
	int32                                        UpperBound;                                        // 0x104(0x4)(None)
...
public:
	...
	float                                        Damp;                                              // 0x24(0x4)(None)
	float                                        Blend;                                             // 0x28(0x4)(None)
	uint8                                        Pad_17C3[0x4];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FVector                               Force;                                             // 0x30(0x18)(None)
	struct FVector                               Position;                                          // 0x48(0x18)(None)
	struct FVector                               Velocity;                                          // 0x60(0x18)(None)
	struct FVector                               Acceleration;                                      // 0x78(0x18)(None)
	struct FRigVMSimPoint                        Point;                                             // 0x90(0x40)(None)
	bool                                         bInitialized;                                      // 0xD0(0x1)(None)
