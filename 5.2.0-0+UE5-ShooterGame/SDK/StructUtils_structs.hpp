...
{
public:
	struct FInstancedStruct                      Value;                                             // 0x0(0x10)(None)
};
...
{
public:
	class UObject*                               ValueTypeObject;                                   // 0x0(0x8)(None)
	struct FGuid                                 ID;                                                // 0x8(0x10)(None)
	class FName                                  Name;                                              // 0x18(0x8)(None)
	enum class EPropertyBagPropertyType          ValueType;                                         // 0x20(0x1)(None)
	enum class EPropertyBagContainerType         ContainerType;                                     // 0x21(0x1)(None)
	uint8                                        Pad_6C2[0xE];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_6C3[0x1];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
