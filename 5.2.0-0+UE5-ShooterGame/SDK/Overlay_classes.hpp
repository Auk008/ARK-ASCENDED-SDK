...
{
public:
	TArray<struct FOverlayItem>                  Overlays;                                          // 0x28(0x10)(None)
...
{
public:
	class UBasicOverlays*                        DefaultOverlays;                                   // 0x28(0x8)(ZeroConstructor)
	TMap<class FString, class UBasicOverlays*>   LocaleToOverlaysMap;                               // 0x30(0x50)(None)
