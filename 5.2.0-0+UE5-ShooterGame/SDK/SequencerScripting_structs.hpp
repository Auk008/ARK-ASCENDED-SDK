...
{
public:
	uint8                                        bHasStart : 1;                                     // Mask: 0x1, PropSize: 0x10x0(0x1)(None)
	uint8                                        bHasEnd : 1;                                       // Mask: 0x2, PropSize: 0x10x0(0x1)(None)
	uint8                                        BitPad_9D : 6;                                     // Fixing Bit-Field Size  [ Dumper-7 ]
	uint8                                        Pad_AD6[0x3];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	int32                                        InclusiveStart;                                    // 0x4(0x4)(None)
	int32                                        ExclusiveEnd;                                      // 0x8(0x4)(None)
	struct FFrameRate                            InternalRate;                                      // 0xC(0x8)(None)
};
