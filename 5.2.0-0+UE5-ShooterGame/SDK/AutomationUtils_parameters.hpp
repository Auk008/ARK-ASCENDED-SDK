...
{
public:
	class FString                                ScreenshotName;                                    // 0x0(0x10)(None)
	float                                        MaxGlobalError;                                    // 0x10(0x4)(None)
	float                                        MaxLocalError;                                     // 0x14(0x4)(None)
	class FString                                MapNameOverride;                                   // 0x18(0x10)(None)
};
