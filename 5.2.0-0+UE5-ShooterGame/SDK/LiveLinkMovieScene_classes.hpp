...
{
public:
	struct FLiveLinkSubjectPreset                SubjectPreset;                                     // 0xF0(0x38)(ZeroConstructor)
	TArray<bool>                                 ChannelMask;                                       // 0x128(0x10)(None)
	TArray<class UMovieSceneLiveLinkSubSection*> SubSections;                                       // 0x138(0x10)(ZeroConstructor)
	uint8                                        Pad_518[0x10];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class FName                                  SubjectName;                                       // 0x158(0x8)(None)
	struct FLiveLinkFrameData                    TemplateToPush;                                    // 0x160(0x90)(None)
	struct FLiveLinkRefSkeleton                  RefSkeleton;                                       // 0x1F0(0x20)(None)
	TArray<class FName>                          CurveNames;                                        // 0x210(0x10)(None)
	TArray<struct FMovieSceneFloatChannel>       PropertyFloatChannels;                             // 0x220(0x10)(None)
...
{
public:
	struct FLiveLinkSubSectionData               SubSectionData;                                    // 0x28(0x10)(ZeroConstructor)
	class UClass*                                SubjectRole;                                       // 0x38(0x8)(None)
...
{
public:
	uint8                                        Pad_521[0x10];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	class UClass*                                TrackRole;                                         // 0xD0(0x8)(ZeroConstructor)
