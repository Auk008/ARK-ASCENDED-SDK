...
{
public:
	class FString                                ChannelName;                                       // 0x0(0x10)(None)
...
{
public:
	class FString                                Filename;                                          // 0x0(0x10)(None)
	TArray<class FString>                        Channels;                                          // 0x10(0x10)(None)
...
{
public:
	class FString                                Target;                                            // 0x0(0x10)(None)
	TArray<class FString>                        Channels;                                          // 0x10(0x10)(None)
	bool                                         ReturnValue;                                       // 0x20(0x1)(None)
