...
{
public:
	struct FSoftObjectPath                       Metasound;                                         // 0x0(0x20)(None)
};
...
{
public:
	struct FDirectoryPath                        Directory;                                         // 0x0(0x10)(None)
};
...
public:
	...
	class UObject*                               Metasound;                                         // 0x8(0x8)(None)
	uint8                                        Pad_262F[0x20];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
