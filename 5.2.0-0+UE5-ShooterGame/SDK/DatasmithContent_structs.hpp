...
{
public:
	uint8                                        Pad_2251[0x1];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        bOverride_WhiteTemp : 1;                           // Mask: 0x1, PropSize: 0x10x0(0x1)(None)
	uint8                                        bOverride_ColorSaturation : 1;                     // Mask: 0x2, PropSize: 0x10x0(0x1)(None)
	uint8                                        bOverride_VignetteIntensity : 1;                   // Mask: 0x4, PropSize: 0x10x0(0x1)(None)
	uint8                                        bOverride_AutoExposureMethod : 1;                  // Mask: 0x8, PropSize: 0x10x0(0x1)(None)
	uint8                                        bOverride_CameraISO : 1;                           // Mask: 0x10, PropSize: 0x10x0(0x1)(None)
	uint8                                        bOverride_CameraShutterSpeed : 1;                  // Mask: 0x20, PropSize: 0x10x0(0x1)(None)
	uint8                                        BitPad_18A : 2;                                    // Fixing Bit-Field Size  [ Dumper-7 ]
	uint8                                        Pad_2255[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	uint8                                        bOverride_DepthOfFieldFstop : 1;                   // Mask: 0x1, PropSize: 0x10x4(0x1)(None)
	uint8                                        BitPad_18B : 7;                                    // Fixing Bit-Field Size  [ Dumper-7 ]
	uint8                                        Pad_2256[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	float                                        WhiteTemp;                                         // 0x8(0x4)(None)
	float                                        VignetteIntensity;                                 // 0xC(0x4)(None)
	struct FVector4                              ColorSaturation;                                   // 0x10(0x20)(None)
	enum class EAutoExposureMethod               AutoExposureMethod;                                // 0x30(0x1)(None)
	uint8                                        Pad_2257[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	float                                        CameraISO;                                         // 0x34(0x4)(None)
	float                                        CameraShutterSpeed;                                // 0x38(0x4)(None)
	float                                        DepthOfFieldFstop;                                 // 0x3C(0x4)(None)
};
...
{
public:
	enum class EDatasmithImportLightmapMin       MinLightmapResolution;                             // 0x0(0x1)(None)
	enum class EDatasmithImportLightmapMax       MaxLightmapResolution;                             // 0x1(0x1)(None)
	bool                                         bGenerateLightmapUVs;                              // 0x2(0x1)(None)
	bool                                         bRemoveDegenerates;                                // 0x3(0x1)(None)
};
...
{
public:
	bool                                         bUpdateActors;                                     // 0x0(0x1)(None)
	bool                                         bRespawnDeletedActors;                             // 0x1(0x1)(None)
};
...
{
public:
	enum class EDatasmithImportScene             SceneHandling;                                     // 0x0(0x1)(None)
	bool                                         bIncludeGeometry;                                  // 0x1(0x1)(None)
	bool                                         bIncludeMaterial;                                  // 0x2(0x1)(None)
	bool                                         bIncludeLight;                                     // 0x3(0x1)(None)
	bool                                         bIncludeCamera;                                    // 0x4(0x1)(None)
	bool                                         bIncludeAnimation;                                 // 0x5(0x1)(None)
	uint8                                        Pad_225A[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FDatasmithAssetImportOptions          AssetOptions;                                      // 0x8(0x8)(None)
	struct FDatasmithStaticMeshImportOptions     StaticMeshOptions;                                 // 0x10(0x4)(None)
};
...
{
public:
	float                                        ChordTolerance;                                    // 0x0(0x4)(None)
	float                                        MaxEdgeLength;                                     // 0x4(0x4)(None)
	float                                        NormalTolerance;                                   // 0x8(0x4)(None)
	enum class EDatasmithCADStitchingTechnique   StitchingTechnique;                                // 0xC(0x1)(None)
...
{
public:
	enum class EDatasmithCADRetessellationRule   RetessellationRule;                                // 0x10(0x1)(None)
...
{
public:
	TMap<class FName, bool>                      StaticSwitchParameters;                            // 0x0(0x50)(None)
};
...
public:
	...
	uint8                                        bRemoveDegenerates : 1;                            // Mask: 0x8, PropSize: 0x10x0(0x1)(None)
	uint8                                        bUseHighPrecisionTangentBasis : 1;                 // Mask: 0x10, PropSize: 0x10x0(0x1)(None)
	uint8                                        bUseFullPrecisionUVs : 1;                          // Mask: 0x20, PropSize: 0x10x0(0x1)(None)
	uint8                                        bGenerateLightmapUVs : 1;                          // Mask: 0x40, PropSize: 0x10x0(0x1)(None)
...
public:
	...
	class UMaterialInterface*                    MaterialInterface;                                 // 0x8(0x8)(None)
};
...
{
public:
	TMap<uint32, struct FDatasmithMeshSectionInfoTemplate> Map;                                               // 0x0(0x50)(None)
};
