...
void UUI_CustomizeSlot_Search_SideMenu_C::SetColor(const struct FLinearColor& Color, bool CallFunc_IsValid_ReturnValue)
{
...
void UUI_CustomizeSlot_Search_SideMenu_C::GetColor(const struct FLinearColor& Color, const struct FCFCoreThemeRowData& CallFunc_GetCurrentTheme_CurrentTheme)
{
	static class UFunction* Func = nullptr;
