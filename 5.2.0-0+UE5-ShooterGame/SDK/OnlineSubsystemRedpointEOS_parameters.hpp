...
{
public:
	class UEOSUserInterface_EnterDevicePinCode_Context* Context;                                           // 0x0(0x8)(None)
	class FString                                VerificationUrl;                                   // 0x8(0x10)(None)
	class FString                                PinCode;                                           // 0x18(0x10)(None)
};
...
{
public:
	TArray<struct FEOSUserInterface_CandidateEOSAccount> SelectedCandidates;                                // 0x0(0x10)(None)
};
...
{
public:
	class UEOSUserInterface_LinkEOSAccountsAgainstCrossPlatform_Context* Context;                                           // 0x0(0x8)(None)
	TArray<struct FEOSUserInterface_CandidateEOSAccount> AvailableCandidates;                               // 0x8(0x10)(None)
};
...
{
public:
	struct FEOSUserInterface_CandidateEOSAccount SelectedCandidate;                                 // 0x0(0xD0)(None)
};
...
{
public:
	class UEOSUserInterface_SelectEOSAccount_Context* Context;                                           // 0x0(0x8)(None)
	TArray<struct FEOSUserInterface_CandidateEOSAccount> AvailableCandidates;                               // 0x8(0x10)(None)
};
...
{
public:
	enum class EEOSUserInterface_SignInOrCreateAccount_Choice SelectedChoice;                                    // 0x0(0x1)(None)
};
...
{
public:
	class UEOSUserInterface_SignInOrCreateAccount_Context* Context;                                           // 0x0(0x8)(None)
};
...
{
public:
	enum class EEOSUserInterface_SwitchToCrossPlatformAccount_Choice SelectedChoice;                                    // 0x0(0x1)(None)
};
...
{
public:
	class UEOSUserInterface_SwitchToCrossPlatformAccount_Context* Context;                                           // 0x0(0x8)(None)
	class FString                                EpicAccountName;                                   // 0x8(0x10)(None)
};
