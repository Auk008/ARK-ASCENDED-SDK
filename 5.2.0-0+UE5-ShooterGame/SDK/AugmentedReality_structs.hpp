...
{
public:
	class AARActor*                              ARActor;                                           // 0x0(0x8)(ZeroConstructor)
	class UARComponent*                          ARComponent;                                       // 0x8(0x8)(ZeroConstructor)
	class UARTrackedGeometry*                    TrackedGeometry;                                   // 0x10(0x8)(None)
};
...
{
public:
	int32                                        ConfigFlags;                                       // 0x0(0x4)(None)
	uint8                                        Pad_1978[0x4];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class UMaterialInterface*                    DefaultMeshMaterial;                               // 0x8(0x8)(ZeroConstructor)
	class UMaterialInterface*                    DefaultWireframeMeshMaterial;                      // 0x10(0x8)(None)
};
...
{
public:
	struct FARSessionPayload                     SessionPayload;                                    // 0x0(0x18)(None)
	uint8                                        Pad_197A[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FTransform                            WorldTransform;                                    // 0x20(0x60)(None)
	struct FVector                               Center;                                            // 0x80(0x18)(None)
	struct FVector                               Extents;                                           // 0x98(0x18)(None)
	TArray<struct FVector>                       BoundaryVertices;                                  // 0xB0(0x10)(None)
	enum class EARObjectClassification           ObjectClassification;                              // 0xC0(0x1)(None)
	uint8                                        Pad_197B[0xF];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	struct FARSessionPayload                     SessionPayload;                                    // 0x0(0x18)(None)
	struct FVector                               LeftEyePosition;                                   // 0x18(0x18)(None)
	struct FVector                               RightEyePosition;                                  // 0x30(0x18)(None)
	struct FVector                               LookAtTarget;                                      // 0x48(0x18)(None)
};
...
{
public:
	struct FARSessionPayload                     SessionPayload;                                    // 0x0(0x18)(ZeroConstructor)
	uint8                                        Pad_197F[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FTransform                            WorldTransform;                                    // 0x20(0x60)(None)
	class UARCandidateImage*                     DetectedImage;                                     // 0x80(0x8)(None)
	struct FVector2D                             EstimatedSize;                                     // 0x88(0x10)(None)
...
public:
	...
	struct FTransform                            WorldTransform;                                    // 0x20(0x60)(None)
	struct FVector                               Extents;                                           // 0x80(0x18)(None)
	class FString                                QRCode;                                            // 0x98(0x10)(None)
...
public:
	...
	TArray<struct FTransform>                    JointTransforms;                                   // 0x60(0x10)(None)
};
...
public:
	...
	struct FTransform                            WorldTransform;                                    // 0x20(0x60)(None)
	enum class EARObjectClassification           ObjectClassification;                              // 0x80(0x1)(None)
...
public:
	...
	struct FTransform                            WorldTransform;                                    // 0x20(0x60)(None)
	float                                        Longitude;                                         // 0x80(0x4)(None)
	float                                        Latitude;                                          // 0x84(0x4)(None)
	float                                        AltitudeMeters;                                    // 0x88(0x4)(None)
	enum class EARAltitudeSource                 AltitudeSource;                                    // 0x8C(0x1)(None)
	uint8                                        Pad_199E[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class FString                                AnchorName;                                        // 0x90(0x10)(None)
};
...
{
public:
	int32                                        PreviewImageOffset;                                // 0x0(0x4)(None)
	int32                                        ARWorldOffset;                                     // 0x4(0x4)(None)
};
...
{
public:
	float                                        DistanceFromCamera;                                // 0x0(0x4)(None)
	enum class EARLineTraceChannels              TraceChannel;                                      // 0x4(0x1)(None)
	uint8                                        Pad_19A3[0xB];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FTransform                            LocalTransform;                                    // 0x10(0x60)(None)
	class UARTrackedGeometry*                    TrackedGeometry;                                   // 0x70(0x8)(None)
	uint8                                        Pad_19A4[0x18];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	class FString                                AdditionalInfo;                                    // 0x0(0x10)(None)
	enum class EARSessionStatus                  Status;                                            // 0x10(0x1)(None)
...
{
public:
	int32                                        FPS;                                               // 0x0(0x4)(None)
	int32                                        Width;                                             // 0x4(0x4)(None)
	int32                                        Height;                                            // 0x8(0x4)(None)
};
...
{
public:
	int32                                        NumJoints;                                         // 0x0(0x4)(None)
	uint8                                        Pad_19AB[0x4];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	TArray<class FName>                          JointNames;                                        // 0x8(0x10)(AutoWeak, ContainsInstancedReference, AssetRegistrySearchable, SimpleDisplay, BlueprintCallable, PersistentInstance, UObjectWrapper)
...
{
public:
	struct FARSkeletonDefinition                 SkeletonDefinition;                                // 0x0(0x28)(AutoWeak, ContainsInstancedReference, AssetRegistrySearchable, BlueprintCallable, PersistentInstance, UObjectWrapper)
	TArray<struct FVector2D>                     JointLocations;                                    // 0x28(0x10)(ContainsInstancedReference, SimpleDisplay, BlueprintCallable, PersistentInstance, UObjectWrapper)
	TArray<bool>                                 IsJointTracked;                                    // 0x38(0x10)(None)
};
...
{
public:
	struct FARSkeletonDefinition                 SkeletonDefinition;                                // 0x0(0x28)(BlueprintCallable, PersistentInstance, UObjectWrapper)
	TArray<struct FTransform>                    JointTransforms;                                   // 0x28(0x10)(ContainsInstancedReference, BlueprintCallable, PersistentInstance, UObjectWrapper)
	TArray<bool>                                 IsJointTracked;                                    // 0x38(0x10)(None)
	enum class EARJointTransformSpace            JointTransformSpace;                               // 0x48(0x1)(None)
...
{
public:
	struct FIntPoint                             ImageResolution;                                   // 0x0(0x8)(None)
	struct FVector2D                             FocalLength;                                       // 0x8(0x10)(None)
	struct FVector2D                             PrincipalPoint;                                    // 0x18(0x10)(None)
};
