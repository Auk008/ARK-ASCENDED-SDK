...
{
public:
	float                                        Loudness;                                          // 0x0(0x4)(None)
	float                                        NormalizedLoudness;                                // 0x4(0x4)(None)
	float                                        PerceptualEnergy;                                  // 0x8(0x4)(None)
	float                                        TimeSeconds;                                       // 0xC(0x4)(None)
};
...
{
public:
	float                                        TimeSeconds;                                       // 0x0(0x4)(None)
	float                                        MeterValue;                                        // 0x4(0x4)(None)
	float                                        PeakValue;                                         // 0x8(0x4)(None)
	int32                                        NumSamplesClipping;                                // 0xC(0x4)(None)
	float                                        ClippingValue;                                     // 0x10(0x4)(None)
};
...
public:
	...
	TArray<float>                                SpectrumValues;                                    // 0x8(0x10)(None)
};
