...
{
public:
	enum class EDynamicMeshChangeType            Type;                                              // 0x0(0x1)(None)
	enum class EDynamicMeshAttributeChangeFlags  Flags;                                             // 0x1(0x1)(None)
	bool                                         bIsRevertChange;                                   // 0x2(0x1)(None)
	uint8                                        Pad_C0F[0x1D];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
