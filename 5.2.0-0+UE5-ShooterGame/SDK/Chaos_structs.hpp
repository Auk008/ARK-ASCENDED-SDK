...
{
public:
	uint8                                        Pad_3128[0xB0];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_312A[0x28];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	bool                                         FilterEnabled;                                     // 0x0(0x1)(None)
...
public:
	...
	float                                        CollisionMarginFraction;                           // 0xC(0x4)(None)
	float                                        CollisionMarginMax;                                // 0x10(0x4)(None)
	float                                        CollisionCullDistance;                             // 0x14(0x4)(None)
	float                                        CollisionMaxPushOutVelocity;                       // 0x18(0x4)(None)
	float                                        ClusterConnectionFactor;                           // 0x1C(0x4)(None)
	enum class EClusterUnionMethod               ClusterUnionConnectionType;                        // 0x20(0x1)(None)
	bool                                         bGenerateCollisionData;                            // 0x21(0x1)(None)
	uint8                                        Pad_312E[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FSolverCollisionFilterSettings        CollisionFilterSettings;                           // 0x24(0x10)(None)
	bool                                         bGenerateBreakData;                                // 0x34(0x1)(None)
	uint8                                        Pad_312F[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FSolverBreakingFilterSettings         BreakingFilterSettings;                            // 0x38(0x10)(None)
	bool                                         bGenerateTrailingData;                             // 0x48(0x1)(None)
	uint8                                        Pad_3130[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FSolverTrailingFilterSettings         TrailingFilterSettings;                            // 0x4C(0x10)(None)
	int32                                        Iterations;                                        // 0x5C(0x4)(None)
	int32                                        PushOutIterations;                                 // 0x60(0x4)(None)
	bool                                         bGenerateContactGraph;                             // 0x64(0x1)(None)
...
public:
	...
	struct FVector                               AccumulatedImpulse;                                // 0x18(0x18)(None)
	struct FVector                               Normal;                                            // 0x30(0x18)(None)
	struct FVector                               Velocity1;                                         // 0x48(0x18)(None)
	struct FVector                               Velocity2;                                         // 0x60(0x18)(None)
	struct FVector                               AngularVelocity1;                                  // 0x78(0x18)(None)
	struct FVector                               AngularVelocity2;                                  // 0x90(0x18)(None)
	float                                        Mass1;                                             // 0xA8(0x4)(None)
	float                                        Mass2;                                             // 0xAC(0x4)(None)
	int32                                        ParticleIndex;                                     // 0xB0(0x4)(None)
	int32                                        LevelsetIndex;                                     // 0xB4(0x4)(None)
	int32                                        ParticleIndexMesh;                                 // 0xB8(0x4)(None)
	int32                                        LevelsetIndexMesh;                                 // 0xBC(0x4)(None)
};
...
public:
	...
	int32                                        ParticleIndexMesh;                                 // 0x50(0x4)(None)
...
{
public:
	TArray<struct FTransform>                    Transforms;                                        // 0x0(0x10)(AutoWeak, ContainsInstancedReference, AdvancedDisplay, Protected, BlueprintCallable, BlueprintAuthorityOnly, TextExportTransient, NonPIEDuplicateTransient, ExposeOnSpawn, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, NativeAccessSpecifierProtected, NativeAccessSpecifierPrivate)
	TArray<int32>                                TransformIndices;                                  // 0x10(0x10)(ContainsInstancedReference, AssetRegistrySearchable, AdvancedDisplay, Protected, BlueprintCallable, BlueprintAuthorityOnly, TextExportTransient, NonPIEDuplicateTransient, ExposeOnSpawn, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, NativeAccessSpecifierProtected, NativeAccessSpecifierPrivate)
	TArray<int32>                                PreviousTransformIndices;                          // 0x20(0x10)(SimpleDisplay, AdvancedDisplay, Protected, BlueprintCallable, BlueprintAuthorityOnly, TextExportTransient, NonPIEDuplicateTransient, ExposeOnSpawn, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, NativeAccessSpecifierProtected, NativeAccessSpecifierPrivate)
	TArray<bool>                                 DisabledFlags;                                     // 0x30(0x10)(AutoWeak, ContainsInstancedReference, SimpleDisplay, AdvancedDisplay, Protected, BlueprintCallable, BlueprintAuthorityOnly, TextExportTransient, NonPIEDuplicateTransient, ExposeOnSpawn, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, NativeAccessSpecifierProtected, NativeAccessSpecifierPrivate)
	TArray<struct FSolverCollisionData>          Collisions;                                        // 0x40(0x10)(AutoWeak, AssetRegistrySearchable, SimpleDisplay, AdvancedDisplay, Protected, BlueprintCallable, BlueprintAuthorityOnly, TextExportTransient, NonPIEDuplicateTransient, ExposeOnSpawn, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, NativeAccessSpecifierProtected, NativeAccessSpecifierPrivate)
	TArray<struct FSolverBreakingData>           Breakings;                                         // 0x50(0x10)(AutoWeak, AssetRegistrySearchable, SimpleDisplay, BlueprintAuthorityOnly, TextExportTransient, NonPIEDuplicateTransient, ExposeOnSpawn, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, NativeAccessSpecifierProtected, NativeAccessSpecifierPrivate)
	TSet<struct FSolverTrailingData>             Trailings;                                         // 0x60(0x50)(None)
	float                                        Timestamp;                                         // 0xB0(0x4)(None)
...
{
public:
	TArray<struct FRecordedFrame>                Records;                                           // 0x0(0x10)(None)
};
