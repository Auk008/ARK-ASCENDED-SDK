...
// Parameters:
// class UEOSUserInterface_EnterDevicePinCode_Context*Context                                                          (None)
// class FString                      VerificationUrl                                                  (None)
// class FString                      PinCode                                                          (None)
...
// (Native, Public, BlueprintCallable)
// Parameters:
// TArray<struct FEOSUserInterface_CandidateEOSAccount>SelectedCandidates                                               (None)
...
// Parameters:
// class UEOSUserInterface_LinkEOSAccountsAgainstCrossPlatform_Context*Context                                                          (None)
// TArray<struct FEOSUserInterface_CandidateEOSAccount>AvailableCandidates                                              (None)
...
// (Native, Public, BlueprintCallable)
// Parameters:
// struct FEOSUserInterface_CandidateEOSAccountSelectedCandidate                                                (None)
...
// (Event, Public, HasOutParams, BlueprintCallable, BlueprintEvent)
// Parameters:
// class UEOSUserInterface_SelectEOSAccount_Context*Context                                                          (None)
// TArray<struct FEOSUserInterface_CandidateEOSAccount>AvailableCandidates                                              (None)
...
// (Native, Public, BlueprintCallable)
// Parameters:
// enum class EEOSUserInterface_SignInOrCreateAccount_ChoiceSelectedChoice                                                   (None)
...
// (Event, Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// class UEOSUserInterface_SignInOrCreateAccount_Context*Context                                                          (None)
...
// (Native, Public, BlueprintCallable)
// Parameters:
// enum class EEOSUserInterface_SwitchToCrossPlatformAccount_ChoiceSelectedChoice                                                   (None)
...
// (Event, Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// class UEOSUserInterface_SwitchToCrossPlatformAccount_Context*Context                                                          (None)
// class FString                      EpicAccountName                                                  (None)
