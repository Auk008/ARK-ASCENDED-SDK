...
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// enum class ENavDataGatheringModeConfigNewMode                                                          (None)
...
// Parameters:
// class AActor*                      Invoker                                                          (None)
// float                              TileGenerationRadius                                             (None)
// float                              TileRemovalRadius                                                (None)
...
// Parameters:
// class UObject*                     WorldContext                                                     (ZeroConstructor)
// struct FVector                     Point                                                            (None)
// struct FVector                     Extent                                                           (None)
// class ANavigationData*             NavData                                                          (ZeroConstructor)
// class UClass*                      FilterClass                                                      (None)
// struct FVector                     ReturnValue                                                      (None)

void UNavigationSystemV1::ProjectPointToNavigationEx(class UObject* WorldContext, const struct FVector& Point, const struct FVector& Extent, class ANavigationData* NavData, class UClass* FilterClass, const struct FVector& ReturnValue)
{
	static class UFunction* Func = nullptr;
...
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// class ANavMeshBoundsVolume*        NavVolume                                                        (None)
...
// struct FVector                     RayStart                                                         (None)
// struct FVector                     RayEnd                                                           (None)
// struct FVector                     HitLocation                                                      (None)
// class UClass*                      FilterClass                                                      (ZeroConstructor)
// class AController*                 Querier                                                          (None)
// bool                               ReturnValue                                                      (None)

void UNavigationSystemV1::NavigationRaycast(class UObject* WorldContextObject, const struct FVector& RayStart, const struct FVector& RayEnd, const struct FVector& HitLocation, class UClass* FilterClass, class AController* Querier, bool ReturnValue)
{
	static class UFunction* Func = nullptr;
...
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// class UObject*                     Object                                                           (ZeroConstructor)
// class UClass*                      OldArea                                                          (ZeroConstructor)
// class UClass*                      NewArea                                                          (None)
// bool                               ReturnValue                                                      (None)
...
// class UObject*                     WorldContextObject                                               (ZeroConstructor)
// struct FVector                     Point                                                            (None)
// struct FVector                     ProjectedLocation                                                (None)
// class ANavigationData*             NavData                                                          (ZeroConstructor)
// class UClass*                      FilterClass                                                      (None)
// struct FVector                     QueryExtent                                                      (None)
// bool                               ReturnValue                                                      (None)

void UNavigationSystemV1::K2_ProjectPointToNavigation(class UObject* WorldContextObject, const struct FVector& Point, const struct FVector& ProjectedLocation, class ANavigationData* NavData, class UClass* FilterClass, const struct FVector& QueryExtent, bool ReturnValue)
{
	static class UFunction* Func = nullptr;
...
// struct FVector                     RandomLocation                                                   (None)
// float                              Radius                                                           (None)
// class ANavigationData*             NavData                                                          (ZeroConstructor)
// class UClass*                      FilterClass                                                      (None)
// bool                               ReturnValue                                                      (None)

void UNavigationSystemV1::K2_GetRandomReachablePointInRadius(class UObject* WorldContextObject, const struct FVector& Origin, const struct FVector& RandomLocation, float Radius, class ANavigationData* NavData, class UClass* FilterClass, bool ReturnValue)
{
	static class UFunction* Func = nullptr;
...
void UNavigationSystemV1::K2_GetRandomPointInNavigableRadius(class UObject* WorldContextObject, const struct FVector& Origin, const struct FVector& RandomLocation, float Radius, class ANavigationData* NavData, class UClass* FilterClass, bool ReturnValue)
{
	static class UFunction* Func = nullptr;
...
void UNavigationSystemV1::K2_GetRandomLocationInNavigableRadius(class UObject* WorldContextObject, const struct FVector& Origin, const struct FVector& RandomLocation, float Radius, class ANavigationData* NavData, class UClass* FilterClass, bool ReturnValue)
{
	static class UFunction* Func = nullptr;
...
// struct FRandomStream               RandStream                                                       (None)
// struct FVector                     PathDirection                                                    (None)
// float                              DotLimit                                                         (None)
// class ANavigationData*             NavData                                                          (ZeroConstructor)
// class UClass*                      FilterClass                                                      (None)
// struct FVector                     ReturnValue                                                      (None)

void UNavigationSystemV1::GetRandomReachablePointInMinMaxRadius(class UObject* WorldContext, const struct FVector& Origin, float MinRadius, float MaxRadius, const struct FRandomStream& RandStream, const struct FVector& PathDirection, float DotLimit, class ANavigationData* NavData, class UClass* FilterClass, const struct FVector& ReturnValue)
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// class UObject*                     WorldContextObject                                               (ZeroConstructor)
// struct FVector                     PathStart                                                        (None)
// struct FVector                     PathEnd                                                          (None)
// double                             PathLength                                                       (None)
// class ANavigationData*             NavData                                                          (ZeroConstructor)
// class UClass*                      FilterClass                                                      (None)
// enum class ENavigationQueryResult  ReturnValue                                                      (None)

void UNavigationSystemV1::GetPathLength(class UObject* WorldContextObject, const struct FVector& PathStart, const struct FVector& PathEnd, double PathLength, class ANavigationData* NavData, class UClass* FilterClass, enum class ENavigationQueryResult ReturnValue)
{
	static class UFunction* Func = nullptr;
...
// struct FVector                     PathStart                                                        (None)
// struct FVector                     PathEnd                                                          (None)
// double                             PathCost                                                         (None)
// class ANavigationData*             NavData                                                          (ZeroConstructor)
// class UClass*                      FilterClass                                                      (None)
// enum class ENavigationQueryResult  ReturnValue                                                      (None)

void UNavigationSystemV1::GetPathCost(class UObject* WorldContextObject, const struct FVector& PathStart, const struct FVector& PathEnd, double PathCost, class ANavigationData* NavData, class UClass* FilterClass, enum class ENavigationQueryResult ReturnValue)
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// class UObject*                     WorldContextObject                                               (ZeroConstructor)
// class UNavigationSystemV1*         ReturnValue                                                      (None)
...
// struct FVector                     PathStart                                                        (None)
// struct FVector                     PathEnd                                                          (None)
// class AActor*                      PathfindingContext                                               (ZeroConstructor)
// class UClass*                      FilterClass                                                      (ZeroConstructor)
// class UNavigationPath*             ReturnValue                                                      (None)

void UNavigationSystemV1::FindPathToLocationSynchronously(class UObject* WorldContextObject, const struct FVector& PathStart, const struct FVector& PathEnd, class AActor* PathfindingContext, class UClass* FilterClass, class UNavigationPath* ReturnValue)
{
	static class UFunction* Func = nullptr;
...
// float                              TetherDistance                                                   (None)
// class AActor*                      PathfindingContext                                               (ZeroConstructor)
// class UClass*                      FilterClass                                                      (ZeroConstructor)
// class UNavigationPath*             ReturnValue                                                      (None)

void UNavigationSystemV1::FindPathToActorSynchronously(class UObject* WorldContextObject, const struct FVector& PathStart, class AActor* GoalActor, float TetherDistance, class AActor* PathfindingContext, class UClass* FilterClass, class UNavigationPath* ReturnValue)
{
	static class UFunction* Func = nullptr;
...
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// class UClass*                      NewAreaClass                                                     (None)
...
// class UClass*                      OldArea                                                          (ZeroConstructor)
// class UClass*                      NewArea                                                          (None)
// bool                               ReplaceLinks                                                     (None)
// bool                               ReturnValue                                                      (None)

void ARecastNavMesh::K2_ReplaceAreaInTileBounds(const struct FBox& Bounds, class UClass* OldArea, class UClass* NewArea, bool ReplaceLinks, bool ReturnValue)
{
	static class UFunction* Func = nullptr;
...
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// enum class ENavigationOptionFlag   DoRecalculation                                                  (None)
...
// (Final, Native, Public, HasDefaults, BlueprintCallable)
// Parameters:
// bool                               bShouldDrawDebugData                                             (None)
// struct FLinearColor                PathColor                                                        (None)
