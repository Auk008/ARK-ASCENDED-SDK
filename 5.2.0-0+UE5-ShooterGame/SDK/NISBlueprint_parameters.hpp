...
{
public:
	enum class EUNISMode                         NISMode;                                           // 0x0(0x1)(None)
};
...
{
public:
	float                                        CustomScreenPercentage;                            // 0x0(0x4)(None)
};
...
{
public:
	TArray<enum class EUNISMode>                 ReturnValue;                                       // 0x0(0x10)(None)
};
...
{
public:
	enum class EUNISMode                         ReturnValue;                                       // 0x0(0x1)(None)
};
