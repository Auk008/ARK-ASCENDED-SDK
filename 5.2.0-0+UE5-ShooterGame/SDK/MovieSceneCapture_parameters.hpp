...
{
public:
	enum class EMovieSceneCaptureProtocolState   ReturnValue;                                       // 0x0(0x1)(None)
};
...
{
public:
	class UClass*                                ProtocolType;                                      // 0x0(0x8)(None)
};
...
{
public:
	class UMovieSceneCaptureProtocolBase*        ReturnValue;                                       // 0x0(0x8)(None)
};
...
{
public:
	class UMovieSceneImageCaptureProtocolBase*   ReturnValue;                                       // 0x0(0x8)(None)
};
...
{
public:
	class UMovieSceneAudioCaptureProtocolBase*   ReturnValue;                                       // 0x0(0x8)(None)
};
...
{
public:
	struct FCapturedPixelsID                     StreamID;                                          // 0x0(0x50)(None)
};
...
{
public:
	class UTexture*                              Buffer;                                            // 0x0(0x8)(None)
	struct FCapturedPixelsID                     BufferID;                                          // 0x8(0x50)(None)
};
...
{
public:
	struct FCapturedPixels                       Pixels;                                            // 0x0(0x10)(None)
	struct FCapturedPixelsID                     ID;                                                // 0x10(0x50)(None)
	struct FFrameMetrics                         FrameMetrics;                                      // 0x60(0x10)(None)
};
...
{
public:
	struct FFrameMetrics                         ReturnValue;                                       // 0x0(0x10)(None)
};
...
{
public:
	struct FFrameMetrics                         InFrameMetrics;                                    // 0x0(0x10)(None)
...
{
public:
	struct FCapturedPixels                       PixelData;                                         // 0x0(0x10)(None)
	struct FCapturedPixelsID                     StreamID;                                          // 0x10(0x50)(None)
	struct FFrameMetrics                         FrameMetrics;                                      // 0x60(0x10)(None)
	bool                                         bCopyImageData;                                    // 0x70(0x1)(None)
	uint8                                        Pad_2A18[0x7];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	class UTexture*                              Buffer;                                            // 0x0(0x8)(None)
	struct FCapturedPixelsID                     StreamID;                                          // 0x8(0x50)(None)
	class FString                                ReturnValue;                                       // 0x58(0x10)(None)
};
