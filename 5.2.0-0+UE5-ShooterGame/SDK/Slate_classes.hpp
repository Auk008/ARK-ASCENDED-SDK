...
{
public:
	bool                                         bExplicitCanvasChildZOrder;                        // 0x28(0x1)(None)
	uint8                                        Pad_287D[0x7];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	struct FComboBoxStyle                        ComboBoxStyle;                                     // 0x30(0x660)(None)
...
{
public:
	struct FComboButtonStyle                     ComboButtonStyle;                                  // 0x30(0x600)(None)
...
{
public:
	struct FEditableTextBoxStyle                 EditableTextBoxStyle;                              // 0x30(0xE80)(None)
...
{
public:
	struct FEditableTextStyle                    EditableTextStyle;                                 // 0x30(0x2F0)(None)
...
{
public:
	struct FProgressBarStyle                     ProgressBarStyle;                                  // 0x30(0x290)(None)
...
{
public:
	struct FScrollBarStyle                       ScrollBarStyle;                                    // 0x30(0x770)(None)
...
{
public:
	struct FScrollBoxStyle                       ScrollBoxStyle;                                    // 0x30(0x370)(None)
...
{
public:
	struct FSpinBoxStyle                         SpinBoxStyle;                                      // 0x30(0x600)(None)
...
{
public:
	struct FTextBlockStyle                       TextBlockStyle;                                    // 0x30(0x340)(None)
