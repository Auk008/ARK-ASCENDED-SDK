...
{
public:
	TArray<struct FNamedInterface>               NamedInterfaces;                                   // 0x28(0x10)(None)
	TArray<struct FNamedInterfaceDef>            NamedInterfaceDefs;                                // 0x38(0x10)(None)
	uint8                                        Pad_0[0x18];                                       // Fixing Size Of Struct [ Dumper-7 ]
