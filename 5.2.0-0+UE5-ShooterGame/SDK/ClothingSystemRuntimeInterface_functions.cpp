...
// (Final, Native, Public, BlueprintCallable, BlueprintPure, Const)
// Parameters:
// class FString                      ClothingAssetName                                                (None)
// class UClothingInteractor*         ReturnValue                                                      (None)

void UClothingSimulationInteractor::GetClothingInteractor(const class FString& ClothingAssetName, class UClothingInteractor* ReturnValue)
{
	static class UFunction* Func = nullptr;
